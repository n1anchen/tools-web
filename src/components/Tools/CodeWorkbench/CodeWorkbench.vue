...
.options :deep(.option-field) {
  display: flex;
  flex-direction: column;
  gap: 5px;
}
.options :deep(.option-field > span), .options :deep(.switch-field > span) {
  color: var(--c-text-secondary);
  font-size: 12px;
}
.options :deep(.switch-field) {
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: 10px;
}
.options :deep(.el-select), .options :deep(.el-input-number) {
  width: 100%;
}
.main-actions {
  display: grid;
...
.settings-card :deep(.notice-card) {
  margin-top: 13px;
  padding: 11px;
...
.settings-card :deep(.notice-card.error) {
  color: #b91c1c;
  background: #fef2f2;
}
.metric-strip {
...
:global(html.dark .code-workbench-page .sample-card), :global(html.dark .code-workbench-page .editor-card), :global(html.dark .code-workbench-page .settings-card), :global(html.dark .code-workbench-page .metric-strip), :global(html.dark .code-workbench-page .tips-grid article) {
  border-color: var(--c-border);
  background: var(--c-surface);
  box-shadow: none;
}
:global(html.dark .code-workbench-page h2), :global(html.dark .code-workbench-page h3), :global(html.dark .code-workbench-page .metric-strip strong), :global(html.dark .code-workbench-page .tips-grid strong) {
  color: #f8fafc;
}
:global(html.dark .code-workbench-page .section-heading > span), :global(html.dark .code-workbench-page .editor-footer button.active), :global(html.dark .code-workbench-page .settings-card .notice-card) {
  border-color: color-mix(in srgb, var(--accent) 65%, #334155);
  color: var(--c-text-primary);
  background: color-mix(in srgb, var(--accent) 22%, #0f172a);
}
:global(html.dark .code-workbench-page .sample-card button), :global(html.dark .code-workbench-page .editor-footer span) {
  border-color: var(--c-border);
  color: var(--c-text-secondary);
  background: var(--c-surface-subtle);
}
:global(html.dark .code-workbench-page .editor-card .ace-editor), :global(html.dark .code-workbench-page .metric-strip div) {
  border-color: var(--c-border);
}
.sample-card {
  gap: 10px;
