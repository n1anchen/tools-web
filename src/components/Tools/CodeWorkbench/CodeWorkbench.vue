...
.metric-strip { display: grid; grid-template-columns: repeat(auto-fit, minmax(110px, 1fr)); padding: 10px 14px; }.metric-strip div { display: flex; align-items: center; flex-direction: column; padding: 7px 10px; border-right: 1px solid var(--c-border); }.metric-strip div:last-child { border: 0; }.metric-strip span { color: var(--c-text-muted); font-size:12px; }.metric-strip strong { margin-top: 2px; color: var(--c-text-strong); font-size:12px; }.tips-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 9px; }.tips-grid article { display: flex; gap: 10px; padding: 14px; border-radius: 15px; }.tips-grid article > span { display: grid; width: 31px; height: 31px; flex: none; place-items: center; border-radius: 9px; color: var(--accent); background: var(--accent-soft); font: 800 12px ui-monospace, monospace; }.tips-grid strong { color: var(--c-text-strong); font-size:12px; }.tips-grid p { margin: 3px 0 0; color: var(--c-text-secondary); font-size:12px; line-height: 1.55; }
