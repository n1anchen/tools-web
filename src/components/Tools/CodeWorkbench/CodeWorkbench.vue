...
<style scoped>
.code-workbench-page { --accent: #2563eb; --accent-soft: #eff6ff; --accent-border: #bfdbfe; gap: 16px; }.accent-violet { --accent: #7c3aed; --accent-soft: #f5f3ff; --accent-border: #ddd6fe; }.accent-orange { --accent: #ea580c; --accent-soft: #fff7ed; --accent-border: #fed7aa; }.accent-cyan { --accent: #0891b2; --accent-soft: #ecfeff; --accent-border: #a5f3fc; }.hero-card, .sample-card, .editor-card, .settings-card, .metric-strip, .tips-grid article { border: 1px solid #e2e8f0; border-radius: 22px; background: #fff; box-shadow: 0 12px 35px rgb(15 23 42 / 6%); }.hero-card { display: flex; align-items: center; justify-content: space-between; gap: 22px; padding: 25px 28px; background: radial-gradient(circle at 88% 10%, var(--accent-soft), transparent 30%), #fff; }.eyebrow { color: var(--accent); font-size: 10px; font-weight: 800; letter-spacing: .15em; }.hero-card h2 { margin: 6px 0 4px; color: #0f172a; font-size: clamp(21px, 3vw, 28px); }.hero-card p { margin: 0; color: #64748b; font-size: 13px; }.language-badge { display: flex; min-width: 145px; flex-direction: column; padding: 11px 13px; border: 1px solid var(--accent-border); border-radius: 14px; color: var(--accent); background: var(--accent-soft); }.language-badge span, .language-badge small { font-size: 8px; opacity: .68; }.language-badge strong { font-size: 13px; }.sample-card { display: flex; align-items: center; gap: 7px; padding: 10px 13px; overflow-x: auto; }.sample-card > span { flex: none; color: #94a3b8; font-size: 9px; }.sample-card button { display: flex; align-items: flex-start; flex-direction: column; flex: none; padding: 6px 9px; border: 1px solid #e2e8f0; border-radius: 9px; color: #475569; background: #f8fafc; cursor: pointer; }.sample-card strong { font-size: 9px; }.sample-card small { color: #94a3b8; font-size: 7px; }
.workspace { display: grid; grid-template-columns: minmax(0, 1.55fr) minmax(285px, .55fr); align-items: start; gap: 16px; }.editor-card { min-width: 0; overflow: hidden; }.editor-heading { display: flex; min-height: 58px; align-items: center; justify-content: space-between; gap: 10px; padding: 10px 13px; }.editor-heading > div:first-child { display: flex; min-width: 0; align-items: center; gap: 7px; }.editor-heading strong { color: #475569; font-size: 10px; }.editor-heading small { overflow: hidden; color: #94a3b8; text-overflow: ellipsis; font-size: 8px; white-space: nowrap; }.status-dot { width: 8px; height: 8px; flex: none; border-radius: 50%; background: #94a3b8; }.status-dot.success { background: #22c55e; box-shadow: 0 0 0 4px #dcfce7; }.status-dot.error { background: #ef4444; box-shadow: 0 0 0 4px #fee2e2; }.status-dot.working { background: #f59e0b; animation: blink 1s ease infinite; }.utility-actions { display: flex; flex: none; }.editor-card :deep(.ace-editor) { border-top: 1px solid #e2e8f0; border-bottom: 1px solid #e2e8f0; }.editor-footer { display: flex; align-items: center; justify-content: space-between; gap: 10px; padding: 8px 12px; }.editor-footer > div { display: flex; align-items: center; gap: 5px; }.editor-footer span { padding: 3px 6px; border-radius: 6px; color: #64748b; background: #f1f5f9; font-size: 7px; }.editor-footer button { display: grid; min-width: 27px; height: 24px; place-items: center; border: 0; border-radius: 6px; color: #94a3b8; background: transparent; font-size: 8px; cursor: pointer; }.editor-footer button.active { color: var(--accent); background: var(--accent-soft); }
.settings-card { position: sticky; top: 14px; padding: 19px; }.section-heading { display: flex; align-items: center; justify-content: space-between; gap: 12px; }.section-heading h3 { margin: 3px 0 0; color: #0f172a; font-size: 16px; }.section-heading > span { padding: 3px 6px; border-radius: 6px; color: var(--accent); background: var(--accent-soft); font-size: 8px; font-weight: 700; }.options { display: flex; flex-direction: column; gap: 13px; margin-top: 17px; }.options :deep(.option-field) { display: flex; flex-direction: column; gap: 5px; }.options :deep(.option-field > span), .options :deep(.switch-field > span) { color: #64748b; font-size: 9px; }.options :deep(.switch-field) { display: flex; align-items: center; justify-content: space-between; gap: 10px; }.options :deep(.el-select), .options :deep(.el-input-number) { width: 100%; }.main-actions { display: grid; grid-template-columns: 1fr 1fr; gap: 7px; margin-top: 18px; }.main-actions .el-button { margin: 0; }.main-actions .el-button:last-child { grid-column: 1 / -1; }.settings-card :deep(.notice-card) { margin-top: 13px; padding: 11px; border-radius: 12px; color: #64748b; background: var(--accent-soft); font-size: 9px; line-height: 1.55; }.settings-card :deep(.notice-card.error) { color: #b91c1c; background: #fef2f2; }
.metric-strip { display: grid; grid-template-columns: repeat(auto-fit, minmax(110px, 1fr)); padding: 10px 14px; }.metric-strip div { display: flex; align-items: center; flex-direction: column; padding: 7px 10px; border-right: 1px solid #e2e8f0; }.metric-strip div:last-child { border: 0; }.metric-strip span { color: #94a3b8; font-size: 8px; }.metric-strip strong { margin-top: 2px; color: #334155; font-size: 10px; }.tips-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 9px; }.tips-grid article { display: flex; gap: 10px; padding: 14px; border-radius: 15px; }.tips-grid article > span { display: grid; width: 31px; height: 31px; flex: none; place-items: center; border-radius: 9px; color: var(--accent); background: var(--accent-soft); font: 800 9px ui-monospace, monospace; }.tips-grid strong { color: #334155; font-size: 11px; }.tips-grid p { margin: 3px 0 0; color: #64748b; font-size: 9px; line-height: 1.55; }
:global(html.dark .code-workbench-page .hero-card), :global(html.dark .code-workbench-page .sample-card), :global(html.dark .code-workbench-page .editor-card), :global(html.dark .code-workbench-page .settings-card), :global(html.dark .code-workbench-page .metric-strip), :global(html.dark .code-workbench-page .tips-grid article) { border-color: #334155; background: #1e293b; box-shadow: none; }:global(html.dark .code-workbench-page .hero-card) { background: radial-gradient(circle at 88% 10%, color-mix(in srgb, var(--accent) 35%, transparent), transparent 30%), #1e293b; }:global(html.dark .code-workbench-page h2), :global(html.dark .code-workbench-page h3), :global(html.dark .code-workbench-page .metric-strip strong), :global(html.dark .code-workbench-page .tips-grid strong) { color: #f8fafc; }:global(html.dark .code-workbench-page .language-badge), :global(html.dark .code-workbench-page .section-heading > span), :global(html.dark .code-workbench-page .editor-footer button.active), :global(html.dark .code-workbench-page .settings-card .notice-card) { border-color: color-mix(in srgb, var(--accent) 65%, #334155); color: #e2e8f0; background: color-mix(in srgb, var(--accent) 22%, #0f172a); }:global(html.dark .code-workbench-page .sample-card button), :global(html.dark .code-workbench-page .editor-footer span) { border-color: #334155; color: #cbd5e1; background: #0f172a; }:global(html.dark .code-workbench-page .editor-card .ace-editor), :global(html.dark .code-workbench-page .metric-strip div) { border-color: #334155; }
@keyframes blink { 50% { opacity: .32; } }
@media (max-width: 930px) { .workspace { grid-template-columns: 1fr; }.settings-card { position: static; } }
@media (max-width: 640px) { .hero-card { align-items: flex-start; flex-direction: column; padding: 21px; }.language-badge { width: 100%; }.editor-heading { align-items: flex-start; flex-direction: column; }.utility-actions { display: grid; width: 100%; grid-template-columns: repeat(3, 1fr); }.utility-actions .el-button { margin: 0; }.editor-card :deep(.ace-editor) { height: 410px !important; }.editor-footer { align-items: flex-start; flex-direction: column; }.editor-footer > div:last-child { align-self: flex-end; }.settings-card { padding: 17px; }.metric-strip { grid-template-columns: repeat(2, 1fr); }.metric-strip div { border-bottom: 1px solid #e2e8f0; }.tips-grid { grid-template-columns: 1fr; } }
</style>
