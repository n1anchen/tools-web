...
.design-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 17px 24px; margin-top: 20px; }.design-grid > label { display: flex; min-width: 0; flex-direction: column; gap: 5px; }.design-grid b, .logo-size b { float: right; color: #334155; font-family: ui-monospace, monospace; }.color-field > div { display: flex; gap: 16px; margin-top: 7px; }.color-field label { display: flex; align-items: center; gap: 7px; color: var(--c-text-body); font-size: 10px; }.logo-row { display: flex; align-items: center; justify-content: space-between; gap: 15px; margin-top: 20px; padding: 13px; border-radius: 13px; background: var(--c-surface-subtle); }.logo-row > div:first-child { display: flex; flex-direction: column; }.logo-row strong { color: #334155; font-size: 11px; }.logo-row span { color: var(--c-text-muted); font-size: 9px; }.logo-actions { display: flex; align-items: center; gap: 5px; }.upload-button { max-width: 160px; padding: 7px 11px; overflow: hidden; border: 1px solid #bfdbfe; border-radius: 9px; color: #1d4ed8; background: #eff6ff; text-overflow: ellipsis; font-size: 10px; white-space: nowrap; cursor: pointer; }.upload-button input { display: none; }.logo-size { display: block; margin-top: 12px; }
...
:global(html.dark .qr-page .panel), :global(html.dark .qr-page .preview-card) { border-color: #334155; background: #1e293b; box-shadow: none; }:global(html.dark .qr-page h3), :global(html.dark .qr-page .design-grid b), :global(html.dark .qr-page .logo-size b), :global(html.dark .qr-page .logo-row strong) { color: #f8fafc; }:global(html.dark .qr-page .type-switcher), :global(html.dark .qr-page .logo-row), :global(html.dark .qr-page .payload-preview) { background: #0f172a; }:global(html.dark .qr-page .type-switcher button.active) { color: #93c5fd; background: #334155; }:global(html.dark .qr-page .color-field label), :global(html.dark .qr-page .payload-preview code) { color: #cbd5e1; }
