...
.result-metrics span, .result-metrics b { display: block; } .result-metrics span { color: var(--c-text-muted); font-size: 10px; } .result-metrics b { margin-top: 3px; color: #334155; font-size: 17px; }
...
.history-list strong { color: #334155; font-size: 12px; } .history-list small { margin-top: 3px; color: var(--c-text-muted); font-size: 9px; }
