...
<style scoped>
.lyrics-tool{--ink:#293247;--muted:#6b7890}.source-workbench,.study-toolbar,.focus-nav,.legend-card,.empty-study{border:1px solid #e1e5f0;border-radius:24px;background:var(--c-surface);box-shadow:0 12px 30px rgba(51,65,85,.06)}.section-header>div>span,.source-sidebar header>span{font-size:12px;font-weight:800;letter-spacing:.14em;color:#7761aa}.section-header p{margin:0;font-size:14px;line-height:1.7;color:var(--muted)}.source-workbench{display:grid;grid-template-columns:minmax(0,1fr) 320px;gap:18px;margin-top:14px;padding:18px}.source-main,.source-sidebar{min-width:0}.section-header{display:flex;justify-content:space-between;gap:15px;margin-bottom:13px}.section-header h3,.source-sidebar h3{margin:4px 0;font-size:18px;color:var(--ink)}.header-actions,.export-actions{display:flex;gap:8px;align-items:flex-start}.header-actions button,.secondary-button,.export-actions button,.line-actions button,.focus-nav button,.empty-study button{padding:8px 11px;border:1px solid #d8deea;border-radius:var(--radius-sm);background:var(--c-surface);font-size:13px;color:#526078}.header-actions button:disabled,.focus-nav button:disabled{opacity:.4}.meta-row{display:flex;gap:7px;flex-wrap:wrap;margin-top:10px}.meta-row span{padding:6px 9px;border:1px solid #dfe4ed;border-radius:var(--radius-sm);background:#f7f9fc;font-size:12px;color:#667489}.meta-row b{margin-right:5px;color:#46556d}.parse-warning,.error-text{margin-top:10px;padding:10px;border-radius:var(--radius-sm);background:#fff1f0;font-size:13px;color:#b85252}.source-sidebar{padding:15px;border:1px solid #e2e5ee;border-radius:var(--radius-lg);background:#fafbfe}.url-field{display:block;margin-top:14px}.url-field>span{display:block;margin-bottom:6px;font-size:12px;font-weight:700;color:#69758a}.primary-button,.secondary-button{width:100%;margin-top:9px;padding:10px}.primary-button{border:0;border-radius:var(--radius-sm);background:#7655ca;color: var(--c-on-accent);font-size:13px;font-weight:700}.primary-button:disabled{opacity:.4}.settings-group,.font-setting{margin-top:13px;padding:12px;border:1px solid #e0e5ee;border-radius:var(--radius-md);background:var(--c-surface)}.setting-row{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:5px 0}.setting-row strong,.setting-row span{display:block}.setting-row strong{font-size:13px;color:var(--ink)}.setting-row span{margin-top:2px;font-size:12px;color:#7a8799}.info-text,.error-text{font-size:12px}.info-text{color:#4c76b4}.font-setting>div{display:flex;justify-content:space-between;font-size:13px;color:#56647a}.study-toolbar{display:flex;align-items:center;justify-content:space-between;gap:14px;margin-top:14px;padding:13px 16px}.view-switch{display:flex;padding:4px;border-radius:var(--radius-sm);background:#eef1f6}.view-switch button{padding:7px 12px;border-radius:var(--radius-xs);font-size:13px;color:#69758a}.view-switch button.active{background:var(--c-surface);color:#6746ba;box-shadow:0 3px 10px rgba(51,65,85,.1)}.display-switches{display:flex;gap:14px;flex-wrap:wrap}.display-switches label{display:flex;align-items:center;gap:6px;font-size:13px;color:#5f6c80}.insight-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin-top:12px}.insight-grid article{display:flex;gap:11px;min-width:0;padding:14px;border:1px solid;border-radius:var(--radius-lg)}.insight-grid article>span{display:grid;place-items:center;flex:0 0 34px;height:34px;border-radius:var(--radius-sm);font-weight:800}.insight-grid strong{font-size:13px;color:var(--ink)}.insight-grid p{margin:4px 0 0;font-size:12px;line-height:1.6;color:#68768b}.insight-grid .sky{border-color:#cfe6fa;background:#f3faff}.insight-grid .sky>span{background:#dff1ff;color:#2874aa}.insight-grid .rose{border-color:#f4d5db;background:#fff7f8}.insight-grid .rose>span{background:#ffe4e8;color:#b54e64}.insight-grid .violet{border-color:#e2d8f6;background:#faf7ff}.insight-grid .violet>span{background:#eee5ff;color:#7252b3}.insight-grid .green{border-color:#cfeadc;background:#f5fcf8}.insight-grid .green>span{background:#dcf5e8;color:#33855a}.focus-nav{display:grid;grid-template-columns:auto minmax(180px,420px) auto;align-items:center;justify-content:center;gap:22px;margin-top:12px;padding:13px 18px}.focus-nav>div{text-align:center}.focus-nav span{font-size:12px;color:#7a8799}.focus-nav strong{display:block;font-size:14px;color:var(--ink)}.progress-track{height:5px;margin-top:7px;border-radius:var(--radius-full);background:#e7eaf1;overflow:hidden}.progress-track i{display:block;height:100%;background:linear-gradient(90deg,#805ad5,#4c83df)}.lyrics-list{display:grid;gap:11px;margin-top:12px}.lyrics-list.focused{max-width:920px;margin-left:auto;margin-right:auto}.lyric-card{overflow:hidden;border:1px solid #e1e6ef;border-radius:19px;background:var(--c-surface);box-shadow:0 8px 22px rgba(51,65,85,.05);transition:.2s}.lyric-card.active{border-color:#b9a5ea;box-shadow:0 0 0 3px rgba(118,85,202,.07),0 9px 24px rgba(51,65,85,.06)}.lyric-card.completed{border-left:4px solid #43aa75}.lyric-card>header{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:10px 14px;border-bottom:1px solid #e8ebf1;background:#f8f9fc}.line-badges,.line-actions{display:flex;align-items:center;gap:7px;flex-wrap:wrap}.line-badges>span{padding:5px 8px;border-radius:var(--radius-xs);font-size:12px}.index-badge{background:#e9edf3;color:#5f6b7e}.time-badge{background:#e5f1ff;color:#3971b1}.translation-badge{background:#e3f7ec;color:#317b55}.done-badge{background:#dcf6e7;color:#2c8153}.line-actions>span{font-size:12px;color:#8a96a8}.line-actions button{padding:5px 8px;font-size:12px}.line-content{padding:18px}.token-row{display:flex;align-items:stretch;gap:6px;flex-wrap:wrap;line-height:1}.token-row>span{display:flex;flex-direction:column;justify-content:center;text-align:center;border-radius:var(--radius-sm);padding:5px 4px}.token-reading,.token-romaji{min-height:14px;color:#748196;line-height:1.2}.token-text{font-weight:600;line-height:1.35}.line-translation{margin-top:14px;padding:11px 13px;border-left:3px solid #76c89a;border-radius:0 10px 10px 0;background:#f4fbf7;line-height:1.7;color:#435266}.legend-card{display:flex;align-items:center;gap:16px;flex-wrap:wrap;margin-top:12px;padding:14px 17px}.legend-card strong{font-size:13px;color:var(--ink)}.legend-card>div{display:flex;gap:7px}.legend-card>div span{padding:5px 8px;border-radius:var(--radius-xs);font-size:12px}.legend-particle{background:#e1f2ff;color:#3477aa}.legend-ending{background:#ffe5ea;color:#ad5064}.legend-katakana{background:#eee4ff;color:#6e50ad}.legend-word{background:#edf0f5;color:#5b687b}.legend-card p{flex:1;margin:0;font-size:12px;color:#778498}.empty-study{display:flex;min-height:300px;flex-direction:column;align-items:center;justify-content:center;margin-top:14px;text-align:center}.empty-study>span{display:grid;place-items:center;width:58px;height:58px;border-radius:17px;background:#eee7ff;color:#7655ca;font-size:22px;font-weight:800}.empty-study strong{margin-top:13px;font-size:17px;color:var(--ink)}.empty-study p{font-size:13px;color:var(--muted)}.empty-study button{border-color:#b9a7e4;color:#6749af}.detail-copy{font-size:14px;line-height:1.9;color: var(--c-text-secondary)}.detail-copy p{margin:0 0 8px}.dark .source-workbench,.dark .study-toolbar,.dark .focus-nav,.dark .legend-card,.dark .empty-study,.dark .lyric-card{border-color:#344155;background:#172033}.dark .section-header p{color:#a9b5c6}.dark .source-sidebar,.dark .settings-group,.dark .font-setting{border-color:#344155;background:#111a2a}.dark .header-actions button,.dark .secondary-button,.dark .export-actions button,.dark .line-actions button,.dark .focus-nav button{border-color:#3b485d;background:#1a2638;color:#cbd6e4}.dark .meta-row span{border-color:#3b485d;background:#111a2a;color:#aab6c7}.dark .study-toolbar .view-switch{background:#111a2a}.dark .view-switch button.active{background:#29354a;color:#c7b8f2}.dark .insight-grid article{border-color:#344155;background:#172033}.dark .lyric-card>header{border-color:#344155;background:#111a2a}.dark .line-translation{background:#142b22;color:#c9d8cf}.dark .detail-copy{color:#aab7c8}@media(max-width:1050px){.source-workbench{grid-template-columns:1fr}.insight-grid{grid-template-columns:repeat(2,1fr)}}@media(max-width:680px){.source-workbench{padding:13px}.section-header,.study-toolbar,.lyric-card>header{align-items:flex-start;flex-direction:column}.header-actions,.export-actions{width:100%}.header-actions button,.export-actions button{flex:1}.study-toolbar{padding:13px}.display-switches{width:100%;justify-content:space-between}.insight-grid{grid-template-columns:1fr}.focus-nav{grid-template-columns:1fr 1fr}.focus-nav>div{grid-column:1/-1;grid-row:1}.line-actions{width:100%}.line-content{padding:14px}.legend-card{align-items:flex-start;flex-direction:column}.empty-study{min-height:250px}}</style>
