...
.workspace-card {
  ...
  box-shadow: 0 11px 28px rgba(47,43,63,.05);
}
.asset-panel {
  padding: 18px;
...
.background-upload,.custom-upload {
  display: flex;
  align-items: center;
  gap: 11px;
  width: 100%;
...
.background-upload strong,.background-upload small,.custom-upload strong,.custom-upload small {
  display: block;
}
.background-upload strong,.custom-upload strong {
  color: #494351;
  font-size: 14px;
}
.background-upload small,.custom-upload small {
  max-width: 170px;
  margin-top: 3px;
  overflow: hidden;
  color: #8c8590;
...
.tool-status>span.active {
  background: #35a779;
  box-shadow: 0 0 0 4px rgba(53,167,121,.12);
}
.tool-status strong {
  overflow: hidden;
  color: #55505c;
...
.canvas-stage.checker {
  ...
  background-image: linear-gradient(45deg,#dde0e7 25%,transparent 25%),linear-gradient(-45deg,#dde0e7 25%,transparent 25%),linear-gradient(45deg,transparent 75%,#dde0e7 75%),linear-gradient(-45deg,transparent 75%,#dde0e7 75%);
...
.canvas-stage :deep(.canvas-container) {
  flex: none;
  box-shadow: 0 14px 34px rgba(29,31,39,.18);
}
.canvas-stage canvas.hidden,.canvas-stage :deep(.canvas-container:has(canvas.hidden)) {
...
.canvas-footer div span,.canvas-footer div strong {
  display: block;
}
.canvas-footer div span {
  color: #8a8e99;
  font-size: 13px;
}
.canvas-footer div strong {
  margin-top: 2px;
  color: #505563;
  font-size: 13px;
}
...
:global(.dark) .sticker-tool {
  --ink: #f1edf5;
  --muted: #aaa3b1;
}
:global(.dark) .workspace-card,:global(.dark) .export-card {
  border-color: #3f4756;
  background: #1b2637;
}
:global(.dark) .asset-panel,:global(.dark) .canvas-toolbar,:global(.dark) .canvas-footer {
  border-color: #414958;
}
:global(.dark) .background-upload strong,:global(.dark) .custom-upload strong,:global(.dark) .tool-status strong,:global(.dark) .canvas-footer div strong,:global(.dark) .export-card strong {
  color: #ece7ef;
}
:global(.dark) .asset-panel,:global(.dark) .stage-controls {
  background: #202b3d;
}
:global(.dark) .background-upload,:global(.dark) .custom-upload,:global(.dark) .group-tabs button.active,:global(.dark) .sticker-grid button,:global(.dark) .selected-tools button,:global(.dark) .stage-controls button.active,:global(.dark) .export-options select {
  border-color: #465061;
  background: #1b2739;
  color: #c9c1ce;
}
:global(.dark) .empty-stage {
  border-color: #566173;
  background: rgba(27,38,55,.88);
}
