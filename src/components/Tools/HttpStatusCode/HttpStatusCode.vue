...
.search-card, .selected-card, .common-card, .results-card { border: 1px solid var(--c-border); border-radius: var(--radius-card); background: var(--c-surface); box-shadow: var(--shadow-card); }
...
.category-grid button { display: grid; grid-template-columns: auto minmax(0, 1fr); align-items: center; gap: 9px; min-width: 0; padding: 13px; border: 1px solid var(--c-border); border-radius: var(--radius-lg); text-align: left; background: var(--c-surface); cursor: pointer; transition: .18s ease; }
.category-grid button:hover, .category-grid button.active { transform: translateY(-2px); box-shadow: 0 8px 20px rgb(15 23 42 / 9%); }.category-grid button > strong { display: grid; width: 42px; height: 42px; place-items: center; border-radius: var(--radius-md); color: var(--c-on-accent); }.category-grid button div { display: flex; min-width: 0; flex-direction: column; }.category-grid b { color: var(--c-text-strong); font-size: 12px; }.category-grid span, .category-grid small { color: var(--c-text-muted); font-size: 9px; }.category-grid small { grid-column: 2; }
...
.search-card { padding: 17px 20px; }.search-box { display: flex; align-items: center; gap: 9px; }.search-box > .el-icon { color: var(--c-text-secondary); font-size: 20px; }.search-box :deep(.el-input__wrapper) { box-shadow: none; background: var(--c-surface-subtle); }
.filter-row { display: flex; align-items: center; justify-content: space-between; gap: 14px; margin-top: 12px; }.category-tabs { display: flex; flex-wrap: wrap; gap: 5px; }.category-tabs button { padding: 5px 11px; border: 0; border-radius: var(--radius-full); color: var(--c-text-secondary); background: #f1f5f9; cursor: pointer; }.category-tabs button.active { color: var(--c-on-accent); background: #2563eb; }
.selected-card { display: grid; grid-template-columns: 145px minmax(0, 1fr); overflow: hidden; }.selected-code { display: flex; align-items: center; justify-content: center; flex-direction: column; color: var(--c-on-accent); }.selected-code span { font-size: 48px; font-weight: 900; line-height: 1; }.selected-code small { margin-top: 7px; opacity: .8; }.tone-1 .selected-code { background: var(--sky); }.tone-2 .selected-code { background: var(--emerald); }.tone-3 .selected-code { background: var(--amber); }.tone-4 .selected-code { background: var(--rose); }.tone-5 .selected-code { background: var(--violet); }
.selected-main { min-width: 0; padding: 21px 23px; }.selected-heading, .section-heading { display: flex; align-items: center; justify-content: space-between; gap: 12px; }.selected-heading h3 { margin: 4px 0 0; color: var(--c-text-primary); font-size: 22px; }.selected-main > p { margin: 11px 0 15px; color: var(--c-text-body); line-height: 1.65; }.selected-details { display: grid; grid-template-columns: repeat(2, 1fr); gap: 9px; }.selected-details > div { display: flex; flex-direction: column; padding: 11px 13px; border-radius: var(--radius-md); background: var(--c-surface-subtle); }.selected-details span { color: var(--c-text-muted); font-size: 9px; }.selected-details strong { margin-top: 3px; color: var(--c-text-strong); font-size: 11px; line-height: 1.5; }.tag-row { display: flex; flex-wrap: wrap; gap: 5px; margin-top: 11px; }.tag-row span { padding: 3px 7px; border-radius: 99px; color: var(--c-text-body); background: #f1f5f9; font-size: 9px; }.tag-row .note-tag { color: #9a3412; background: #ffedd5; }
.common-card, .results-card { padding: 22px; }.section-heading h3 { margin: 4px 0 0; color: var(--c-text-primary); font-size: 18px; }.section-heading > span { color: var(--c-text-muted); font-size: 10px; }.common-list { display: flex; gap: 7px; margin-top: 15px; overflow-x: auto; padding-bottom: 4px; }.common-list button { display: flex; align-items: center; gap: 7px; flex: none; padding: 7px 10px; border: 1px solid var(--c-border); border-radius: var(--radius-sm); color: var(--c-text-body); background: var(--c-surface-subtle); cursor: pointer; }.common-list button.active { border-color: #93c5fd; color: #1d4ed8; background: #eff6ff; }.common-list strong { font: 800 12px ui-monospace, monospace; }.common-list span { font-size: 10px; }
.status-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px; margin-top: 17px; }.status-grid article { min-width: 0; padding: 14px; border: 1px solid var(--c-border); border-left-width: 4px; border-radius: var(--radius-md); background: var(--c-surface-subtle); cursor: pointer; transition: .18s ease; }.status-grid article:hover, .status-grid article.selected { transform: translateY(-2px); box-shadow: 0 8px 20px rgb(15 23 42 / 8%); }.status-grid .category-1 { border-left-color: var(--sky); }.status-grid .category-2 { border-left-color: var(--emerald); }.status-grid .category-3 { border-left-color: var(--amber); }.status-grid .category-4 { border-left-color: var(--rose); }.status-grid .category-5 { border-left-color: var(--violet); }.status-heading { display: flex; align-items: center; gap: 10px; }.status-heading > strong { color: var(--c-text-primary); font: 900 20px ui-monospace, monospace; }.status-heading > div { display: flex; min-width: 0; flex: 1; flex-direction: column; }.status-heading h4 { margin: 0; color: var(--c-text-strong); overflow: hidden; text-overflow: ellipsis; font-size: 12px; white-space: nowrap; }.status-heading span, .status-heading small { color: var(--c-text-muted); font-size: 9px; }.status-heading small { padding: 3px 6px; border-radius: 99px; color: #2563eb; background: #dbeafe; }.status-grid article > p { min-height: 42px; margin: 11px 0; color: var(--c-text-secondary); font-size: 11px; line-height: 1.7; }.status-footer { display: flex; align-items: center; justify-content: space-between; gap: 8px; }.status-footer > span { color: var(--c-text-muted); font-size: 9px; }.empty-state { margin-top: 16px; padding: 36px; border-radius: var(--radius-md); color: var(--c-text-muted); background: var(--c-surface-subtle); text-align: center; }

:global(html.dark .http-page .search-card), :global(html.dark .http-page .selected-card), :global(html.dark .http-page .common-card), :global(html.dark .http-page .results-card), :global(html.dark .http-page .category-grid button) { border-color: var(--c-border); background: var(--c-surface); box-shadow: none; }
:global(html.dark .http-page h3), :global(html.dark .http-page .category-grid b), :global(html.dark .http-page .status-heading > strong), :global(html.dark .http-page .status-heading h4) { color: #f8fafc; }
:global(html.dark .http-page .common-list button.active) { border-color: #1d4ed8; color: #93c5fd; background: #172554; }
:global(html.dark .http-page .search-box .el-input__wrapper), :global(html.dark .http-page .selected-details > div), :global(html.dark .http-page .common-list button), :global(html.dark .http-page .status-grid article), :global(html.dark .http-page .empty-state) { border-color: var(--c-border); color: var(--c-text-secondary); background: var(--c-surface-subtle); }
:global(html.dark .http-page .selected-main > p), :global(html.dark .http-page .selected-details strong) { color: var(--c-text-secondary); }:global(html.dark .http-page .category-grid button.active) { border-color: var(--c-border-strong); background: #172033; }
