...
.search-card, .selected-card, .common-card, .results-card { border: 1px solid var(--c-border); border-radius: 22px; background: #fff; box-shadow: 0 12px 35px rgb(15 23 42 / 6%); }
...
.category-grid button { display: grid; grid-template-columns: auto minmax(0, 1fr); align-items: center; gap: 9px; min-width: 0; padding: 13px; border: 1px solid var(--c-border); border-radius: 16px; text-align: left; background: #fff; cursor: pointer; transition: .18s ease; }
...
.filter-row { display: flex; align-items: center; justify-content: space-between; gap: 14px; margin-top: 12px; }.category-tabs { display: flex; flex-wrap: wrap; gap: 5px; }.category-tabs button { padding: 5px 11px; border: 0; border-radius: 999px; color: var(--c-text-secondary); background: #f1f5f9; cursor: pointer; }.category-tabs button.active { color: #fff; background: #2563eb; }
