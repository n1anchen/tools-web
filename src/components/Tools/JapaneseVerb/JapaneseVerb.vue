...
.search-heading span,.result-kicker,.reference-heading>span {
  color: #7a64aa;
  font-size: 13px;
  font-weight: 800;
  letter-spacing: .12em;
}
.search-card,.reference-card,.onboarding-card,.result-workbench,.notice-card {
  margin-top: 14px;
  border: 1px solid #e1e2e9;
  border-radius: 19px;
  background: var(--c-surface);
  box-shadow: 0 10px 26px rgba(48,43,64,.045);
}
.search-card {
  padding: 21px;
}
...
.search-heading h3,.reference-heading h3 {
  margin: 4px 0 0;
  color: var(--ink);
  font-size: 18px;
  font-weight: 800;
...
.search-shell:focus-within {
  border-color: #9a82d4;
  box-shadow: 0 0 0 3px rgba(109,79,194,.08);
}
.search-mark {
  display: grid;
  place-items: center;
...
.candidate-panel>button.active {
  border-color: #b8a8df;
  background: var(--c-surface);
  box-shadow: 0 5px 15px rgba(77,61,113,.07);
}
.candidate-index {
  color: #aaa3b1;
  font: 700 12px ui-monospace,SFMono-Regular,Menlo,monospace;
}
.candidate-panel strong,.candidate-panel small {
  display: block;
}
...
.matched-banner strong {
  color: #714d17;
  font-size: 15px;
}
.matched-banner span:last-child {
  color: #9b8667;
}
.form-tabs {
  display: flex;
...
.form-tabs button.active {
  background: var(--c-surface);
  color: #674aae;
  box-shadow: 0 2px 8px rgba(65,52,85,.08);
}
.form-grid {
  display: grid;
...
.form-card-heading strong,.form-card-heading span {
  display: block;
}
...
.form-chip.matched {
  ...
  background: #fff4d9;
  color: #744a09;
  box-shadow: 0 0 0 2px rgba(230,174,72,.12);
}
.form-note {
  margin: 9px 0 0;
  color: #9a7380;
...
.reference-grid strong,.reference-grid span,.reference-grid small {
  display: block;
}
...
.reference-grid .exception {
  border-color: #ecd5a9;
  background: #fffbf1;
}
.reference-grid .exception span {
  color: #9a681e;
}
:global(.dark) .verb-tool {
  --ink: #f1edf4;
  --muted: #a9a1ae;
}
:global(.dark) .search-card,:global(.dark) .reference-card,:global(.dark) .onboarding-card,:global(.dark) .result-workbench,:global(.dark) .notice-card {
  border-color: #3e4656;
  background: #1b2637;
}
:global(.dark) .quick-inputs,:global(.dark) .candidate-panel,:global(.dark) .candidate-note {
  border-color: #41495a;
}
:global(.dark) .search-shell input,:global(.dark) .candidate-panel strong,:global(.dark) .dictionary-line h3,:global(.dark) .form-card-heading strong,:global(.dark) .form-chip,:global(.dark) .reference-grid strong {
  color: #ece7ef;
}
:global(.dark) .search-shell,:global(.dark) .candidate-panel,:global(.dark) .form-tabs,:global(.dark) .onboarding-main {
  border-color: #41495a;
  background: #202b3d;
}
...
:global(.dark) .form-chip.matched {
  border-color: #b98a38;
  background: #3b3120;
  color: #ffd98f;
}
:global(.dark) .matched-banner {
  background: #352f24;
}
:global(.dark) .onboarding-main h3 {
  color: #ece6ef;
}
:global(.dark) .rule-preview div {
  border-color: #41495a;
}
:global(.dark) .reference-grid .exception {
  border-color: #705a35;
  background: #342e24;
}
...
@media (max-width:640px) {
  .search-card,.forms-panel,.reference-card {
    padding: 18px 15px;
  }
  .search-shell {
    flex-wrap: wrap;
