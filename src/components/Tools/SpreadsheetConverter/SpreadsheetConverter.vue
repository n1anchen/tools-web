...
.drop-zone strong,.drop-zone span {
  display:block
}
.drop-zone strong {
  color: #1e293b;
...
.source-summary>div,.source-summary>label {
  display: flex;
  min-width: 0;
...
.source-summary span,.option-grid label>span {
  color: var(--c-text-secondary);
  font-size: 12px;
  font-weight:750
}
...
.source-summary small,.option-grid small {
  margin-top: 5px;
  color: var(--c-text-muted);
  font-size: 11px;
  line-height:1.4
}
.source-summary select,.option-grid input,.option-grid select,.rename-bar input {
  height: 35px;
  margin-top: 6px;
  padding: 0 9px;
  border: 1px solid #dbe3ef;
...
.editor-mode-tabs strong,.editor-mode-tabs span {
  display:block
}
...
.source-editor header strong,.source-editor header span {
  display:block
}
.source-editor header strong {
  color: #1e293b;
  font-size:13px
}
.source-editor header span {
  margin-top: 3px;
  color: var(--c-text-secondary);
  font-size:11px
}
...
.source-editor footer.error {
  color: #b91c1c;
  background:#fff1f2
}
.source-editor footer small {
  font-size:11px
}
.quality-grid {
  display: grid;
...
.quality-grid span,.quality-grid strong {
  display:block
}
.quality-grid span {
  color: var(--c-text-secondary);
...
.quality-grid .warning {
  border-color: #fed7aa;
  background:#fff7ed
}
.quality-grid .warning strong {
  color:#c2410c
}
.convert-layout {
  display: grid;
...
.option-grid .toggle-field {
  display: grid;
  grid-template-columns: 1fr auto;
  align-content: center;
  align-items:center
}
.option-grid .toggle-field small {
  grid-column:1/3
}
.export-summary {
  display: flex;
...
.export-summary strong,.export-summary span {
  display:block
}
...
.preview-panel header span,.preview-panel header small {
  display:block
}
...
:global(html.dark .section-title h3),:global(html.dark .drop-zone strong),:global(html.dark .source-summary strong),:global(html.dark .quality-grid strong),:global(html.dark .detail-grid strong),:global(html.dark .source-editor header strong) {
  color:#f1f5f9
}
:global(html.dark .drop-zone) {
  border-color: var(--c-border);
  background:#172033
}
:global(html.dark .source-summary>div),:global(html.dark .source-summary>label),:global(html.dark .sheet-tabs),:global(html.dark .quality-grid>div),:global(html.dark .format-panel),:global(html.dark .detail-grid article),:global(html.dark .editor-mode-tabs),:global(html.dark .source-editor),:global(html.dark .source-editor header),:global(html.dark .source-editor footer) {
  border-color: var(--c-border);
  background:#172033
}
...
:global(html.dark .editor-mode-tabs button) {
  color: var(--c-text-muted)
}
...
:global(html.dark .source-editor footer.error) {
  color: #fecaca;
  background:#450a0a
}
...
@media(max-width:430px) {
  ...
  .format-tabs small,.editor-mode-tabs span {
    display:none
  }
}
</style>
