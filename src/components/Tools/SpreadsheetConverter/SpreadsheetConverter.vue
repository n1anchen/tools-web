  ...
  <div class="sheet-page flex flex-col mt-3 flex-1">
    ...
    <section class="hero-card">
      ...
      <div class="hero-stats">
        ...
        <div><strong>{{ totalRows.toLocaleString() }}</strong><span>数据行</span></div>
...
@media(max-width:1050px){.hero-card{align-items:flex-start;flex-direction:column}.hero-stats{width:100%;min-width:0}.hero-stats div:first-child{border-left:0}.convert-layout{grid-template-columns:1fr}.preview-panel{min-height:340px}.preview-panel pre{max-height:340px}}
@media(max-width:760px){.sheet-page{gap:12px}.hero-card,.source-card,.editor-card,.convert-card{border-radius:16px}.hero-card{padding:20px}.hero-copy h2{font-size:22px}.hero-stats div{padding:6px 10px}.hero-stats strong{font-size:19px}.source-card,.editor-card,.convert-card{padding:15px}.section-title{flex-direction:column}.import-layout{grid-template-columns:1fr}.source-summary{grid-template-columns:1fr 1fr}.drop-zone{align-items:flex-start;flex-wrap:wrap}.drop-zone div{min-width:170px}.sheet-actions{width:100%;justify-content:flex-start}.sheet-actions button{flex:1;justify-content:center;padding:0 7px}.editor-mode-tabs button{padding:9px 7px;text-align:center}.editor-mode-tabs span{font-size:10px}.source-editor header{align-items:flex-start;flex-direction:column}.source-editor header button{width:100%}.source-editor textarea{min-height:260px}.source-editor footer{align-items:flex-start;flex-direction:column}.quality-grid{grid-template-columns:repeat(2,1fr)}.option-grid{grid-template-columns:1fr}.format-tabs button{font-size:12px}.export-summary{align-items:stretch;flex-direction:column}.detail-grid{grid-template-columns:1fr}.rename-bar{align-items:stretch;flex-wrap:wrap}.rename-bar label{flex-basis:100%}}
@media(max-width:430px){.source-summary{grid-template-columns:1fr}.hero-stats span{font-size:10px}.format-tabs small,.editor-mode-tabs span{display:none}}
</style>
