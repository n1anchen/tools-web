...
<template>
  <div class="sheet-page flex flex-col mt-3 flex-1">
    <ToolHero summary="XLSX、CSV 与 JSON，在一张表里自由往返">
      <template #metrics>
        <MetricsBar :items="[{ label: '工作表', value: sheets.length }, { label: '数据行', value: totalRows.toLocaleString() }, { label: '有效单元格', value: totalCells.toLocaleString() }]" />
      </template>
    </ToolHero>
...
<style scoped>
.sheet-page{--accent:#2563eb;--accent-soft:#eff6ff;gap:18px}.source-card,.editor-card,.convert-card{border: 1px solid var(--c-border);border-radius:var(--radius-card);background:var(--c-surface);box-shadow: var(--shadow-card)}.eyebrow{display:block;color:var(--accent);font-size:11px;font-weight:900;letter-spacing:.14em}.source-card,.editor-card,.convert-card{padding:22px}.section-title{display:flex;align-items:flex-start;justify-content:space-between;gap:18px}.section-title h3{margin:4px 0 5px;color: var(--c-text-primary);font-size:19px}.section-title p{margin:0;color: var(--c-text-secondary);font-size:13px;line-height:1.6}.import-layout{display:grid;grid-template-columns:minmax(0,1.5fr) minmax(250px,.5fr);gap:14px;margin-top:17px}.drop-zone{display:flex;min-height:112px;align-items:center;gap:14px;padding:18px;border:1.5px dashed #bfdbfe;border-radius:var(--radius-lg);background:#f8fbff;transition:.18s}.drop-zone.dragging{border-color:var(--accent);background:#eff6ff;transform:translateY(-2px)}.drop-zone>.el-icon{flex:none;color:var(--accent);font-size:31px}.drop-zone div{flex:1}.drop-zone strong,.drop-zone span{display:block}.drop-zone strong{color:#1e293b;font-size:14px}.drop-zone span{margin-top:4px;color: var(--c-text-secondary);font-size:12px}.drop-zone button,.sheet-actions button,.rename-bar button{min-height:34px;padding:0 12px;border:1px solid #dbe3ef;border-radius:var(--radius-sm);background:var(--c-surface);color: var(--c-text-strong);font-size:12px;font-weight:800;cursor:pointer}.drop-zone button{border-color:var(--accent);color:var(--accent)}.source-summary{display:grid;grid-template-columns:1fr 1fr;gap:10px}.source-summary>div,.source-summary>label{display:flex;min-width:0;flex-direction:column;justify-content:center;padding:13px;border: 1px solid var(--c-border);border-radius:var(--radius-md);background: var(--c-surface-subtle)}.source-summary span,.option-grid label>span{color: var(--c-text-secondary);font-size:12px;font-weight:750}.source-summary strong{overflow:hidden;margin-top:5px;color:#1e293b;font-size:14px;text-overflow:ellipsis;white-space:nowrap}.source-summary small,.option-grid small{margin-top:5px;color: var(--c-text-muted);font-size:11px;line-height:1.4}.source-summary select,.option-grid input,.option-grid select,.rename-bar input{height:35px;margin-top:6px;padding:0 9px;border:1px solid #dbe3ef;border-radius:var(--radius-xs);background:var(--c-surface);color: var(--c-text-strong);font-size:12px}.sheet-actions{display:flex;flex-wrap:wrap;justify-content:flex-end;gap:6px}.sheet-actions button{display:flex;align-items:center;gap:5px}.sheet-actions button:hover{border-color:var(--accent);color:var(--accent)}.sheet-actions button.danger:hover{border-color:#ef4444;color:#dc2626}.editor-mode-tabs{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin-top:17px;padding:7px;border:1px solid #dbe3ef;border-radius:var(--radius-md);background:#f1f5f9}.editor-mode-tabs button{padding:10px 12px;border:1px solid transparent;border-radius:var(--radius-sm);background:transparent;color: var(--c-text-secondary);text-align:left;cursor:pointer}.editor-mode-tabs strong,.editor-mode-tabs span{display:block}.editor-mode-tabs strong{font-size:13px}.editor-mode-tabs span{margin-top:3px;font-size:11px}.editor-mode-tabs button.active{border-color:#bfdbfe;background:var(--c-surface);color:#1d4ed8;box-shadow:0 4px 12px rgba(37,99,235,.1)}.sheet-tabs{display:flex;gap:7px;margin:10px 0 0;padding:8px;overflow-x:auto;border: 1px solid var(--c-border);border-radius:var(--radius-md);background: var(--c-surface-subtle)}.sheet-tabs button{display:flex;flex:none;align-items:center;gap:6px;padding:9px 11px;border:1px solid transparent;border-radius:var(--radius-sm);background:transparent;color: var(--c-text-body);font-size:12px;font-weight:800;cursor:pointer}.sheet-tabs button span{min-width:21px;padding:2px 5px;border-radius:var(--radius-full);background:#e2e8f0;color: var(--c-text-secondary);font-size:10px;text-align:center}.sheet-tabs button.active{border-color:#bfdbfe;background:var(--c-surface);color:var(--accent);box-shadow:0 3px 10px rgba(37,99,235,.1)}.sheet-tabs button.active span{background:#dbeafe;color:#1d4ed8}.rename-bar{display:flex;align-items:flex-end;gap:7px;margin-top:10px;padding:10px;border-radius:var(--radius-md);background:#eff6ff}.rename-bar label{display:flex;flex:1;flex-direction:column;color: var(--c-text-body);font-size:11px;font-weight:800}.rename-bar input{margin-top:4px}.source-editor{margin-top:11px;overflow:hidden;border:1px solid #dbe3ef;border-radius:var(--radius-md);background:var(--c-surface)}.source-editor header{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:11px 13px;border-bottom: 1px solid var(--c-border);background: var(--c-surface-subtle)}.source-editor header strong,.source-editor header span{display:block}.source-editor header strong{color:#1e293b;font-size:13px}.source-editor header span{margin-top:3px;color: var(--c-text-secondary);font-size:11px}.source-editor header button{flex:none;min-height:34px;padding:0 13px;border:0;border-radius:var(--radius-sm);background:var(--accent);color: var(--c-on-accent);font-size:12px;font-weight:850;cursor:pointer}.source-editor textarea{display:block;width:100%;min-height:290px;padding:14px;border:0;outline:0;resize:vertical;background:#0f172a;color:#dbeafe;font:12px/1.65 ui-monospace,SFMono-Regular,Menlo,monospace;tab-size:2}.source-editor textarea:focus{box-shadow:inset 0 0 0 2px var(--accent)}.source-editor footer{display:flex;align-items:center;justify-content:space-between;gap:10px;min-height:38px;padding:7px 12px;border-top: 1px solid var(--c-border);background: var(--c-surface-subtle);color: var(--c-text-secondary);font-size:11px}.source-editor footer.error{color:#b91c1c;background:#fff1f2}.source-editor footer small{font-size:11px}.quality-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:9px;margin-top:11px}.quality-grid>div{padding:11px 13px;border: 1px solid var(--c-border);border-radius:var(--radius-md);background: var(--c-surface-subtle)}.quality-grid span,.quality-grid strong{display:block}.quality-grid span{color: var(--c-text-secondary);font-size:11px}.quality-grid strong{margin-top:4px;color:#1e293b;font-size:13px}.quality-grid .warning{border-color:#fed7aa;background:#fff7ed}.quality-grid .warning strong{color:#c2410c}.convert-layout{display:grid;grid-template-columns:minmax(0,1.15fr) minmax(330px,.85fr);gap:14px;margin-top:17px}.format-panel,.preview-panel{border: 1px solid var(--c-border);border-radius:var(--radius-lg);background: var(--c-surface-subtle)}.format-panel{padding:13px}.format-tabs{display:grid;grid-template-columns:repeat(3,1fr);gap:7px}.format-tabs button{padding:11px 8px;border:1px solid #dbe3ef;border-radius:var(--radius-sm);background:var(--c-surface);color: var(--c-text-body);font-size:13px;font-weight:850;cursor:pointer}.format-tabs small{display:block;margin-top:3px;color: var(--c-text-muted);font-size:10px;font-weight:600}.format-tabs button.active{border-color:#93c5fd;background:#eff6ff;color:#1d4ed8;box-shadow:0 3px 12px rgba(37,99,235,.1)}.option-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px;margin-top:11px}.option-grid label{display:flex;min-height:75px;flex-direction:column;padding:10px;border: 1px solid var(--c-border);border-radius:var(--radius-sm);background:var(--c-surface)}.option-grid .toggle-field{display:grid;grid-template-columns:1fr auto;align-content:center;align-items:center}.option-grid .toggle-field small{grid-column:1/3}.export-summary{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-top:12px;padding:12px;border-radius:var(--radius-md);background:#eaf2ff}.export-summary strong,.export-summary span{display:block}.export-summary strong{color:#1e3a8a;font-size:14px}.export-summary span{margin-top:4px;color: var(--c-text-secondary);font-size:11px}.preview-panel{display:flex;min-height:430px;flex-direction:column;overflow:hidden;background:#0f172a}.preview-panel header{display:flex;align-items:center;justify-content:space-between;padding:12px 13px;border-bottom:1px solid #334155}.preview-panel header span,.preview-panel header small{display:block}.preview-panel header span{color:#f8fafc;font-size:13px;font-weight:850}.preview-panel header small{margin-top:3px;color: var(--c-text-muted);font-size:10px}.preview-panel pre{flex:1;max-height:425px;margin:0;padding:14px;overflow:auto;color:#bfdbfe;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:12px;line-height:1.65;white-space:pre}.detail-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:12px}.detail-grid article{padding:15px;border: 1px solid var(--c-border);border-radius:var(--radius-md);background: var(--c-surface-subtle)}.detail-grid strong{color:#1e293b;font-size:13px}.detail-grid p{margin:6px 0 0;color: var(--c-text-secondary);font-size:12px;line-height:1.7}
:global(html.dark .sheet-page){--accent:#60a5fa;--accent-soft:#172554}:global(html.dark .source-card),:global(html.dark .editor-card),:global(html.dark .convert-card){border-color: var(--c-border);background:var(--c-surface);box-shadow:none}:global(html.dark .section-title h3),:global(html.dark .drop-zone strong),:global(html.dark .source-summary strong),:global(html.dark .quality-grid strong),:global(html.dark .detail-grid strong),:global(html.dark .source-editor header strong){color:#f1f5f9}:global(html.dark .drop-zone){border-color: var(--c-border);background:#172033}:global(html.dark .source-summary>div),:global(html.dark .source-summary>label),:global(html.dark .sheet-tabs),:global(html.dark .quality-grid>div),:global(html.dark .format-panel),:global(html.dark .detail-grid article),:global(html.dark .editor-mode-tabs),:global(html.dark .source-editor),:global(html.dark .source-editor header),:global(html.dark .source-editor footer){border-color: var(--c-border);background:#172033}:global(html.dark .source-summary select),:global(html.dark .option-grid input),:global(html.dark .option-grid select),:global(html.dark .rename-bar input),:global(html.dark .option-grid label),:global(html.dark .format-tabs button),:global(html.dark .sheet-actions button),:global(html.dark .rename-bar button),:global(html.dark .editor-mode-tabs button.active){border-color: var(--c-border-strong);background:var(--c-surface-subtle);color: var(--c-text-secondary)}:global(html.dark .editor-mode-tabs button){color: var(--c-text-muted)}:global(html.dark .editor-mode-tabs button.active){border-color:#3b82f6;color:#93c5fd}:global(html.dark .sheet-tabs button){color: var(--c-text-secondary)}:global(html.dark .sheet-tabs button.active){border-color:#3b82f6;background:#172554;color:#93c5fd}:global(html.dark .export-summary){background:#172554}:global(html.dark .export-summary strong){color:#bfdbfe}:global(html.dark .quality-grid .warning){border-color:#9a3412;background:#431407}:global(html.dark .source-editor footer.error){color:#fecaca;background:#450a0a}@media(max-width:1050px){.convert-layout{grid-template-columns:1fr}.preview-panel{min-height:340px}.preview-panel pre{max-height:340px}}@media(max-width:760px){.sheet-page{gap:12px}.source-card,.editor-card,.convert-card{border-radius:var(--radius-lg)}.source-card,.editor-card,.convert-card{padding:15px}.section-title{flex-direction:column}.import-layout{grid-template-columns:1fr}.source-summary{grid-template-columns:1fr 1fr}.drop-zone{align-items:flex-start;flex-wrap:wrap}.drop-zone div{min-width:170px}.sheet-actions{width:100%;justify-content:flex-start}.sheet-actions button{flex:1;justify-content:center;padding:0 7px}.editor-mode-tabs button{padding:9px 7px;text-align:center}.editor-mode-tabs span{font-size:10px}.source-editor header{align-items:flex-start;flex-direction:column}.source-editor header button{width:100%}.source-editor textarea{min-height:260px}.source-editor footer{align-items:flex-start;flex-direction:column}.quality-grid{grid-template-columns:repeat(2,1fr)}.option-grid{grid-template-columns:1fr}.format-tabs button{font-size:12px}.export-summary{align-items:stretch;flex-direction:column}.detail-grid{grid-template-columns:1fr}.rename-bar{align-items:stretch;flex-wrap:wrap}.rename-bar label{flex-basis:100%}}@media(max-width:430px){.source-summary{grid-template-columns:1fr}.format-tabs small,.editor-mode-tabs span{display:none}}</style>
