...
.hero-service-state.online {
  border-color: #bee2d5;
  background: rgba(242,252,248,.8);
}
.hero-service-state.online .state-dot {
  background: #19a36f;
}
.hero-service-state strong {
  color: var(--c-text-strong);
  font-size: 12px;
}
.hero-service-state small {
  color: var(--c-text-muted);
  font-size: 11px;
}
.input-heading span,.setting-heading span,.result-heading span {
  color: #4c837e;
  font-size: 13px;
  font-weight: 800;
  letter-spacing: .12em;
}
.input-card,.settings-card,.result-card,.safety-card {
  margin-top: 14px;
  padding: 21px;
  border: 1px solid #dfe7e9;
  border-radius: 19px;
  background: var(--c-surface);
  box-shadow: 0 10px 26px rgba(31,57,61,.045);
}
.input-heading,.result-heading,.chain-heading {
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: 12px;
}
.input-heading h3,.setting-heading h3,.result-heading h3 {
  margin: 4px 0 0;
  color: var(--ink);
  font-size: 18px;
  font-weight: 800;
...
.diagnostics-row,.result-summary {
  display: grid;
...
.diagnostics-row div,.result-summary div {
  min-width: 0;
  padding: 11px 14px;
  border-right: 1px solid #e2e9eb;
}
.diagnostics-row div:last-child,.result-summary div:last-child {
  border-right: 0;
}
.diagnostics-row span,.result-summary span {
  display: block;
  color: #7c8996;
  font-size: 13px;
}
.diagnostics-row strong,.result-summary strong {
  display: block;
  margin-top: 4px;
  overflow: hidden;
  color: #415162;
...
.cleanup-options button.active {
  border-color: #5da49c;
  background: #f0faf7;
  box-shadow: 0 0 0 2px rgba(15,118,110,.07);
}
.cleanup-options strong,.cleanup-options span {
  display: block;
}
.cleanup-options strong {
  color: #3f4e5d;
  font-size: 14px;
}
.cleanup-options span {
  margin-top: 4px;
  color: #81909d;
  font-size: 13px;
  line-height: 1.45;
}
.cleanup-options button.active strong {
  color: #126f67;
}
.tracking-settings {
  padding: 15px;
...
.tracking-title strong,.tracking-title span {
  display: block;
}
...
.tracking-settings label strong {
  color: #226f69;
}
...
.final-url-box>div:nth-child(2) {
  min-width: 0;
}
.final-url-box span,.final-url-box a {
  display: block;
}
.final-url-box span {
  color: #7c8a95;
...
.final-url-box a {
  ...
  color: #176f8a;
  font: 650 14px/1.55 ui-monospace,SFMono-Regular,Menlo,monospace;
}
.url-actions {
  display: flex;
  gap: 6px;
...
.chain-section li:not(:last-child)::after {
  content: "";
  position: absolute;
  left: 15px;
  top: 31px;
...
.chain-section li strong,.chain-section li code {
  display: block;
}
.chain-section li strong {
  color: #566674;
  font-size: 13px;
}
.chain-section li code {
  margin-top: 4px;
  overflow-wrap: anywhere;
  color: #6f7d89;
  font-size: 13px;
...
.safety-card>div:first-child>span {
  display: grid;
  place-items: center;
  width: 38px;
  height: 38px;
...
:global(.dark) .input-card,:global(.dark) .settings-card,:global(.dark) .result-card,:global(.dark) .safety-card {
  border-color: #344850;
  background: #17242f;
}
:global(.dark) .tracking-settings,:global(.dark) .url-input-shell,:global(.dark) .cleanup-options button {
  border-color: #3c5057;
  background: #1c2b36;
}
:global(.dark) .url-input-shell input,:global(.dark) .cleanup-options strong,:global(.dark) .tracking-title strong,:global(.dark) .diagnostics-row strong,:global(.dark) .result-summary strong,:global(.dark) .chain-heading strong,:global(.dark) .safety-card p strong {
  color: #dce7e8;
}
:global(.dark) .cleanup-options button.active {
  border-color: #4e958d;
  background: #183632;
}
...
:global(.dark) .final-url-box {
  border-color: #315951;
  background: #17332f;
}
:global(.dark) .final-url-box a {
  color: #74c0d2;
}
:global(.dark) .hero-service-state {
  border-color: #3c5057;
  background: #1c2b36;
}
:global(.dark) .hero-service-state strong {
  color: #dce7e8;
}
...
@media (max-width:640px) {
  .input-card,.settings-card,.result-card {
    padding: 18px 15px;
  }
  .url-input-shell {
    flex-wrap: wrap;
  ...
  .diagnostics-row div:nth-child(2),.result-summary div:nth-child(2) {
    border-right: 0;
  }
  .diagnostics-row div:nth-child(-n+2),.result-summary div:nth-child(-n+2) {
