...
.preview-card,.settings-card,.results-card {
  padding: 20px;
  border-radius:24px
}
.settings-card {
...
.source-meta span,.source-meta strong {
  display:block
}
.source-meta span {
...
.output-summary div:last-child {
  border:0
}
.output-summary span,.output-summary strong {
  display:block
}
.output-summary span {
  color: var(--c-text-muted);
...
:global(html.dark .cut-page .upload-card),:global(html.dark .cut-page .preview-card),:global(html.dark .cut-page .settings-card),:global(html.dark .cut-page .results-card),:global(html.dark .cut-page .feature-strip article) {
  border-color: var(--c-border);
  background-color: var(--c-surface);
  box-shadow:none
}
:global(html.dark .cut-page .upload-card.dragging),:global(html.dark .cut-page .setting-note) {
  background:#0f2f2d
}
:global(html.dark .cut-page .upload-card h3),:global(html.dark .cut-page .card-heading h3),:global(html.dark .cut-page .feature-strip strong) {
  color:#f8fafc
}
:global(html.dark .cut-page .upload-card p),:global(html.dark .cut-page .field-group>label),:global(html.dark .cut-page .slider-field>label),:global(html.dark .cut-page .feature-strip p) {
  color: var(--c-text-muted)
}
:global(html.dark .cut-page .source-meta),:global(html.dark .cut-page .source-meta div),:global(html.dark .cut-page .preset-grid button),:global(html.dark .cut-page .output-summary),:global(html.dark .cut-page .output-summary div),:global(html.dark .cut-page .result-grid button) {
  border-color: var(--c-border)
}
:global(html.dark .cut-page .source-meta strong),:global(html.dark .cut-page .output-summary strong) {
  color: var(--c-text-primary)
}
:global(html.dark .cut-page .preset-grid button),:global(html.dark .cut-page .result-grid button) {
  color: var(--c-text-muted);
  background:var(--c-surface-subtle)
}
...
@media(max-width:720px) {
  ...
  .source-meta div:first-child {
    grid-column: 1/-1;
    border-right: 0;
    border-bottom: 1px solid var(--c-border)
  }
  .source-meta div:nth-child(2) {
    border-bottom:0
  }
  .result-grid {
