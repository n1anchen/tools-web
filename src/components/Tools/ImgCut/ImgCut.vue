...
<template>
  <div class="cut-page flex flex-col mt-3 flex-1">
    <ToolHero summary="每一格，都完整覆盖原图">
      <template #metrics>
        <MetricsBar :items="[{ label: sourceUrl ? `${sliceCount} 张切片` : '自由网格', value: sourceUrl ? `${state.rows} × ${state.columns}` : 'R × C' }]" />
      </template>
    </ToolHero>
...
<style scoped>
.cut-page { --cut-accent: #0d9488; gap: 16px; }.upload-card,.preview-card,.settings-card,.results-card,.feature-strip article { border: 1px solid var(--c-border); background: var(--c-surface); box-shadow: 0 16px 40px rgba(15,23,42,.06); }.eyebrow{display:block;margin-bottom:6px;color:#0f766e;font-size:11px;font-weight:900;letter-spacing:.16em}.upload-card{min-height:430px;padding:58px 24px;border-radius:24px;text-align:center;display:grid;place-items:center;align-content:center;transition:.2s}.upload-card.dragging{border-color:#14b8a6;background:#f0fdfa;transform:translateY(-2px)}.upload-icon{display:grid;place-items:center;width:72px;height:72px;margin-bottom:18px;border-radius:var(--radius-card);color: var(--c-on-accent);font-size:34px;background:linear-gradient(145deg,#0d9488,#2563eb);box-shadow:0 14px 28px rgba(13,148,136,.24)}.upload-card h3,.card-heading h3{margin:0;color: var(--c-text-primary)}.upload-card h3{font-size:24px}.upload-card p{max-width:610px;margin:10px auto 22px;color: var(--c-text-secondary);line-height:1.7}.upload-actions{display:flex;gap:10px}.studio-grid{display:grid;grid-template-columns:minmax(0,1.5fr) minmax(330px,.8fr);gap:16px;align-items:start}.preview-card,.settings-card,.results-card{padding:20px;border-radius:24px}.settings-card{position:sticky;top:82px}.card-heading{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:16px}.card-heading .eyebrow{margin-bottom:3px}.header-actions{display:flex;gap:8px}.status-pill{padding:5px 9px;border-radius:var(--radius-full);color:#0f766e;background:#ccfbf1;font-size:10px;font-weight:800;text-transform:uppercase}.image-stage{position:relative;min-height:400px;display:grid;place-items:center;padding:18px;overflow:auto;border-radius:var(--radius-lg);background:#0f172a}.image-frame{position:relative;display:inline-flex;max-width:100%;max-height:68vh}.image-frame img{display:block;max-width:100%;max-height:68vh;object-fit:contain}.grid-overlay{position:absolute;inset:0;display:grid;pointer-events:none}.grid-overlay span{display:grid;place-items:center;border:1px solid rgba(255,255,255,.86);color: var(--c-on-accent);font-size:11px;font-weight:800;text-shadow:0 1px 4px #000;background:rgba(15,23,42,.08)}.processing-mask{position:absolute;inset:0;display:grid;place-items:center;color: var(--c-on-accent);background:rgba(15,23,42,.62);font-size:13px}.source-meta{display:grid;grid-template-columns:1.5fr 1fr 1fr;margin-top:14px;border: 1px solid var(--c-border);border-radius:var(--radius-md);overflow:hidden}.source-meta div{min-width:0;padding:11px 13px;border-right: 1px solid var(--c-border)}.source-meta div:last-child{border:0}.source-meta span,.source-meta strong{display:block}.source-meta span{color: var(--c-text-muted);font-size:10px}.source-meta strong{margin-top:3px;overflow:hidden;color: var(--c-text-strong);font-size:12px;text-overflow:ellipsis;white-space:nowrap}.preset-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:18px}.preset-grid button{display:flex;align-items:center;justify-content:space-between;padding:11px;border: 1px solid var(--c-border);border-radius:var(--radius-md);color: var(--c-text-body);background: var(--c-surface-subtle);cursor:pointer}.preset-grid button strong{font-size:12px}.preset-grid button span{color: var(--c-text-muted);font-size:10px}.preset-grid button.active{border-color:#2dd4bf;color:#0f766e;background:#f0fdfa;box-shadow:inset 0 0 0 1px #5eead4}.number-grid{display:grid;grid-template-columns:1fr 28px 1fr;align-items:end;gap:7px}.number-grid :deep(.el-input-number){width:100%}.field-group{margin-bottom:15px}.field-group>label,.slider-field>label{display:flex;justify-content:space-between;margin-bottom:7px;color: var(--c-text-body);font-size:12px;font-weight:700}.swap-symbol{padding-bottom:21px;color: var(--c-text-muted);text-align:center}.setting-note{margin:0 0 16px;padding:12px 13px;border-left:3px solid #14b8a6;border-radius:0 12px 12px 0;background:#f0fdfa}.setting-note b{color:#0f766e;font-size:12px}.setting-note p{margin:4px 0 0;color: var(--c-text-secondary);font-size:11px;line-height:1.55}.slider-field{margin-bottom:14px}.slider-field label strong{color:#0d9488}.output-summary{display:grid;grid-template-columns:repeat(3,1fr);margin:16px 0;border: 1px solid var(--c-border);border-radius:var(--radius-md);overflow:hidden}.output-summary div{padding:10px 7px;border-right: 1px solid var(--c-border);text-align:center}.output-summary div:last-child{border:0}.output-summary span,.output-summary strong{display:block}.output-summary span{color: var(--c-text-muted);font-size:9px}.output-summary strong{margin-top:4px;color: var(--c-text-strong);font-size:11px}.zip-button{width:100%}.result-hint{color: var(--c-text-muted);font-size:11px}.result-grid{display:grid;grid-template-columns:repeat(var(--columns),minmax(100px,1fr));gap:10px}.result-grid button{min-width:0;padding:0;overflow:hidden;border: 1px solid var(--c-border);border-radius:var(--radius-md);background: var(--c-surface-subtle);cursor:pointer;transition:.18s}.result-grid button:hover{border-color:#2dd4bf;transform:translateY(-2px);box-shadow:0 10px 20px rgba(13,148,136,.12)}.result-grid img{display:block;width:100%;aspect-ratio:1/1;object-fit:cover;background:#e2e8f0}.result-grid button>span{display:flex;align-items:center;gap:7px;padding:8px;color: var(--c-text-secondary);font-size:10px}.result-grid b{color:#0f766e}.result-grid .el-icon{margin-left:auto}.result-loading{padding:36px;color: var(--c-text-muted);text-align:center}.feature-strip{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}.feature-strip article{display:flex;gap:12px;padding:17px;border-radius:var(--radius-lg)}.feature-strip article>b{display:grid;place-items:center;flex:0 0 34px;height:34px;border-radius:var(--radius-sm);color:#0f766e;background:#ccfbf1;font-size:11px}.feature-strip strong{color:#1e293b;font-size:13px}.feature-strip p{margin:4px 0 0;color: var(--c-text-secondary);font-size:11px;line-height:1.55}:global(html.dark .cut-page .upload-card),:global(html.dark .cut-page .preview-card),:global(html.dark .cut-page .settings-card),:global(html.dark .cut-page .results-card),:global(html.dark .cut-page .feature-strip article){border-color: var(--c-border);background-color:var(--c-surface);box-shadow:none}:global(html.dark .cut-page .upload-card.dragging),:global(html.dark .cut-page .setting-note){background:#0f2f2d}:global(html.dark .cut-page .upload-card h3),:global(html.dark .cut-page .card-heading h3),:global(html.dark .cut-page .feature-strip strong){color:#f8fafc}:global(html.dark .cut-page .upload-card p),:global(html.dark .cut-page .field-group>label),:global(html.dark .cut-page .slider-field>label),:global(html.dark .cut-page .feature-strip p){color: var(--c-text-muted)}:global(html.dark .cut-page .source-meta),:global(html.dark .cut-page .source-meta div),:global(html.dark .cut-page .preset-grid button),:global(html.dark .cut-page .output-summary),:global(html.dark .cut-page .output-summary div),:global(html.dark .cut-page .result-grid button){border-color: var(--c-border)}:global(html.dark .cut-page .source-meta strong),:global(html.dark .cut-page .output-summary strong){color: var(--c-text-primary)}:global(html.dark .cut-page .preset-grid button),:global(html.dark .cut-page .result-grid button){color: var(--c-text-muted);background:var(--c-surface-subtle)}:global(html.dark .cut-page .preset-grid button.active){color:#5eead4;background:#134e4a}:global(html.dark .cut-page .feature-strip article>b){background:#134e4a;color:#5eead4}@media(max-width:1080px){.studio-grid{grid-template-columns:1fr}.settings-card{position:static}.image-stage{min-height:340px}}@media(max-width:720px){.cut-page{gap:12px}.upload-card{min-height:360px;padding:38px 18px}.upload-actions{flex-direction:column;width:100%}.upload-actions :deep(.el-button){width:100%;margin-left:0}.preview-card,.settings-card,.results-card{padding:15px;border-radius:var(--radius-card)}.card-heading{align-items:flex-start}.header-actions{display:grid}.image-stage{min-height:260px;padding:10px}.source-meta{grid-template-columns:1fr 1fr}.source-meta div:first-child{grid-column:1/-1;border-right:0;border-bottom: 1px solid var(--c-border)}.source-meta div:nth-child(2){border-bottom:0}.result-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important}.feature-strip{grid-template-columns:1fr}.output-summary{grid-template-columns:1fr}.output-summary div{border-right:0;border-bottom: 1px solid var(--c-border)}.output-summary div:last-child{border-bottom:0}}</style>
