...
<style scoped>
.reaction-page { --blue: #2563eb; gap: 16px; }.session-bar, .stats-card, .history-card, .tips-grid article { border: 1px solid #e2e8f0; border-radius: 22px; background: #fff; box-shadow: 0 12px 35px rgb(15 23 42 / 6%); }.eyebrow { color: var(--blue); font-size:12px; font-weight: 800; letter-spacing: .15em; }.hero-metrics{display:grid;grid-template-columns:minmax(160px,1fr);min-width:200px;overflow:hidden;border:1px solid #e0e9f4;border-radius:18px;background:rgba(255,255,255,.78)}
