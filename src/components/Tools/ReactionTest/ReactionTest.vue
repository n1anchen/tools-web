...
<style scoped>
.reaction-page { --blue: #2563eb; gap: 16px; }.session-bar, .stats-card, .history-card, .tips-grid article { border: 1px solid var(--c-border); border-radius: 22px; background: #fff; box-shadow: 0 12px 35px rgb(15 23 42 / 6%); }.eyebrow { color: var(--blue); font-size:12px; font-weight: 800; letter-spacing: .15em; }
.session-bar { display: flex; align-items: center; justify-content: space-between; gap: 18px; padding: 13px 17px; }.round-options { display: flex; align-items: center; gap: 6px; }.round-options > span { margin-right: 4px; color: var(--c-text-secondary); font-size:12px; }.round-options button { padding: 6px 10px; border: 0; border-radius: 9px; color: var(--c-text-secondary); background: #f1f5f9; font-size:12px; cursor: pointer; }.round-options button.active { color: #fff; background: #2563eb; }.round-options button:disabled { cursor: not-allowed; opacity: .5; }.session-progress { display: grid; grid-template-columns: auto 150px auto; align-items: center; gap: 8px; color: var(--c-text-secondary); font-size:12px; }.session-progress > div { height: 6px; overflow: hidden; border-radius: 99px; background: #e2e8f0; }.session-progress i { display: block; height: 100%; border-radius: inherit; background: linear-gradient(90deg, #3b82f6, #22c55e); transition: width .3s ease; }.session-progress small { color: #ef4444; }
