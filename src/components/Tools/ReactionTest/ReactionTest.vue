...
.state-waiting {
  ...
  box-shadow: 0 18px 45px rgb(245 158 11 / 24%);
}
.state-active {
  background: linear-gradient(145deg, #16a34a, #22c55e);
  box-shadow: 0 18px 45px rgb(34 197 94 / 25%);
}
.state-tooEarly {
  background: linear-gradient(145deg, #dc2626, #f43f5e);
  box-shadow: 0 18px 45px rgb(244 63 94 / 24%);
}
.state-roundResult {
...
.stage-noise {
  ...
  inset: 0;
  opacity: .14;
  background-image: radial-gradient(circle at 20% 25%, #fff 0 1px, transparent 1.5px), radial-gradient(circle at 75% 70%, #fff 0 1px, transparent 1.5px);
...
.target-rings i:nth-child(2) {
  inset: 42px;
}
.target-rings i:nth-child(3) {
  inset: 84px;
}
.target-rings > .el-icon {
  font-size: 32px;
}
.state-active .target-rings {
...
:global(html.dark .reaction-page .session-bar), :global(html.dark .reaction-page .stats-card), :global(html.dark .reaction-page .history-card), :global(html.dark .reaction-page .tips-grid article) {
  border-color: var(--c-border);
  background: var(--c-surface);
  box-shadow: none;
}
:global(html.dark .reaction-page h2), :global(html.dark .reaction-page h3), :global(html.dark .reaction-page .stat-grid strong), :global(html.dark .reaction-page .tips-grid strong) {
  color: #f8fafc;
}
:global(html.dark .reaction-page .round-options button), :global(html.dark .reaction-page .stat-grid > div), :global(html.dark .reaction-page .history-chart > div > div) {
  color: var(--c-text-secondary);
  background: var(--c-surface-subtle);
}
