...
<style scoped>
.reaction-page { --blue: #2563eb; gap: 16px; }.hero-card, .session-bar, .stats-card, .history-card, .tips-grid article { border: 1px solid #e2e8f0; border-radius: 22px; background: #fff; box-shadow: 0 12px 35px rgb(15 23 42 / 6%); }.hero-card { display: flex; align-items: center; justify-content: space-between; gap: 22px; padding: 25px 28px; background: radial-gradient(circle at 88% 10%, #dcfce7, transparent 28%), #fff; }.eyebrow { color: var(--blue); font-size: 10px; font-weight: 800; letter-spacing: .15em; }.hero-card h2 { margin: 6px 0 4px; color: #0f172a; font-size: clamp(21px, 3vw, 28px); }.hero-card p { margin: 0; color: #64748b; font-size: 13px; }.best-badge { display: flex; align-items: center; gap: 9px; flex: none; padding: 10px 13px; border: 1px solid #fde68a; border-radius: 14px; color: #b45309; background: #fffbeb; }.best-badge > .el-icon { font-size: 23px; }.best-badge span { display: flex; flex-direction: column; font-size: 8px; }.best-badge strong { font-size: 13px; }
.session-bar { display: flex; align-items: center; justify-content: space-between; gap: 18px; padding: 13px 17px; }.round-options { display: flex; align-items: center; gap: 6px; }.round-options > span { margin-right: 4px; color: #64748b; font-size: 10px; }.round-options button { padding: 6px 10px; border: 0; border-radius: 9px; color: #64748b; background: #f1f5f9; font-size: 10px; cursor: pointer; }.round-options button.active { color: #fff; background: #2563eb; }.round-options button:disabled { cursor: not-allowed; opacity: .5; }.session-progress { display: grid; grid-template-columns: auto 150px auto; align-items: center; gap: 8px; color: #64748b; font-size: 9px; }.session-progress > div { height: 6px; overflow: hidden; border-radius: 99px; background: #e2e8f0; }.session-progress i { display: block; height: 100%; border-radius: inherit; background: linear-gradient(90deg, #3b82f6, #22c55e); transition: width .3s ease; }.session-progress small { color: #ef4444; }
.challenge-grid { display: grid; grid-template-columns: minmax(0, 1.5fr) minmax(280px, .65fr); align-items: stretch; gap: 16px; }.reaction-stage { position: relative; display: flex; min-height: 450px; align-items: center; justify-content: center; overflow: hidden; border: 0; border-radius: 24px; color: #fff; background: linear-gradient(145deg, #1d4ed8, #3b82f6); box-shadow: 0 18px 45px rgb(37 99 235 / 23%); outline: none; cursor: pointer; transition: background .16s ease, transform .16s ease; user-select: none; -webkit-tap-highlight-color: transparent; }.reaction-stage:focus-visible { box-shadow: 0 0 0 4px #bfdbfe, 0 18px 45px rgb(37 99 235 / 23%); }.reaction-stage:active { transform: scale(.995); }.state-waiting { color: #422006; background: linear-gradient(145deg, #facc15, #f59e0b); box-shadow: 0 18px 45px rgb(245 158 11 / 24%); }.state-active { background: linear-gradient(145deg, #16a34a, #22c55e); box-shadow: 0 18px 45px rgb(34 197 94 / 25%); }.state-tooEarly { background: linear-gradient(145deg, #dc2626, #f43f5e); box-shadow: 0 18px 45px rgb(244 63 94 / 24%); }.state-roundResult { background: linear-gradient(145deg, #6d28d9, #8b5cf6); }.state-complete { background: linear-gradient(145deg, #0f766e, #14b8a6); }.stage-noise { position: absolute; inset: 0; opacity: .14; background-image: radial-gradient(circle at 20% 25%, #fff 0 1px, transparent 1.5px), radial-gradient(circle at 75% 70%, #fff 0 1px, transparent 1.5px); background-size: 31px 31px, 43px 43px; }.target-rings { position: absolute; display: grid; width: 270px; height: 270px; place-items: center; opacity: .16; }.target-rings i { position: absolute; inset: 0; border: 2px solid currentColor; border-radius: 50%; }.target-rings i:nth-child(2) { inset: 42px; }.target-rings i:nth-child(3) { inset: 84px; }.target-rings > .el-icon { font-size: 32px; }.state-active .target-rings { animation: pulse 1s ease infinite; opacity: .28; }.stage-content { position: relative; display: flex; z-index: 1; align-items: center; flex-direction: column; padding: 30px; text-align: center; }.stage-content > span { font-size: 10px; font-weight: 900; letter-spacing: .2em; opacity: .8; }.stage-content > strong { margin-top: 7px; font-size: clamp(34px, 6vw, 57px); line-height: 1.1; }.stage-content p { margin: 10px 0 24px; font-size: 13px; opacity: .85; }.stage-content small { padding: 6px 10px; border: 1px solid rgb(255 255 255 / 28%); border-radius: 99px; font-size: 8px; opacity: .8; }
.stats-card, .history-card { padding: 21px; }.section-heading { display: flex; align-items: center; justify-content: space-between; gap: 12px; }.section-heading h3 { margin: 3px 0 0; color: #0f172a; font-size: 16px; }.section-heading > span { color: #94a3b8; font-size: 9px; }.stat-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-top: 17px; }.stat-grid > div { display: flex; min-height: 85px; justify-content: center; flex-direction: column; padding: 12px; border-radius: 13px; background: #f8fafc; }.stat-grid span { color: #94a3b8; font-size: 9px; }.stat-grid strong { margin-top: 3px; color: #334155; font-size: 22px; }.stat-grid small { margin-left: 3px; color: #94a3b8; font-size: 8px; }.empty-stats { display: flex; min-height: 290px; align-items: center; justify-content: center; flex-direction: column; color: #94a3b8; text-align: center; }.empty-stats > .el-icon { font-size: 35px; }.empty-stats strong { margin-top: 9px; color: #64748b; }.empty-stats span { max-width: 180px; margin-top: 3px; font-size: 9px; }.rating-card { display: flex; flex-direction: column; margin-top: 8px; padding: 13px; border-radius: 13px; color: #fff; background: linear-gradient(135deg, #2563eb, #7c3aed); }.rating-card span, .rating-card small { font-size: 8px; opacity: .8; }.rating-card strong { font-size: 17px; }
.history-chart { display: flex; flex-direction: column; gap: 8px; margin-top: 17px; }.history-chart > div { display: grid; grid-template-columns: 28px minmax(0, 1fr) 55px; align-items: center; gap: 8px; }.history-chart span { color: #94a3b8; font: 9px ui-monospace, monospace; }.history-chart > div > div { height: 20px; overflow: hidden; border-radius: 6px; background: #f1f5f9; }.history-chart i { display: block; height: 100%; border-radius: inherit; background: linear-gradient(90deg, #93c5fd, #3b82f6); transition: width .25s ease; }.history-chart i.best { background: linear-gradient(90deg, #86efac, #22c55e); }.history-chart strong { color: #475569; font: 9px ui-monospace, monospace; text-align: right; }.tips-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 9px; }.tips-grid article { display: flex; gap: 10px; padding: 14px; border-radius: 15px; }.tips-grid article > span { display: grid; width: 31px; height: 31px; flex: none; place-items: center; border-radius: 9px; color: #2563eb; background: #dbeafe; font: 800 9px ui-monospace, monospace; }.tips-grid strong { color: #334155; font-size: 11px; }.tips-grid p { margin: 3px 0 0; color: #64748b; font-size: 9px; line-height: 1.55; }
