...
.custom-field > span, .range-grid label > span {
  display: block;
  margin-bottom: 8px;
  color: var(--c-text-strong);
  font-size: 13px;
...
.range-grid :deep(.el-input-number) {
  width: 100%;
}
.switch-row {
...
.switch-row strong, .switch-row span {
  display: block;
}
.switch-row strong {
  color: var(--c-text-strong);
...
.advice-grid strong, .advice-grid span {
  display: block;
}
.advice-grid strong {
  color: var(--c-text-strong);
...
:global(html.dark .password-page .settings-card), :global(html.dark .password-page .strength-card), :global(html.dark .password-page .result-card) {
  border-color: var(--c-border);
  background: var(--c-surface);
  box-shadow: none;
}
:global(html.dark .password-page .strength-card) {
  background: linear-gradient(155deg, rgba(88, 28, 135, .18), #1e293b 58%);
}
:global(html.dark .password-page .custom-field > span), :global(html.dark .password-page .range-grid label > span), :global(html.dark .password-page .field-label), :global(html.dark .password-page .switch-row strong), :global(html.dark .password-page .metric-list b), :global(html.dark .password-page .password-item code), :global(html.dark .password-page .advice-grid strong) {
  color: var(--c-text-primary);
}
:global(html.dark .password-page .group-option), :global(html.dark .password-page .switch-row), :global(html.dark .password-page .password-item), :global(html.dark .password-page .advice-grid div) {
  border-color: var(--c-border);
  background: var(--c-surface-subtle);
}
:global(html.dark .password-page .group-option) {
  color: var(--c-text-primary);
}
...
@media (max-width: 640px) {
  ...
  .group-grid, .password-list, .range-grid, .advice-grid {
    grid-template-columns: 1fr;
  }
  .group-grid {
    grid-template-columns: repeat(2, 1fr);
