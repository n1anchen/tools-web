...
<template>
  <div class="meme-page flex flex-col mt-3 flex-1">
    <ToolHero summary="把一句话，放到最有戏的位置">
      <template #metrics>
        <MetricsBar :items="[{ label: '输出宽度', value: outputDimensions.width || '—' }, { label: '字幕行数', value: renderedLines.length || '—' }, { label: '导出格式', value: state.format.toUpperCase() }]" />
      </template>
    </ToolHero>
...
<style scoped>
.meme-page{gap:18px}.preview-card,.control-card,.export-card{border: 1px solid var(--c-border);border-radius:var(--radius-card);background:var(--c-surface);box-shadow: var(--shadow-card)}.eyebrow{display:block;margin-bottom:8px;color:#7dd3fc;font-size:11px;font-weight:900;letter-spacing:.17em}.preview-card,.control-card,.export-card{padding:22px}.preview-heading,.card-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:18px}.preview-heading h3,.card-heading h3{margin:0;color: var(--c-text-primary);font-size:20px}.preview-heading p{margin:5px 0 0;color: var(--c-text-secondary);font-size:13px}.preview-actions{display:flex;gap:8px;flex-wrap:wrap}.preview-actions button,.card-heading>button,.clear-action{display:inline-flex;align-items:center;justify-content:center;gap:6px;min-height:38px;padding:0 13px;border:1px solid #dbe3ef;border-radius:var(--radius-sm);background:var(--c-surface);color: var(--c-text-body);font-weight:750;cursor:pointer}.preview-actions button.primary{border-color:#0284c7;background:#0284c7;color: var(--c-on-accent)}.preview-actions button:disabled{cursor:not-allowed;opacity:.45}.canvas-stage{display:flex;align-items:center;justify-content:center;box-sizing:border-box;height:440px;margin-top:18px;padding:18px;overflow:hidden;border-radius:var(--radius-lg);background:#f1f5f9}.canvas-stage canvas{display:block;width:min(100%,720px);height:auto;max-height:100%;border-radius:var(--radius-sm);box-shadow:0 12px 30px rgba(15,23,42,.18)}.preview-meta{display:flex;flex-wrap:wrap;gap:8px;margin-top:12px}.preview-meta span{padding:5px 9px;border-radius:var(--radius-full);background:#e0f2fe;color:#0369a1;font-size:11px;font-weight:750}.workspace-grid{display:grid;grid-template-columns:minmax(0,1.5fr) minmax(300px,.7fr);gap:18px}.card-heading{margin-bottom:20px}.card-heading>button{min-height:34px;padding:0 10px}.text-field,.segment-grid label,.option-field{display:flex;flex-direction:column;gap:8px}.text-field>span,.text-presets>span,.style-presets>span,.segment-grid label>span,.option-field>span{color: var(--c-text-secondary);font-size:12px;font-weight:800}.text-presets,.style-presets{margin-top:16px}.text-presets>div{display:flex;flex-wrap:wrap;gap:7px;margin-top:8px}.text-presets button{padding:7px 10px;border: 1px solid var(--c-border);border-radius:var(--radius-full);background: var(--c-surface-subtle);color: var(--c-text-body);font-size:12px;cursor:pointer}.style-presets>div{display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:8px}.style-presets button{display:flex;flex-direction:column;gap:3px;padding:10px;border: 1px solid var(--c-border);border-radius:var(--radius-sm);background: var(--c-surface-subtle);color: var(--c-text-strong);text-align:left;cursor:pointer}.style-presets button:hover,.text-presets button:hover{border-color:#38bdf8;background:#f0f9ff}.style-presets small{color: var(--c-text-muted)}.segment-grid{display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-top:18px}.segment-grid :deep(.el-segmented),.option-field :deep(.el-segmented){width:100%}.switch-row{display:flex;align-items:center;justify-content:space-between;gap:16px;margin-top:16px;padding:12px 13px;border: 1px solid var(--c-border);border-radius:var(--radius-md);background: var(--c-surface-subtle)}.switch-row div{display:flex;flex-direction:column}.switch-row strong{color: var(--c-text-strong);font-size:13px}.switch-row span{margin-top:3px;color: var(--c-text-muted);font-size:11px}.slider-grid{display:grid;grid-template-columns:1fr 1fr;gap:13px 22px;margin-top:18px}.slider-setting label{display:flex;justify-content:space-between;color: var(--c-text-secondary);font-size:12px;font-weight:800}.slider-setting strong{color:#0284c7}.slider-setting :deep(.el-slider){padding:0 5px}.summary-list{display:grid;gap:1px;overflow:hidden;border: 1px solid var(--c-border);border-radius:var(--radius-md);background:#e2e8f0}.summary-list div{display:flex;justify-content:space-between;padding:13px;background: var(--c-surface-subtle);color: var(--c-text-secondary);font-size:12px}.summary-list strong{color:#1e293b}.option-field{margin-top:17px}.quality{margin-top:18px}.export-summary{display:flex;flex-direction:column;margin-top:18px;padding:18px;border-radius:var(--radius-md);background:linear-gradient(135deg,#0369a1,#0e7490);color: var(--c-on-accent)}.export-summary span,.export-summary small{color:#bae6fd;font-size:11px}.export-summary strong{margin:5px 0;font-size:24px}.clear-action{width:100%;margin-top:13px}.related-link{display:block;margin-top:14px;color:#0284c7;font-size:12px;font-weight:750}.dark .control-card {border-color:#334155;background:#1e293b}.dark .preview-heading h3,.dark .card-heading h3{color:#f8fafc}.dark .preview-heading p,.dark .text-field>span,.dark .text-presets>span,.dark .style-presets>span,.dark .segment-grid label>span,.dark .option-field>span{color: var(--c-text-muted)}.dark .preview-actions button,.dark .card-heading>button,.dark .clear-action{border-color:#475569;background:#0f172a;color:#cbd5e1}.dark .canvas-stage{background:#0f172a}.dark .preview-meta span{background:#0c4a6e;color:#bae6fd}.dark .text-presets button,.dark .style-presets button,.dark .switch-row,.dark .summary-list div{border-color:#334155;background:#0f172a;color: var(--c-text-muted)}.dark .style-presets button:hover,.dark .text-presets button:hover{border-color:#38bdf8;background:#0c3045}.dark .switch-row strong,.dark .summary-list strong{color:#e2e8f0}.dark .summary-list{border-color:#334155;background:#334155}@media(max-width:980px){.workspace-grid{grid-template-columns:1fr}}@media(max-width:680px){.meme-page{gap:14px}.preview-card,.control-card,.export-card{border-radius:var(--radius-lg)}.preview-card,.control-card,.export-card{padding:15px}.preview-heading{flex-direction:column}.preview-actions{width:100%}.preview-actions>*{flex:1}.preview-actions button{width:100%}.canvas-stage{height:260px;padding:12px}.style-presets>div,.segment-grid,.slider-grid{grid-template-columns:1fr 1fr}.preview-meta{gap:6px}}@media(max-width:430px){.style-presets>div,.segment-grid,.slider-grid{grid-template-columns:1fr}}</style>
