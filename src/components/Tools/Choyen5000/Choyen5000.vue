...
<style scoped>
.choyen-page{--accent:#ef4444;--accent-deep:#991b1b;--gold:#f59e0b;gap:18px}.preview-card,.control-card,.export-card{border: 1px solid var(--c-border);border-radius:var(--radius-card);background:var(--c-surface);box-shadow: var(--shadow-card)}.eyebrow{display:block;margin-bottom:8px;color:#fbbf24;font-size:11px;font-weight:900;letter-spacing:.17em}.preview-card{padding:20px}.preview-heading,.card-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:18px}.preview-heading h3,.card-heading h3{margin:0;color: var(--c-text-primary);font-size:20px}.preview-heading p{margin:5px 0 0;color: var(--c-text-secondary);font-size:13px}.export-actions{display:flex;gap:10px}.export-actions button,.card-heading>button,.soft-action{display:inline-flex;align-items:center;justify-content:center;gap:6px;border:1px solid #dbe3ef;border-radius:var(--radius-sm);background:var(--c-surface);color: var(--c-text-body);min-height:38px;padding:0 14px;font-weight:700;cursor:pointer}.export-actions button.primary{border-color:#dc2626;background:#dc2626;color: var(--c-on-accent)}.export-actions button:disabled{cursor:not-allowed;opacity:.55}.canvas-stage{position:relative;display:flex;align-items:center;justify-content:flex-start;min-height:210px;margin-top:18px;padding:18px;overflow:auto;border-radius:var(--radius-lg);background: var(--c-surface-subtle)}.canvas-stage.transparent{background-color: var(--c-surface-subtle);background-image:linear-gradient(45deg,#e2e8f0 25%,transparent 25%),linear-gradient(-45deg,#e2e8f0 25%,transparent 25%),linear-gradient(45deg,transparent 75%,#e2e8f0 75%),linear-gradient(-45deg,transparent 75%,#e2e8f0 75%);background-position:0 0,0 10px,10px -10px,-10px 0;background-size:20px 20px}.canvas-stage canvas{display:block;width:auto;max-width:none;height:210px;touch-action:none}.drag-hint{position:sticky;right:8px;bottom:8px;align-self:flex-end;display:flex;align-items:center;gap:5px;margin-left:auto;padding:7px 10px;border:1px solid rgba(148,163,184,.45);border-radius:var(--radius-full);background:rgba(255,255,255,.9);color: var(--c-text-secondary);font-size:11px;font-weight:700;white-space:nowrap}.loading-overlay{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;gap:9px;border-radius:var(--radius-lg);background:rgba(248,250,252,.88);color:#b91c1c;font-weight:700}.loading-overlay.error{flex-direction:column}.preview-meta{display:flex;flex-wrap:wrap;gap:8px;margin-top:12px}.preview-meta span{padding:5px 9px;border-radius:var(--radius-full);background:#f1f5f9;color: var(--c-text-body);font-size:11px;font-weight:700}.workspace-grid{display:grid;grid-template-columns:minmax(0,1.45fr) minmax(300px,.75fr);gap:18px}.control-card,.export-card{padding:22px}.card-heading{margin-bottom:20px}.card-heading>button{min-height:34px;padding:0 10px}.text-grid{display:grid;grid-template-columns:1fr 1fr;gap:14px}.text-grid label,.option-field{display:flex;flex-direction:column;gap:8px}.text-grid label>span,.option-field>span,.preset-block>span{color: var(--c-text-secondary);font-size:12px;font-weight:800}.preset-block{margin-top:18px}.preset-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:9px;margin-top:9px}.preset-grid button{display:flex;flex-direction:column;gap:3px;padding:11px 12px;border: 1px solid var(--c-border);border-radius:var(--radius-sm);background: var(--c-surface-subtle);color: var(--c-text-strong);text-align:left;cursor:pointer}.preset-grid button:hover{border-color:#f59e0b;background:#fffbeb}.preset-grid small{color: var(--c-text-muted)}.option-field{margin-top:18px}.option-field :deep(.el-segmented){width:100%}.slider-setting{margin-top:19px}.slider-setting label{display:flex;justify-content:space-between;color: var(--c-text-secondary);font-size:12px;font-weight:800}.slider-setting strong{color:#b91c1c}.slider-setting :deep(.el-slider){padding:0 5px}.soft-action{width:100%;margin-top:4px;border-color:#fecaca;background:#fff7ed;color:#b91c1c}.summary-list{display:grid;gap:1px;overflow:hidden;border: 1px solid var(--c-border);border-radius:var(--radius-md);background:#e2e8f0}.summary-list div{display:flex;justify-content:space-between;padding:13px;background: var(--c-surface-subtle);color: var(--c-text-secondary);font-size:12px}.summary-list strong{color:#1e293b}.export-summary{display:flex;flex-direction:column;margin-top:18px;padding:18px;border-radius:var(--radius-md);background:linear-gradient(135deg,#b91c1c,#7c2d12);color: var(--c-on-accent)}.export-summary span,.export-summary small{color:#fed7aa;font-size:11px}.export-summary strong{margin:5px 0;font-size:25px}.privacy-note{display:flex;flex-direction:column;gap:4px;margin-top:14px;padding:13px;border-radius:var(--radius-md);background: var(--c-surface-subtle);color: var(--c-text-secondary);font-size:12px}.privacy-note strong{color: var(--c-text-strong)}.detail-copy{display:flex;flex-direction:column;gap:10px;color: var(--c-text-secondary);font-size:14px;line-height:1.9}.detail-copy a{color:#dc2626}.dark .preview-card,.dark .control-card,.dark .export-card{border-color:#334155}.dark .preview-card,.dark .control-card,.dark .export-card{background:#1e293b}.dark .preview-heading h3,.dark .card-heading h3{color:#f8fafc}.dark .preview-heading p,.dark .text-grid label>span,.dark .option-field>span,.dark .preset-block>span{color: var(--c-text-muted)}.dark .export-actions button,.dark .card-heading>button{border-color:#475569;background:#0f172a;color:#cbd5e1}.dark .canvas-stage{background-color:#0f172a}.dark .canvas-stage.transparent{background-image:linear-gradient(45deg,#1e293b 25%,transparent 25%),linear-gradient(-45deg,#1e293b 25%,transparent 25%),linear-gradient(45deg,transparent 75%,#1e293b 75%),linear-gradient(-45deg,transparent 75%,#1e293b 75%)}.dark .drag-hint{border-color:#475569;background:rgba(15,23,42,.9);color: var(--c-text-muted)}.dark .loading-overlay{background:rgba(15,23,42,.9)}.dark .preview-meta span{background:#0f172a;color:#cbd5e1}.dark .preset-grid button,.dark .summary-list div,.dark .privacy-note{border-color:#334155;background:#0f172a;color: var(--c-text-muted)}.dark .preset-grid button:hover{border-color:#f59e0b;background:#292314}.dark .summary-list{border-color:#334155;background:#334155}.dark .summary-list strong,.dark .privacy-note strong{color:#e2e8f0}.dark .soft-action{border-color:#7f1d1d;background:#291414;color:#fecaca}@media(max-width:900px){.workspace-grid{grid-template-columns:1fr}}@media(max-width:640px){.choyen-page{gap:14px}.preview-card,.control-card,.export-card{border-radius:var(--radius-lg)}.preview-card,.control-card,.export-card{padding:15px}.preview-heading{flex-direction:column}.export-actions{width:100%}.export-actions button{flex:1}.canvas-stage{min-height:180px;padding:12px}.canvas-stage canvas{height:170px}.drag-hint{display:none}.text-grid,.preset-grid{grid-template-columns:1fr}.preview-meta{gap:6px}}
.canvas-stage{box-sizing:border-box;height:340px;min-height:340px;justify-content:center;overflow:hidden}
.canvas-stage canvas{flex:0 1 auto;width:auto;max-width:100%;height:auto;max-height:100%}
.drag-hint{position:absolute;right:26px;bottom:26px;margin-left:0}@media(max-width:640px){.canvas-stage{height:220px;min-height:220px}.canvas-stage canvas{width:auto;height:auto;max-height:100%}}</style>
