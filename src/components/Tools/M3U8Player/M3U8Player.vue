...
<style scoped>
.hls-page { --blue: #2563eb; gap: 16px; }.hero-card, .source-card, .player-card, .diagnostics-card, .recent-card, .tips-grid article { border: 1px solid #e2e8f0; border-radius: 22px; background: #fff; box-shadow: 0 12px 35px rgb(15 23 42 / 6%); }.hero-card { display: flex; align-items: center; justify-content: space-between; gap: 22px; padding: 25px 28px; background: radial-gradient(circle at 88% 10%, #dbeafe, transparent 28%), #fff; }.eyebrow { color: var(--blue); font-size: 10px; font-weight: 800; letter-spacing: .15em; }.hero-card h2 { margin: 6px 0 4px; color: #0f172a; font-size: clamp(21px, 3vw, 28px); }.hero-card p { margin: 0; color: #64748b; font-size: 13px; }.capability { display: flex; min-width: 170px; flex-direction: column; padding: 10px 13px; border: 1px solid #bfdbfe; border-radius: 14px; background: #eff6ff; }.capability span, .capability small { color: #60a5fa; font-size: 8px; }.capability strong { color: #1e40af; font-size: 11px; }
.source-card { padding: 15px; }.url-row { display: grid; grid-template-columns: minmax(0, 1fr) auto auto; align-items: start; gap: 8px; }.url-input { min-width: 0; }.url-input :deep(.el-input__wrapper) { border-radius: 11px; }.url-input > span { display: block; margin: 4px 4px 0; color: #dc2626; font-size: 8px; }.sample-row { display: flex; align-items: center; gap: 7px; margin-top: 11px; overflow-x: auto; }.sample-row > span { flex: none; color: #94a3b8; font-size: 9px; }.sample-row button { display: flex; align-items: flex-start; flex-direction: column; flex: none; padding: 6px 9px; border: 1px solid #e2e8f0; border-radius: 9px; color: #475569; background: #f8fafc; cursor: pointer; }.sample-row strong { font-size: 9px; }.sample-row small { color: #94a3b8; font-size: 7px; }
.workspace { display: grid; grid-template-columns: minmax(0, 1.5fr) minmax(285px, .55fr); align-items: start; gap: 16px; }.player-card { min-width: 0; overflow: hidden; }.player-heading { display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 11px 15px; }.player-heading > div { display: flex; align-items: center; gap: 8px; min-width: 0; }.player-heading > div:last-child { flex: none; }.player-heading strong { color: #475569; overflow: hidden; text-overflow: ellipsis; font-size: 9px; white-space: nowrap; }.player-heading > div:last-child > span { color: #94a3b8; font: 8px ui-monospace, monospace; }.status-indicator { display: flex; align-items: center; gap: 5px; flex: none; color: #64748b; font-size: 8px; }.status-indicator i { width: 6px; height: 6px; border-radius: 50%; background: #94a3b8; }.status-indicator.loading i, .status-indicator.buffering i { background: #f59e0b; animation: blink 1s ease infinite; }.status-indicator.ready i, .status-indicator.playing i { background: #22c55e; box-shadow: 0 0 0 4px #dcfce7; }.status-indicator.error i { background: #ef4444; box-shadow: 0 0 0 4px #fee2e2; }.video-stage { position: relative; overflow: hidden; aspect-ratio: 16 / 9; color: #fff; background: #030712; }.video-stage video { display: block; width: 100%; height: 100%; object-fit: contain; }.video-placeholder, .loading-overlay, .error-overlay { position: absolute; display: flex; inset: 0; align-items: center; justify-content: center; flex-direction: column; padding: 25px; background: radial-gradient(circle at center, #172554, #030712 68%); text-align: center; }.video-placeholder > .el-icon { color: #60a5fa; font-size: 48px; }.video-placeholder strong, .loading-overlay strong, .error-overlay strong { margin-top: 10px; font-size: 15px; }.video-placeholder span, .loading-overlay span, .error-overlay span { max-width: 80%; margin-top: 4px; overflow: hidden; color: #94a3b8; text-overflow: ellipsis; font-size: 8px; white-space: nowrap; }.loading-overlay i { width: 34px; height: 34px; border: 3px solid #334155; border-top-color: #60a5fa; border-radius: 50%; animation: spin .8s linear infinite; }.error-overlay { background: radial-gradient(circle at center, #450a0a, #030712 70%); }.error-overlay span { margin-bottom: 14px; color: #fca5a5; }.stream-stats { display: grid; grid-template-columns: repeat(5, 1fr); padding: 10px; }.stream-stats div { display: flex; align-items: center; flex-direction: column; padding: 7px; border-right: 1px solid #e2e8f0; }.stream-stats div:last-child { border: 0; }.stream-stats span { color: #94a3b8; font-size: 7px; }.stream-stats strong { margin-top: 2px; color: #334155; font-size: 9px; }.player-actions { display: flex; align-items: flex-end; justify-content: space-between; gap: 10px; padding: 11px 15px 15px; border-top: 1px solid #e2e8f0; }.player-actions label { display: flex; flex-direction: column; gap: 4px; }.player-actions label > span { color: #94a3b8; font-size: 8px; }.player-actions :deep(.el-select) { width: 190px; }
.diagnostics-card { position: sticky; top: 14px; padding: 19px; }.section-heading { display: flex; align-items: center; justify-content: space-between; gap: 12px; }.section-heading h3 { margin: 3px 0 0; color: #0f172a; font-size: 16px; }.section-heading > span, .section-heading > button { border: 0; color: #94a3b8; background: transparent; font-size: 8px; }.advice-card { margin-top: 15px; padding: 12px; border-radius: 13px; background: #eff6ff; }.advice-card > span { color: #2563eb; font-size: 8px; font-weight: 800; }.advice-card p { margin: 5px 0; color: #475569; font-size: 9px; line-height: 1.55; }.check-list { display: flex; flex-direction: column; gap: 8px; margin: 15px 0; }.check-list > div { display: grid; grid-template-columns: auto 1fr auto; align-items: center; gap: 8px; color: #64748b; font-size: 9px; }.check-list i { width: 8px; height: 8px; border: 2px solid #cbd5e1; border-radius: 50%; }.check-list .done i { border-color: #22c55e; background: #22c55e; box-shadow: 0 0 0 3px #dcfce7; }.check-list .failed i { border-color: #ef4444; background: #ef4444; box-shadow: 0 0 0 3px #fee2e2; }.check-list span { color: #94a3b8; font-size: 8px; }.check-list .done span { color: #16a34a; }.check-list .failed span { color: #dc2626; }.subheading { display: flex; align-items: center; justify-content: space-between; }.subheading strong { color: #334155; font-size: 10px; }.subheading button { border: 0; color: #94a3b8; background: transparent; font-size: 8px; cursor: pointer; }.log-list { display: flex; max-height: 240px; flex-direction: column; gap: 6px; margin-top: 8px; overflow-y: auto; }.log-list article { display: grid; grid-template-columns: auto 1fr; gap: 3px 6px; padding: 8px; border-left: 3px solid #f59e0b; border-radius: 8px; background: #fffbeb; }.log-list article.fatal { border-color: #ef4444; background: #fef2f2; }.log-list span { color: #94a3b8; font: 7px ui-monospace, monospace; }.log-list strong { color: #92400e; font-size: 8px; }.log-list code { grid-column: 1 / -1; color: #78350f; font-size: 7px; overflow-wrap: anywhere; }.log-empty { display: grid; min-height: 80px; margin-top: 8px; place-items: center; border-radius: 10px; color: #94a3b8; background: #f8fafc; font-size: 8px; }
.recent-card { padding: 19px; }.recent-list { display: flex; gap: 7px; margin-top: 13px; overflow-x: auto; }.recent-list button { display: flex; width: 260px; align-items: center; justify-content: space-between; gap: 10px; flex: none; padding: 9px; border: 1px solid #e2e8f0; border-radius: 10px; color: #475569; background: #f8fafc; cursor: pointer; }.recent-list span { overflow: hidden; text-overflow: ellipsis; font: 8px ui-monospace, monospace; white-space: nowrap; }.recent-list small { flex: none; color: #2563eb; font-size: 8px; }.tips-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 9px; }.tips-grid article { padding: 14px; border-radius: 15px; }.tips-grid strong { color: #2563eb; font-size: 10px; }.tips-grid p { margin: 4px 0 0; color: #64748b; font-size: 9px; line-height: 1.55; }
:global(html.dark .hls-page .hero-card), :global(html.dark .hls-page .source-card), :global(html.dark .hls-page .player-card), :global(html.dark .hls-page .diagnostics-card), :global(html.dark .hls-page .recent-card), :global(html.dark .hls-page .tips-grid article) { border-color: #334155; background: #1e293b; box-shadow: none; }:global(html.dark .hls-page .hero-card) { background: radial-gradient(circle at 88% 10%, #1e3a8a, transparent 28%), #1e293b; }:global(html.dark .hls-page h2), :global(html.dark .hls-page h3), :global(html.dark .hls-page .stream-stats strong), :global(html.dark .hls-page .subheading strong), :global(html.dark .hls-page .tips-grid strong) { color: #f8fafc; }:global(html.dark .hls-page .capability), :global(html.dark .hls-page .advice-card) { border-color: #1d4ed8; background: #172554; }:global(html.dark .hls-page .capability strong), :global(html.dark .hls-page .advice-card p) { color: #bfdbfe; }:global(html.dark .hls-page .sample-row button), :global(html.dark .hls-page .recent-list button), :global(html.dark .hls-page .log-empty) { border-color: #334155; color: #cbd5e1; background: #0f172a; }:global(html.dark .hls-page .stream-stats div), :global(html.dark .hls-page .player-actions) { border-color: #334155; }:global(html.dark .hls-page .log-list article) { background: #422006; }:global(html.dark .hls-page .log-list article.fatal) { background: #450a0a; }:global(html.dark .hls-page .log-list code) { color: #fed7aa; }
