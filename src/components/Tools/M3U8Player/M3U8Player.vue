...
<style scoped>
.hls-page { --blue: #2563eb; gap: 16px; }.hero-card, .source-card, .player-card, .diagnostics-card, .recent-card, .tips-grid article { border: 1px solid #e2e8f0; border-radius: 22px; background: #fff; box-shadow: 0 12px 35px rgb(15 23 42 / 6%); }.hero-card { display: flex; align-items: center; justify-content: space-between; gap: 22px; padding: 25px 28px; background: radial-gradient(circle at 88% 10%, #dbeafe, transparent 28%), #fff; }.eyebrow { color: var(--blue); font-size:12px; font-weight: 800; letter-spacing: .15em; }.hero-card h2 { margin: 6px 0 4px; color: #0f172a; font-size: clamp(21px, 3vw, 28px); }.hero-card p { margin: 0; color: #64748b; font-size: 13px; }.capability { display: flex; min-width: 170px; flex-direction: column; padding: 10px 13px; border: 1px solid #bfdbfe; border-radius: 14px; background: #eff6ff; }.capability span, .capability small { color: #60a5fa; font-size:12px; }.capability strong { color: #1e40af; font-size:12px; }
