...
<style scoped>
.hls-page { --blue: #2563eb; gap: 16px; }.source-card, .player-card, .diagnostics-card, .recent-card, .tips-grid article { border: 1px solid var(--c-border); border-radius: var(--radius-card); background: var(--c-surface); box-shadow: var(--shadow-card); }.eyebrow { color: var(--blue); font-size:12px; font-weight: 800; letter-spacing: .15em; }.hero-capability { display:inline-flex; align-items:center; gap:7px; padding:7px 11px; border:1px solid #bfdbfe; border-radius:var(--radius-sm); background:rgba(239,246,255,.8); font-size:12px; color:#3b82f6; }.hero-capability strong { color:#1d4ed8; font-weight:700; }.hero-capability small { color: var(--c-text-muted); font-size:11px; }
.source-card { padding: 15px; }.url-row { display: grid; grid-template-columns: minmax(0, 1fr) auto auto; align-items: start; gap: 8px; }.url-input { min-width: 0; }.url-input :deep(.el-input__wrapper) { border-radius: var(--radius-sm); }.url-input > span { display: block; margin: 4px 4px 0; color: #dc2626; font-size:12px; }.sample-row { display: flex; align-items: center; gap: 7px; margin-top: 11px; overflow-x: auto; }.sample-row > span { flex: none; color: var(--c-text-muted); font-size:12px; }.sample-row button { display: flex; align-items: flex-start; flex-direction: column; flex: none; padding: 6px 9px; border: 1px solid var(--c-border); border-radius: var(--radius-sm); color: var(--c-text-body); background: var(--c-surface-subtle); cursor: pointer; }.sample-row strong { font-size:12px; }.sample-row small { color: var(--c-text-muted); font-size:12px; }
.workspace { display: grid; grid-template-columns: minmax(0, 1.5fr) minmax(285px, .55fr); align-items: start; gap: 16px; }.player-card { min-width: 0; overflow: hidden; }.player-heading { display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 11px 15px; }.player-heading > div { display: flex; align-items: center; gap: 8px; min-width: 0; }.player-heading > div:last-child { flex: none; }.player-heading strong { color: var(--c-text-body); overflow: hidden; text-overflow: ellipsis; font-size:12px; white-space: nowrap; }.player-heading > div:last-child > span { color: var(--c-text-muted); font: 12px ui-monospace, monospace; }.status-indicator { display: flex; align-items: center; gap: 5px; flex: none; color: var(--c-text-secondary); font-size:12px; }.status-indicator i { width: 6px; height: 6px; border-radius: 50%; background: #94a3b8; }.status-indicator.loading i, .status-indicator.buffering i { background: #f59e0b; animation: blink 1s ease infinite; }.status-indicator.ready i, .status-indicator.playing i { background: #22c55e; box-shadow: 0 0 0 4px #dcfce7; }.status-indicator.error i { background: #ef4444; box-shadow: 0 0 0 4px #fee2e2; }.video-stage { position: relative; overflow: hidden; aspect-ratio: 16 / 9; color: var(--c-on-accent); background: #030712; }.video-stage video { display: block; width: 100%; height: 100%; object-fit: contain; }.video-placeholder, .loading-overlay, .error-overlay { position: absolute; display: flex; inset: 0; align-items: center; justify-content: center; flex-direction: column; padding: 25px; background: radial-gradient(circle at center, #172554, #030712 68%); text-align: center; }.video-placeholder > .el-icon { color: #60a5fa; font-size: 48px; }.video-placeholder strong, .loading-overlay strong, .error-overlay strong { margin-top: 10px; font-size: 15px; }.video-placeholder span, .loading-overlay span, .error-overlay span { max-width: 80%; margin-top: 4px; overflow: hidden; color: var(--c-text-muted); text-overflow: ellipsis; font-size:12px; white-space: nowrap; }.loading-overlay i { width: 34px; height: 34px; border: 3px solid #334155; border-top-color: #60a5fa; border-radius: 50%; animation: spin .8s linear infinite; }.error-overlay { background: radial-gradient(circle at center, #450a0a, #030712 70%); }.error-overlay span { margin-bottom: 14px; color: #fca5a5; }.stream-stats { display: grid; grid-template-columns: repeat(5, 1fr); padding: 10px; }.stream-stats div { display: flex; align-items: center; flex-direction: column; padding: 7px; border-right: 1px solid var(--c-border); }.stream-stats div:last-child { border: 0; }.stream-stats span { color: var(--c-text-muted); font-size:12px; }.stream-stats strong { margin-top: 2px; color: var(--c-text-strong); font-size:12px; }.player-actions { display: flex; align-items: flex-end; justify-content: space-between; gap: 10px; padding: 11px 15px 15px; border-top: 1px solid var(--c-border); }.player-actions label { display: flex; flex-direction: column; gap: 4px; }.player-actions label > span { color: var(--c-text-muted); font-size:12px; }.player-actions :deep(.el-select) { width: 190px; }
.diagnostics-card { position: sticky; top: 14px; padding: 19px; }.section-heading { display: flex; align-items: center; justify-content: space-between; gap: 12px; }.section-heading h3 { margin: 3px 0 0; color: var(--c-text-primary); font-size: 16px; }.section-heading > span, .section-heading > button { border: 0; color: var(--c-text-muted); background: transparent; font-size:12px; }.advice-card { margin-top: 15px; padding: 12px; border-radius: var(--radius-md); background: #eff6ff; }.advice-card > span { color: #2563eb; font-size:12px; font-weight: 800; }.advice-card p { margin: 5px 0; color: var(--c-text-body); font-size:12px; line-height: 1.55; }.check-list { display: flex; flex-direction: column; gap: 8px; margin: 15px 0; }.check-list > div { display: grid; grid-template-columns: auto 1fr auto; align-items: center; gap: 8px; color: var(--c-text-secondary); font-size:12px; }.check-list i { width: 8px; height: 8px; border: 2px solid #cbd5e1; border-radius: 50%; }.check-list .done i { border-color: #22c55e; background: #22c55e; box-shadow: 0 0 0 3px #dcfce7; }.check-list .failed i { border-color: #ef4444; background: #ef4444; box-shadow: 0 0 0 3px #fee2e2; }.check-list span { color: var(--c-text-muted); font-size:12px; }.check-list .done span { color: #16a34a; }.check-list .failed span { color: #dc2626; }.subheading { display: flex; align-items: center; justify-content: space-between; }.subheading strong { color: var(--c-text-strong); font-size:12px; }.subheading button { border: 0; color: var(--c-text-muted); background: transparent; font-size:12px; cursor: pointer; }.log-list { display: flex; max-height: 240px; flex-direction: column; gap: 6px; margin-top: 8px; overflow-y: auto; }.log-list article { display: grid; grid-template-columns: auto 1fr; gap: 3px 6px; padding: 8px; border-left: 3px solid #f59e0b; border-radius: var(--radius-xs); background: #fffbeb; }.log-list article.fatal { border-color: #ef4444; background: #fef2f2; }.log-list span { color: var(--c-text-muted); font: 12px ui-monospace, monospace; }.log-list strong { color: #92400e; font-size:12px; }.log-list code { grid-column: 1 / -1; color: #78350f; font-size:12px; overflow-wrap: anywhere; }.log-empty { display: grid; min-height: 80px; margin-top: 8px; place-items: center; border-radius: var(--radius-sm); color: var(--c-text-muted); background: var(--c-surface-subtle); font-size:12px; }
.recent-card { padding: 19px; }.recent-list { display: flex; gap: 7px; margin-top: 13px; overflow-x: auto; }.recent-list button { display: flex; width: 260px; align-items: center; justify-content: space-between; gap: 10px; flex: none; padding: 9px; border: 1px solid var(--c-border); border-radius: var(--radius-sm); color: var(--c-text-body); background: var(--c-surface-subtle); cursor: pointer; }.recent-list span { overflow: hidden; text-overflow: ellipsis; font: 12px ui-monospace, monospace; white-space: nowrap; }.recent-list small { flex: none; color: #2563eb; font-size:12px; }.tips-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 9px; }.tips-grid article { padding: 14px; border-radius: var(--radius-md); }.tips-grid strong { color: #2563eb; font-size:12px; }.tips-grid p { margin: 4px 0 0; color: var(--c-text-secondary); font-size:12px; line-height: 1.55; }
:global(html.dark .hls-page .source-card), :global(html.dark .hls-page .player-card), :global(html.dark .hls-page .diagnostics-card), :global(html.dark .hls-page .recent-card), :global(html.dark .hls-page .tips-grid article) { border-color: var(--c-border); background: var(--c-surface); box-shadow: none; }:global(html.dark .hls-page h3), :global(html.dark .hls-page .stream-stats strong), :global(html.dark .hls-page .subheading strong), :global(html.dark .hls-page .tips-grid strong) { color: #f8fafc; }:global(html.dark .hls-page .advice-card) { border-color: #1d4ed8; background: #172554; }:global(html.dark .hls-page .advice-card p) { color: #bfdbfe; }:global(html.dark .hls-page .sample-row button), :global(html.dark .hls-page .recent-list button), :global(html.dark .hls-page .log-empty) { border-color: var(--c-border); color: var(--c-text-secondary); background: var(--c-surface-subtle); }:global(html.dark .hls-page .stream-stats div), :global(html.dark .hls-page .player-actions) { border-color: var(--c-border); }:global(html.dark .hls-page .log-list article) { background: #422006; }:global(html.dark .hls-page .log-list article.fatal) { background: #450a0a; }:global(html.dark .hls-page .log-list code) { color: #fed7aa; }:global(html.dark .hls-page .hero-capability) { border-color:#1d4ed8; background:rgba(23,37,84,.6); }:global(html.dark .hls-page .hero-capability strong) { color:#bfdbfe; }:global(html.dark .hls-page .hero-capability small) { color: var(--c-text-muted); }
