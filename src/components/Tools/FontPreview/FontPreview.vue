...
<style scoped>
.font-preview-page{--accent:#6366f1;gap:18px}.preview-card,.control-card,.insight-card,.font-browser-card{border: 1px solid var(--c-border);border-radius:var(--radius-card);background:var(--c-surface);box-shadow: var(--shadow-card)}.eyebrow{display:block;margin-bottom:8px;color:#a5b4fc;font-size:11px;font-weight:900;letter-spacing:.17em}.preview-card,.control-card,.insight-card,.font-browser-card{padding:22px}.preview-heading,.card-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:18px}.preview-heading h3,.card-heading h3{margin:0;color: var(--c-text-primary);font-size:20px}.preview-heading p{max-width:620px;margin:5px 0 0;overflow:hidden;color: var(--c-text-secondary);font-size:12px;text-overflow:ellipsis;white-space:nowrap}.preview-actions{display:flex;align-items:center;gap:9px}.preview-actions>button,.card-heading>button,.source-actions button,.browse-action{display:inline-flex;align-items:center;justify-content:center;gap:6px;min-height:38px;padding:0 13px;border:1px solid #dbe3ef;border-radius:var(--radius-sm);background:var(--c-surface);color: var(--c-text-body);font-weight:750;cursor:pointer}.specimen-stage{min-height:240px;margin-top:18px;padding:28px;border: 1px solid var(--c-border);border-radius:var(--radius-lg);overflow:auto;white-space:pre-wrap;word-break:break-word}.waterfall-stage{margin-top:18px;padding:18px 24px;border: 1px solid var(--c-border);border-radius:var(--radius-lg);overflow:hidden}.waterfall-stage>div{display:grid;grid-template-columns:42px minmax(0,1fr);align-items:baseline;border-bottom:1px solid rgba(148,163,184,.24)}.waterfall-stage>div:last-child{border-bottom:0}.waterfall-stage span{color: var(--c-text-muted);font:700 11px/1 ui-monospace,monospace}.waterfall-stage p{margin:8px 0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.preview-meta{display:flex;flex-wrap:wrap;gap:8px;margin-top:12px}.preview-meta span{padding:5px 9px;border-radius:var(--radius-full);background:#eef2ff;color:#4f46e5;font-size:11px;font-weight:750}.workspace-grid{display:grid;grid-template-columns:minmax(0,1.55fr) minmax(300px,.65fr);gap:18px}.card-heading{margin-bottom:20px}.card-heading>button{min-height:34px;padding:0 10px}.textarea-field,.font-source-field label{display:flex;flex-direction:column;gap:8px}.textarea-field>span,.font-source-field label>span,.sample-presets>span,.appearance-row label>span{color: var(--c-text-secondary);font-size:12px;font-weight:800}.sample-presets{margin-top:18px}.sample-presets>div{display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:9px}.sample-presets button{display:flex;flex-direction:column;gap:3px;padding:10px;border: 1px solid var(--c-border);border-radius:var(--radius-sm);background: var(--c-surface-subtle);color: var(--c-text-strong);text-align:left;cursor:pointer}.sample-presets button:hover{border-color:#818cf8;background:#eef2ff}.sample-presets small{color: var(--c-text-muted)}.font-source-field{margin-top:19px;padding-top:18px;border-top: 1px solid var(--c-border)}.source-actions{display:flex;gap:9px;margin-top:10px}.source-actions button:disabled,.browse-action:disabled{cursor:not-allowed;opacity:.5}.support-note{margin:9px 0 0;color:#b45309;font-size:12px;line-height:1.6}.slider-grid{display:grid;grid-template-columns:1fr 1fr;gap:14px 22px;margin-top:20px}.slider-setting label{display:flex;justify-content:space-between;color: var(--c-text-secondary);font-size:12px;font-weight:800}.slider-setting strong{color:#4f46e5}.slider-setting :deep(.el-slider){padding:0 5px}.appearance-row{display:grid;grid-template-columns:1.2fr 1fr 1fr;gap:13px;margin-top:15px}.appearance-row label{display:flex;flex-direction:column;gap:8px}.appearance-row label>div{display:flex;align-items:center;gap:8px;min-height:32px}.appearance-row code{color: var(--c-text-secondary);font-size:11px}.appearance-row :deep(.el-segmented){width:100%}.metric-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px}.metric-grid div{display:flex;flex-direction:column;padding:14px;border-radius:var(--radius-md);background: var(--c-surface-subtle)}.metric-grid strong{color:#312e81;font-size:22px}.metric-grid span{margin-top:3px;color: var(--c-text-secondary);font-size:11px}.css-card{margin-top:14px;overflow:hidden;border: 1px solid var(--c-border);border-radius:var(--radius-md);background:#0f172a}.css-card>div{display:flex;justify-content:space-between;padding:9px 12px;border-bottom:1px solid #334155;color: var(--c-text-muted);font-size:11px;font-weight:800}.css-card button{border:0;background:transparent;color:#c7d2fe;cursor:pointer}.css-card pre{margin:0;padding:14px;overflow:auto;color:#c7d2fe;font:11px/1.75 ui-monospace,SFMono-Regular,monospace;white-space:pre-wrap}.browse-action{width:100%;margin-top:14px;border-color:#c7d2fe;background:#eef2ff;color:#4338ca}.privacy-note{display:flex;flex-direction:column;gap:4px;margin-top:14px;padding:13px;border-radius:var(--radius-md);background: var(--c-surface-subtle);color: var(--c-text-secondary);font-size:12px}.privacy-note strong{color: var(--c-text-strong)}.font-browser-card .preview-heading :deep(.el-input){width:280px}.font-list{display:grid;grid-template-columns:1fr 1fr;gap:10px;max-height:620px;margin-top:18px;padding-right:4px;overflow:auto}.font-list button{display:flex;flex-direction:column;gap:10px;min-width:0;padding:15px;border: 1px solid var(--c-border);border-radius:var(--radius-md);background: var(--c-surface-subtle);color: var(--c-text-body);text-align:left;cursor:pointer}.font-list button.active{border-color:#6366f1;background:#eef2ff;box-shadow:0 0 0 2px rgba(99,102,241,.12)}.font-list span{font:700 11px/1.2 ui-monospace,monospace}.font-list strong{overflow:hidden;color: var(--c-text-primary);font-size:24px;text-overflow:ellipsis;white-space:nowrap}.empty-state{padding:50px;text-align:center;color: var(--c-text-muted)}.dark .control-card, .dark .font-browser-card {border-color:#334155;background:#1e293b}.dark .preview-heading h3,.dark .card-heading h3{color:#f8fafc}.dark .preview-heading p,.dark .textarea-field>span,.dark .font-source-field label>span,.dark .sample-presets>span,.dark .appearance-row label>span{color: var(--c-text-muted)}.dark .preview-actions>button,.dark .card-heading>button,.dark .source-actions button{border-color:#475569;background:#0f172a;color:#cbd5e1}.dark .specimen-stage,.dark .waterfall-stage{border-color:#475569}.dark .preview-meta span{background:#312e81;color:#c7d2fe}.dark .sample-presets button,.dark .metric-grid div,.dark .privacy-note,.dark .font-list button{border-color:#334155;background:#0f172a}.dark .sample-presets button:hover,.dark .font-list button.active{border-color:#818cf8;background:#22224e}.dark .font-source-field{border-color:#334155}.dark .metric-grid strong{color:#a5b4fc}.dark .privacy-note strong,.dark .font-list strong{color:#e2e8f0}.dark .browse-action{border-color:#4338ca;background:#312e81;color:#e0e7ff}@media(max-width:980px){.workspace-grid{grid-template-columns:1fr}.sample-presets{grid-template-columns:repeat(4,1fr)}}@media(max-width:680px){.font-preview-page{gap:14px}.preview-card,.control-card,.insight-card,.font-browser-card{border-radius:var(--radius-lg)}.preview-card,.control-card,.insight-card,.font-browser-card{padding:15px}.preview-heading{flex-direction:column}.preview-actions{width:100%;flex-wrap:wrap}.preview-actions :deep(.el-segmented){flex:1}.preview-actions>button{flex:1}.specimen-stage{min-height:210px;padding:20px}.sample-presets>div,.slider-grid,.appearance-row,.font-list{grid-template-columns:1fr}.source-actions{flex-direction:column}.source-actions button{width:100%}.font-browser-card .preview-heading :deep(.el-input){width:100%}.waterfall-stage{padding:14px}.waterfall-stage>div{grid-template-columns:34px minmax(0,1fr)}}</style>
