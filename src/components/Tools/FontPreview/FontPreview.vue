    ...
    <ToolHero summary="不只看一个字，而是检查整套阅读气质">
      <template #metrics>
        <div class="hero-metrics">
          <div><span>当前来源</span><strong>{{ selectedFont.source }}</strong></div>
          <div><span>标本字号</span><strong>{{ settings.fontSize }} px</strong></div>
          <div><span>文本行数</span><strong>{{ metrics.lines }}</strong></div>
        </div>
      </template>
    </ToolHero>
