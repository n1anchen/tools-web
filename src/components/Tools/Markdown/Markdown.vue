  ...
  <div class="markdown-page flex flex-col mt-3 flex-1">
    ...
    <section class="studio-hero">
      ...
      <div class="hero-stats">
        ...
        <div><strong>{{ headingCount }}</strong><span>标题层级</span></div>
