...
<style scoped>
.ascii-page{--amber:#d97706;gap:18px}.lookup-card, .group-nav, .filter-card, .detail-card {border: 1px solid var(--c-border);border-radius:22px;background:#fff;box-shadow:0 14px 38px rgba(15,23,42,.06)}.eyebrow{display:block;margin-bottom:6px;color:#fcd34d;font-size:12px;font-weight:900;letter-spacing:.16em}.lookup-card{display:grid;grid-template-columns:minmax(220px,.7fr) minmax(320px,1fr) auto;align-items:center;gap:22px;padding:19px 22px}.lookup-card .eyebrow,.filter-card .eyebrow,.result-card .eyebrow,.detail-card .eyebrow{color:var(--amber)}.lookup-card h3,.filter-card h3,.result-card h3,.detail-card h3{margin:0;color: var(--c-text-primary);font-size:19px}.lookup-card p,.filter-card p{margin:4px 0 0;color: var(--c-text-secondary);font-size:13px;line-height:1.55}.lookup-input{display:grid;grid-template-columns:1fr auto}.lookup-input :deep(.el-input__wrapper){border-radius:11px 0 0 11px}.lookup-input button{display:inline-flex;align-items:center;justify-content:center;gap:5px;padding:0 14px;border:0;border-radius:0 11px 11px 0;background:linear-gradient(135deg,#d97706,#be123c);color:#fff;font-size:13px;font-weight:800;cursor:pointer}.popular-list{display:flex;align-items:center;gap:6px}.popular-list>span{color: var(--c-text-secondary);font-size:12px}.popular-list button{display:grid;min-width:38px;min-height:40px;place-items:center;padding:4px 7px;border: 1px solid var(--c-border);border-radius:9px;background: var(--c-surface-subtle);color: var(--c-text-strong);cursor:pointer}.popular-list b{font:800 13px ui-monospace,monospace}.popular-list small{color: var(--c-text-muted);font-size:11px}.group-nav{display:grid;grid-template-columns:repeat(4,1fr);gap:9px;padding:10px}.group-nav button{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:13px;border:1px solid transparent;border-radius:14px;background:transparent;color: var(--c-text-secondary);text-align:left;cursor:pointer}.group-nav strong,.group-nav small{display:block}.group-nav strong{color: var(--c-text-strong);font-size:15px}.group-nav small{margin-top:2px;color: var(--c-text-muted);font-size:12px}.group-nav b{display:grid;min-width:36px;height:36px;place-items:center;border-radius:10px;background:#f1f5f9;font:800 12px ui-monospace,monospace}.group-nav button.active{border-color:#fbbf24;background:#fffbeb}.group-nav button.active strong,.group-nav button.active b{color:#92400e}.filter-card{display:grid;grid-template-columns:minmax(220px,.7fr) minmax(300px,1fr) auto;align-items:center;gap:22px;padding:18px 22px}.filter-card>span{color: var(--c-text-secondary);font-size:13px;font-weight:750}.workspace-grid{display:grid;grid-template-columns:minmax(0,1fr) 340px;align-items:start;gap:18px}.result-card,.detail-card{padding:22px}.result-card>header,.detail-card>header{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.result-card header small{color: var(--c-text-muted);font-size:12px}.character-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(90px,1fr));gap:9px;margin-top:17px}.character-grid button{display:flex;min-width:0;min-height:94px;align-items:center;justify-content:center;flex-direction:column;border: 1px solid var(--c-border);border-radius:13px;background: var(--c-surface-subtle);color: var(--c-text-strong);cursor:pointer}.character-grid button:hover,.character-grid button.selected{border-color:#f59e0b;background:#fffbeb;box-shadow:0 6px 16px rgba(217,119,6,.12)}.character-grid span{max-width:100%;overflow:hidden;font:800 24px ui-monospace,SFMono-Regular,Consolas,monospace;text-overflow:ellipsis}.character-grid small{margin-top:7px;color: var(--c-text-secondary);font-size:12px}.character-grid code{margin-top:2px;color: var(--c-text-muted);font-size:12px}.empty-state{display:grid;min-height:260px;margin-top:17px;place-items:center;border:1px dashed #cbd5e1;border-radius:14px;color: var(--c-text-muted);font-size:13px}.detail-card{position:sticky;top:80px}.category-pill{padding:5px 9px;border-radius:999px;color:#92400e;background:#fef3c7;font-size:12px;font-weight:800}.symbol-preview{display:flex;align-items:center;gap:16px;margin-top:18px;padding:18px;border-radius:15px;color:#fff;background:linear-gradient(135deg,#b45309,#be123c)}.symbol-preview>strong{display:grid;width:78px;height:78px;flex:none;place-items:center;border-radius:14px;background:rgba(255,255,255,.16);font:900 31px ui-monospace,monospace}.symbol-preview span{font:800 18px ui-monospace,monospace}.symbol-preview p{margin:5px 0 0;color:#fef3c7;font-size:13px;line-height:1.55}.value-list{margin-top:14px;border: 1px solid var(--c-border);border-radius:14px;overflow:hidden}.value-list button{display:grid;width:100%;grid-template-columns:1fr 1fr auto;align-items:center;gap:8px;padding:11px 12px;border:0;border-bottom: 1px solid var(--c-border);background:#fff;color: var(--c-text-secondary);text-align:left;cursor:pointer}.value-list button:last-child{border:0}.value-list button:hover{background:#fffbeb}.value-list span{font-size:12px}.value-list code{color: var(--c-text-primary);font:800 13px ui-monospace,monospace}.byte-map{margin-top:14px;padding:14px;border-radius:13px;background: var(--c-surface-subtle)}.byte-map>span,.byte-map>small{color: var(--c-text-secondary);font-size:12px}.byte-map>div{display:grid;grid-template-columns:repeat(8,1fr);gap:4px;margin:10px 0}.byte-map b{display:grid;aspect-ratio:1;place-items:center;border-radius:6px;color:#fff;background:#334155;font:800 12px ui-monospace,monospace}:global(html.dark .ascii-page .lookup-card),:global(html.dark .ascii-page .group-nav),:global(html.dark .ascii-page .filter-card),:global(html.dark .ascii-page .result-card),:global(html.dark .ascii-page .detail-card){border-color: var(--c-border);background:var(--c-surface);box-shadow:none}:global(html.dark .ascii-page h3),:global(html.dark .ascii-page .group-nav strong),:global(html.dark .ascii-page .value-list code){color:#f8fafc}:global(html.dark .ascii-page .popular-list button),:global(html.dark .ascii-page .group-nav b),:global(html.dark .ascii-page .character-grid button),:global(html.dark .ascii-page .value-list button),:global(html.dark .ascii-page .byte-map){border-color: var(--c-border-strong);background:var(--c-surface-subtle);color: var(--c-text-primary)}:global(html.dark .ascii-page .group-nav button.active),:global(html.dark .ascii-page .character-grid button.selected){border-color:#d97706;background:#451a03}:global(html.dark .ascii-page .value-list){border-color: var(--c-border)}:global(html.dark .ascii-page .value-list button){border-color: var(--c-border)}@media(max-width:1100px){.lookup-card,.filter-card{grid-template-columns:1fr}.popular-list{overflow-x:auto}.workspace-grid{grid-template-columns:1fr}.detail-card{position:static}.character-grid{grid-template-columns:repeat(auto-fill,minmax(82px,1fr))}}@media(max-width:680px){.ascii-page{gap:14px}.lookup-card,.filter-card,.result-card,.detail-card{padding:15px}.lookup-input{grid-template-columns:1fr}.lookup-input :deep(.el-input__wrapper){border-radius:10px}.lookup-input button{min-height:40px;margin-top:8px;border-radius:10px}.group-nav{grid-template-columns:1fr 1fr}.character-grid{grid-template-columns:repeat(3,1fr)}.character-grid button{min-height:88px}.hero-card h2{font-size:25px}.result-card>header{flex-direction:column}}</style>
