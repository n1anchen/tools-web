...
.lookup-card, .group-nav, .filter-card, .detail-card {
...
.lookup-card {
  display: grid;
  grid-template-columns: minmax(220px,.7fr) minmax(320px,1fr) auto;
  align-items: center;
  gap: 22px;
  padding:19px 22px
}
.lookup-card .eyebrow,.filter-card .eyebrow,.result-card .eyebrow,.detail-card .eyebrow {
  color:var(--amber)
}
.lookup-card h3,.filter-card h3,.result-card h3,.detail-card h3 {
  margin: 0;
  color: var(--c-text-primary);
  font-size:19px
}
.lookup-card p,.filter-card p {
  margin: 4px 0 0;
...
.group-nav strong,.group-nav small {
  display:block
}
.group-nav strong {
  color: var(--c-text-strong);
...
.group-nav button.active strong,.group-nav button.active b {
  color:#92400e
}
.filter-card {
  display: grid;
...
.result-card>header,.detail-card>header {
  display: flex;
...
.character-grid button:hover,.character-grid button.selected {
  border-color: #f59e0b;
  background: #fffbeb;
...
.symbol-preview>strong {
  ...
  font:900 31px ui-monospace,monospace
}
.symbol-preview span {
...
.value-list button:last-child {
  border:0
}
.value-list button:hover {
  background:#fffbeb
}
.value-list span {
  font-size:12px
...
:global(html.dark .ascii-page .lookup-card),:global(html.dark .ascii-page .group-nav),:global(html.dark .ascii-page .filter-card),:global(html.dark .ascii-page .result-card),:global(html.dark .ascii-page .detail-card) {
  border-color: var(--c-border);
  background: var(--c-surface);
  box-shadow:none
}
:global(html.dark .ascii-page h3),:global(html.dark .ascii-page .group-nav strong),:global(html.dark .ascii-page .value-list code) {
  color:#f8fafc
}
:global(html.dark .ascii-page .popular-list button),:global(html.dark .ascii-page .group-nav b),:global(html.dark .ascii-page .character-grid button),:global(html.dark .ascii-page .value-list button),:global(html.dark .ascii-page .byte-map) {
  border-color: var(--c-border-strong);
  background: var(--c-surface-subtle);
  color: var(--c-text-primary)
}
:global(html.dark .ascii-page .group-nav button.active),:global(html.dark .ascii-page .character-grid button.selected) {
  border-color: #d97706;
  background:#451a03
}
:global(html.dark .ascii-page .value-list) {
  border-color: var(--c-border)
}
:global(html.dark .ascii-page .value-list button) {
  border-color: var(--c-border)
}
@media(max-width:1100px) {
  .lookup-card,.filter-card {
...
@media(max-width:680px) {
  ...
  .lookup-card,.filter-card,.result-card,.detail-card {
    padding:15px
  }
  .lookup-input {
    grid-template-columns:1fr
