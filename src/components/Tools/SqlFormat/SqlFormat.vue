...
<style scoped>
.sql-page { --blue: #2563eb; gap: 16px; }.sample-card, .editor-card, .settings-card, .stat-strip { border: 1px solid #e2e8f0; border-radius: 22px; background: #fff; box-shadow: 0 12px 35px rgb(15 23 42 / 6%); }.eyebrow { color: var(--blue); font-size:12px; font-weight: 800; letter-spacing: .15em; }
.sample-card { display: flex; align-items: center; gap: 7px; padding: 11px 14px; overflow-x: auto; }.sample-card > span { flex: none; color: #94a3b8; font-size:12px; }.sample-card button { display: flex; align-items: center; gap: 7px; flex: none; padding: 6px 9px; border: 1px solid #e2e8f0; border-radius: 9px; color: #475569; background: #f8fafc; cursor: pointer; }.sample-card strong { font-size:12px; }.sample-card small { padding: 2px 4px; border-radius: 4px; color: #2563eb; background: #dbeafe; font-size:12px; }
.workspace { display: grid; grid-template-columns: minmax(0, 1fr) 300px; align-items: start; gap: 16px; }.editor-card { min-width: 0; overflow: hidden; }.editor-toolbar, .editor-footer { display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 11px 14px; }.editor-toolbar > div:first-child { display: flex; align-items: center; gap: 9px; }.status-dot { display: flex; align-items: center; gap: 6px; color: #16a34a; font-size:12px; }.status-dot i { width: 6px; height: 6px; border-radius: 50%; background: #22c55e; box-shadow: 0 0 0 4px #dcfce7; }.status-dot.error { color: #dc2626; }.status-dot.error i { background: #ef4444; box-shadow: 0 0 0 4px #fee2e2; }.editor-toolbar small { color: #94a3b8; font-size:12px; }.toolbar-actions { display: flex; gap: 4px; }.editor-card :deep(.ace-editor) { border-width: 1px 0; border-radius: 0; }.error-panel { display: flex; flex-direction: column; padding: 11px 14px; color: #991b1b; background: #fef2f2; }.error-panel strong { font-size:12px; }.error-panel code { margin: 4px 0; font-size:12px; overflow-wrap: anywhere; }.error-panel span { font-size:12px; opacity: .75; }.editor-footer > div { display: flex; align-items: center; flex-wrap: wrap; gap: 5px; }.editor-footer span { padding: 3px 6px; border-radius: 6px; color: #64748b; background: #f1f5f9; font-size:12px; }.editor-footer button { display: flex; align-items: center; gap: 3px; padding: 4px 6px; border: 0; border-radius: 6px; color: #64748b; background: transparent; font-size:12px; cursor: pointer; }.editor-footer button.active { color: #1d4ed8; background: #dbeafe; }
.settings-card { position: sticky; top: 14px; padding: 19px; }.section-heading { display: flex; align-items: center; justify-content: space-between; gap: 12px; }.section-heading h3 { margin: 3px 0 0; color: #0f172a; font-size: 16px; }.section-heading > span { padding: 3px 6px; border-radius: 6px; color: #2563eb; background: #dbeafe; font-size:12px; }.settings-list { display: flex; flex-direction: column; gap: 12px; margin-top: 17px; }.settings-list > label, .split-settings label { display: flex; min-width: 0; flex-direction: column; gap: 5px; }.settings-list label > span, .switch-row > span { color: #64748b; font-size:12px; }.settings-list b { float: right; color: #334155; font-family: ui-monospace, monospace; }.split-settings { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; }.split-settings :deep(.el-input-number) { width: 100%; }.settings-list :deep(.el-radio-group) { display: grid; grid-template-columns: 1fr 1fr; }.settings-list :deep(.el-radio-button__inner) { width: 100%; padding: 8px 5px; font-size:12px; }.switch-row { display: flex; align-items: center; justify-content: space-between; }.primary-actions { display: grid; grid-template-columns: 1fr 1fr; gap: 7px; margin-top: 17px; }.primary-actions .el-button { margin: 0; }.primary-actions .el-button:last-child { grid-column: 1 / -1; }.settings-card > p { margin: 12px 0 0; color: #94a3b8; font-size:12px; line-height: 1.55; }
.stat-strip { display: grid; grid-template-columns: repeat(5, 1fr); padding: 10px; }.stat-strip div { display: flex; align-items: center; flex-direction: column; padding: 8px; border-right: 1px solid #e2e8f0; }.stat-strip div:last-child { border: 0; }.stat-strip span { color: #94a3b8; font-size:12px; }.stat-strip strong { margin-top: 2px; color: #334155; font-size:12px; }
:global(html.dark .sql-page .sample-card), :global(html.dark .sql-page .editor-card), :global(html.dark .sql-page .settings-card), :global(html.dark .sql-page .stat-strip) { border-color: #334155; background: #1e293b; box-shadow: none; }:global(html.dark .sql-page h3), :global(html.dark .sql-page .settings-list b), :global(html.dark .sql-page .stat-strip strong) { color: #f8fafc; }:global(html.dark .sql-page .sample-card button), :global(html.dark .sql-page .editor-footer span) { border-color: #334155; color: #cbd5e1; background: #0f172a; }:global(html.dark .sql-page .stat-strip div) { border-color: #334155; }:global(html.dark .sql-page .error-panel) { color: #fecaca; background: #450a0a; }
...
@media (max-width: 640px) { .editor-toolbar, .editor-footer { align-items: flex-start; flex-direction: column; }.toolbar-actions { width: 100%; }.toolbar-actions .el-button { min-width: 0; flex: 1; padding: 7px 5px; }.settings-card { padding: 17px; border-radius: 19px; }.settings-list { display: flex; }.primary-actions { grid-template-columns: 1fr; }.stat-strip { grid-template-columns: repeat(2, 1fr); }.stat-strip div { border-bottom: 1px solid #e2e8f0; }.stat-strip div:last-child { grid-column: 1 / -1; }.split-settings { grid-template-columns: 1fr 1fr; } }
</style>
