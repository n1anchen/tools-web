...
<style scoped>
.sql-page { --blue: #2563eb; gap: 16px; }.hero-card, .sample-card, .editor-card, .settings-card, .stat-strip { border: 1px solid #e2e8f0; border-radius: 22px; background: #fff; box-shadow: 0 12px 35px rgb(15 23 42 / 6%); }.hero-card { display: flex; align-items: center; justify-content: space-between; gap: 22px; padding: 25px 28px; background: radial-gradient(circle at 88% 10%, #dbeafe, transparent 28%), #fff; }.eyebrow { color: var(--blue); font-size:12px; font-weight: 800; letter-spacing: .15em; }.hero-card h2 { margin: 6px 0 4px; color: #0f172a; font-size: clamp(21px, 3vw, 28px); }.hero-card p { margin: 0; color: #64748b; font-size: 13px; }.hero-dialect { display: grid; min-width: 145px; grid-template-columns: 1fr auto; gap: 2px 8px; padding: 11px 13px; border: 1px solid #bfdbfe; border-radius: 14px; background: #eff6ff; }.hero-dialect span { grid-column: 1 / -1; color: #60a5fa; font-size:12px; }.hero-dialect strong { color: #1e40af; font-size:12px; }.hero-dialect small { padding: 2px 5px; border-radius: 5px; color: #fff; background: #2563eb; font-size:12px; }
