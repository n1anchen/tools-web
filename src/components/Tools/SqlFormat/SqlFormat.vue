...
.stat-strip { display: grid; grid-template-columns: repeat(5, 1fr); padding: 10px; }.stat-strip div { display: flex; align-items: center; flex-direction: column; padding: 8px; border-right: 1px solid #e2e8f0; }.stat-strip div:last-child { border: 0; }.stat-strip span { color: var(--c-text-muted); font-size:12px; }.stat-strip strong { margin-top: 2px; color: #334155; font-size:12px; }
