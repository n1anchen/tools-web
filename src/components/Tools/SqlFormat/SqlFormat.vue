...
<style scoped>
.sql-page { --blue: #2563eb; gap: 16px; }.sample-card, .editor-card, .settings-card, .stat-strip { border: 1px solid var(--c-border); border-radius: 22px; background: #fff; box-shadow: 0 12px 35px rgb(15 23 42 / 6%); }.eyebrow { color: var(--blue); font-size:12px; font-weight: 800; letter-spacing: .15em; }
.sample-card { display: flex; align-items: center; gap: 7px; padding: 11px 14px; overflow-x: auto; }.sample-card > span { flex: none; color: var(--c-text-muted); font-size:12px; }.sample-card button { display: flex; align-items: center; gap: 7px; flex: none; padding: 6px 9px; border: 1px solid var(--c-border); border-radius: 9px; color: var(--c-text-body); background: var(--c-surface-subtle); cursor: pointer; }.sample-card strong { font-size:12px; }.sample-card small { padding: 2px 4px; border-radius: 4px; color: #2563eb; background: #dbeafe; font-size:12px; }
