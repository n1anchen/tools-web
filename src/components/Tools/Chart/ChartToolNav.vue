...
<style scoped>
.chart-tool-nav{display:grid;grid-template-columns:190px minmax(0,1fr);align-items:stretch;gap:12px;padding:12px;border: 1px solid var(--c-border);border-radius:var(--radius-card);background:var(--c-surface);box-shadow: var(--shadow-card)}.nav-intro{display:flex;justify-content:center;flex-direction:column;padding:8px 12px;border-radius:var(--radius-md);background:linear-gradient(135deg,#f8fafc,#eff6ff)}.nav-intro span{color:var(--accent);font-size:10px;font-weight:900;letter-spacing:.15em}.nav-intro strong{margin-top:4px;color: var(--c-text-primary);font-size:14px}.nav-intro small{margin-top:4px;color: var(--c-text-secondary);font-size:11px;line-height:1.45}.nav-groups{display:grid;grid-template-columns:1.08fr 1.08fr .92fr;gap:8px}.nav-group{min-width:0;padding:8px 9px;border:1px solid #e8edf4;border-radius:var(--radius-md);background:#fbfdff}.nav-group header{display:flex;align-items:baseline;gap:7px;padding:0 3px 6px}.nav-group header strong{flex:none;color: var(--c-text-strong);font-size:12px}.nav-group header small{min-width:0;overflow:hidden;color: var(--c-text-muted);font-size:10px;text-overflow:ellipsis;white-space:nowrap}.nav-group>div{display:flex;flex-wrap:wrap;gap:4px}.nav-group a{flex:none;padding:6px 8px;border:1px solid transparent;border-radius:var(--radius-xs);color: var(--c-text-body);font-size:11px;font-weight:800;text-decoration:none;transition:.16s}.nav-group a:hover{background:#f1f5f9;color:var(--accent)}.nav-group a.active{border-color:color-mix(in srgb,var(--accent),#fff 58%);background:var(--accent-soft);color:var(--accent);box-shadow:0 1px 5px color-mix(in srgb,var(--accent),transparent 86%)}
:global(html.dark .chart-tool-nav){border-color: var(--c-border);background:var(--c-surface);box-shadow:none}:global(html.dark .nav-intro){background:linear-gradient(135deg,#0f172a,#172554)}:global(html.dark .nav-intro strong){color:#f8fafc}:global(html.dark .nav-group){border-color: var(--c-border);background:#172033}:global(html.dark .nav-group header strong){color: var(--c-text-secondary)}:global(html.dark .nav-group a){color: var(--c-text-secondary)}:global(html.dark .nav-group a:hover){background:#334155}:global(html.dark .nav-group a.active){border-color:var(--accent);background:color-mix(in srgb,var(--accent),#0f172a 74%);color: var(--c-on-accent)}
...
@media(max-width:760px){.chart-tool-nav{display:block;padding:10px;border-radius:var(--radius-lg)}.nav-intro{display:block;margin-bottom:9px;padding:8px 10px}.nav-intro small{display:block;margin-top:3px}.nav-groups{display:grid;grid-template-columns:1fr;gap:7px}.nav-group{padding:9px}.nav-group header{padding-bottom:5px}.nav-group a{padding:7px 9px;font-size:12px}}
</style>
