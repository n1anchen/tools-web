...
.nav-group a.active {
  border-color: color-mix(in srgb,var(--accent),#fff 58%);
  background: var(--accent-soft);
  color: var(--accent);
  box-shadow:0 1px 5px color-mix(in srgb,var(--accent),transparent 86%)
}
:global(html.dark .chart-tool-nav) {
  border-color: var(--c-border);
  background: var(--c-surface);
  box-shadow:none
}
:global(html.dark .nav-intro) {
  background:linear-gradient(135deg,#0f172a,#172554)
}
:global(html.dark .nav-intro strong) {
  color:#f8fafc
}
:global(html.dark .nav-group) {
  border-color: var(--c-border);
  background:#172033
}
:global(html.dark .nav-group header strong) {
  color: var(--c-text-secondary)
}
:global(html.dark .nav-group a) {
  color: var(--c-text-secondary)
}
:global(html.dark .nav-group a:hover) {
  background:#334155
}
:global(html.dark .nav-group a.active) {
  border-color: var(--accent);
  background: color-mix(in srgb,var(--accent),#0f172a 74%);
