...
.grid-toolbar strong,.grid-toolbar span {
  display:block
}
.grid-toolbar strong {
...
.header-row td,.header-row .row-number {
  position: sticky;
  z-index: 2;
  top: 38px;
...
:global(html.dark .grid-editor),:global(html.dark .grid-scroll) {
  border-color: var(--c-border-strong);
  background:var(--c-surface-subtle)
}
:global(html.dark .grid-toolbar),:global(html.dark .grid-footer),:global(html.dark .row-number),:global(html.dark .row-action) {
...
:global(html.dark .grid-editor thead th) {
  background: #253248;
  color: var(--c-text-muted)
}
:global(html.dark .grid-editor .header-row td),:global(html.dark .grid-editor .header-row .row-number) {
  background:#172554
}
:global(html.dark .grid-editor td input) {
  color: var(--c-text-primary)
}
