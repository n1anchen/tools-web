...
<style scoped>
.grid-editor{margin-top:12px;border:1px solid #dbe3ef;border-radius:var(--radius-md);overflow:hidden;background:var(--c-surface)}.grid-toolbar{display:flex;min-height:56px;align-items:center;justify-content:space-between;gap:12px;padding:9px 11px;border-bottom: 1px solid var(--c-border);background: var(--c-surface-subtle)}.grid-toolbar strong,.grid-toolbar span{display:block}.grid-toolbar strong{color: var(--c-text-strong);font-size:13px}.grid-toolbar span{margin-top:2px;color: var(--c-text-secondary);font-size:12px;line-height:1.4}.grid-actions{display:flex;flex:none;gap:5px}.grid-actions button{min-height:30px;padding:0 8px;border:1px solid #dbe3ef;border-radius:var(--radius-xs);background:var(--c-surface);color: var(--c-text-body);font-size:12px;font-weight:800;cursor:pointer}.grid-actions button:hover{border-color:var(--accent);color:var(--accent)}.grid-actions button:disabled{cursor:not-allowed;opacity:.4}.grid-scroll{height:260px;overflow:auto;overscroll-behavior:contain;background:var(--c-surface)}table{min-width:100%;border-spacing:0;border-collapse:separate;table-layout:fixed}th,td{height:38px;padding:0;border-right: 1px solid var(--c-border);border-bottom: 1px solid var(--c-border)}thead th{position:sticky;z-index:4;top:0;width:132px;background:#eef2f7;color: var(--c-text-secondary);font-size:11px;font-weight:850;text-align:center}.corner,.row-number{position:sticky;z-index:5;left:0;width:46px;min-width:46px;max-width:46px}.corner{top:0}.action-head,.row-action{width:34px;min-width:34px;max-width:34px;border-right:0}.row-number{z-index:3;background: var(--c-surface-subtle);color: var(--c-text-muted);font-size:11px;text-align:center}.header-row td,.header-row .row-number{position:sticky;z-index:2;top:38px;background:#eff6ff}.header-row .row-number{z-index:4}.header-row input{color:#1d4ed8;font-weight:850}td input{display:block;width:100%;height:37px;padding:0 9px;border:0;outline:0;background:transparent;color: var(--c-text-strong);font-size:12px;font-weight:650}td input:focus{position:relative;z-index:1;background:var(--c-surface);box-shadow:inset 0 0 0 2px var(--accent)}.row-action{background: var(--c-surface-subtle);text-align:center}.row-action button{width:24px;height:24px;border:0;border-radius:var(--radius-xs);background:transparent;color: var(--c-text-muted);font-size:17px;cursor:pointer}.row-action button:hover{background:#fee2e2;color:#dc2626}.grid-footer{display:flex;min-height:38px;align-items:center;justify-content:space-between;gap:10px;padding:0 11px;border-top: 1px solid var(--c-border);background: var(--c-surface-subtle);color: var(--c-text-secondary);font-size:11px}.grid-footer span{font-weight:750}.grid-footer i{display:inline-block;width:7px;height:7px;margin-right:6px;border-radius:50%;background:#10b981}.grid-footer b{color:#047857;font-size:11px}.grid-footer small{font-size:11px}
:global(html.dark .grid-editor),:global(html.dark .grid-scroll){border-color: var(--c-border-strong);background:var(--c-surface-subtle)}:global(html.dark .grid-toolbar),:global(html.dark .grid-footer),:global(html.dark .row-number),:global(html.dark .row-action){border-color: var(--c-border);background:#172033}:global(html.dark .grid-toolbar strong){color: var(--c-text-primary)}:global(html.dark .grid-actions button){border-color: var(--c-border-strong);background:var(--c-surface-subtle);color: var(--c-text-secondary)}:global(html.dark .grid-editor th),:global(html.dark .grid-editor td){border-color: var(--c-border)}:global(html.dark .grid-editor thead th){background:#253248;color: var(--c-text-muted)}:global(html.dark .grid-editor .header-row td),:global(html.dark .grid-editor .header-row .row-number){background:#172554}:global(html.dark .grid-editor td input){color: var(--c-text-primary)}:global(html.dark .grid-editor .header-row input){color:#93c5fd}:global(html.dark .grid-editor td input:focus){background:var(--c-surface)}
