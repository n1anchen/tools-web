...
@media(max-width:620px){.special-page{gap:14px}.hero-card{padding:22px 18px}.hero-card h2{font-size:25px}.hero-stats div{min-width:0;padding:7px 3px}.hero-stats strong{font-size:16px}.hero-stats span{font-size:12px}.sample-card,.data-card,.preview-card,.config-card{padding:15px;border-radius:17px}.sample-card>.section-heading,.card-header{flex-direction:column}.sample-list{grid-template-columns:1fr}.header-actions{width:100%}.header-actions button{flex:1}textarea{height:260px}.format-hint{flex-direction:column}.validation-box.success{flex-direction:column}.chart-shell{height:420px!important}.calendar-canvas{min-width:560px}.preview-summary span:first-child{width:100%;margin:0}.mobile-hint{display:block}.config-grid{grid-template-columns:1fr}.reset-button{width:100%}.palette-list{display:grid;grid-template-columns:1fr 1fr}.palette-list button{width:100%}}
