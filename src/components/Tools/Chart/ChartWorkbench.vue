...
.chart-family a.active {
  border-color: color-mix(in srgb,var(--accent),#fff 68%);
...
.palette-section>div:first-child small {
  display: block;
  margin-top: 4px;
  color: var(--c-text-secondary);
  font-size: 12px;
...
.palette-list>button,.custom-color {
  display: grid;
...
:global(html.dark .chart-page .chart-family),:global(html.dark .chart-page .sample-card),:global(html.dark .chart-page .data-card),:global(html.dark .chart-page .preview-card),:global(html.dark .chart-page .config-card) {
  border-color: var(--c-border);
  background: var(--c-surface);
  box-shadow:none
}
:global(html.dark .chart-page h3) {
  color:#f8fafc
}
:global(html.dark .chart-page .chart-family a),:global(html.dark .chart-page .sample-list button),:global(html.dark .chart-page .field>span),:global(html.dark .chart-page .palette-section>div:first-child>span) {
  color: var(--c-text-secondary)
}
:global(html.dark .chart-page .chart-family a:hover),:global(html.dark .chart-page .sample-list button),:global(html.dark .chart-page .mode-tabs),:global(html.dark .chart-page .segmented) {
  border-color: var(--c-border-strong);
  background:var(--c-surface-subtle)
}
:global(html.dark .chart-page .chart-family a.active),:global(html.dark .chart-page .sample-list button.active) {
  border-color: var(--accent);
...
:global(html.dark .chart-page .header-actions button.primary) {
  border-color: var(--accent);
  background: var(--accent);
  color: var(--c-on-accent)
}
:global(html.dark .chart-page .mode-tabs button.active),:global(html.dark .chart-page .segmented button.active) {
  background: #334155;
  color: var(--c-on-accent)
}
:global(html.dark .chart-page .data-card textarea) {
  border-color: var(--c-border-strong);
  background: var(--c-surface-subtle);
  color: var(--c-text-primary)
}
:global(html.dark .chart-page .chart-shell) {
  border-color: var(--c-border);
  background:var(--c-surface-subtle)
}
:global(html.dark .chart-page .chart-empty) {
  background:rgba(15,23,42,.86)
}
:global(html.dark .chart-page .config-card>.card-header),:global(html.dark .chart-page .palette-section) {
  border-color: var(--c-border)
}
:global(html.dark .chart-page .validation-box.success) {
  background:#12372a
}
:global(html.dark .chart-page .validation-box.success span) {
  color: var(--c-text-muted)
}
...
@media(max-width:820px) {
  ...
  .chart-family>span,.chart-family a {
    flex:none
  }
  .config-grid {
