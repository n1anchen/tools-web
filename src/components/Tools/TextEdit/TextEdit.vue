    ...
    <ToolHero summary="专注写内容，HTML 交付自然完成">
      <template #metrics>
        <div class="hero-metrics">
          ...
          <div><span>内容段落</span><strong>{{ statistics.paragraphs }}</strong></div>
