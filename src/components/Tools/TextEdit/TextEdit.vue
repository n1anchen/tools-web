...
<template>
  <div class="rich-page flex flex-col mt-3 flex-1">
    <ToolHero summary="专注写内容，HTML 交付自然完成">
      <template #metrics>
        <MetricsBar :items="[{ label: '有效字符', value: statistics.charactersWithoutWhitespace }, { label: '内容段落', value: statistics.paragraphs }, { label: '分钟阅读', value: statistics.readingMinutes || '—' }]" />
      </template>
    </ToolHero>
...
<style scoped>
.rich-page{gap:18px}.document-bar,.editor-card,.insight-card,.template-card,.source-card{border: 1px solid var(--c-border);border-radius:var(--radius-card);background:var(--c-surface);box-shadow: var(--shadow-card)}.eyebrow{display:block;margin-bottom:8px;color:#99f6e4;font-size:11px;font-weight:900;letter-spacing:.17em}.document-bar{display:grid;grid-template-columns:minmax(220px,1fr) minmax(240px,.8fr) auto;align-items:end;gap:18px;padding:18px 20px}.title-field{display:flex;flex-direction:column;gap:7px}.title-field>span{color: var(--c-text-secondary);font-size:11px;font-weight:800}.document-state{display:flex;align-items:center;gap:10px;padding-bottom:7px}.document-state i{width:9px;height:9px;border-radius:50%;background:#14b8a6;box-shadow:0 0 0 4px #ccfbf1}.document-state i.dirty{background:#f59e0b;box-shadow:0 0 0 4px #fef3c7}.document-state strong,.document-state span{display:block}.document-state strong{color: var(--c-text-strong);font-size:12px}.document-state span{margin-top:3px;color: var(--c-text-muted);font-size:10px}.bar-actions{display:flex;gap:8px}.bar-actions button,.card-heading>button,.source-actions button,.delivery-actions button{display:inline-flex;align-items:center;justify-content:center;gap:6px;min-height:38px;padding:0 12px;border:1px solid #dbe3ef;border-radius:var(--radius-sm);background:var(--c-surface);color: var(--c-text-body);font-weight:750;cursor:pointer}.bar-actions button.primary{border-color:#0d9488;background:#0d9488;color: var(--c-on-accent)}.bar-actions button:disabled,.source-actions button:disabled,.delivery-actions button:disabled{cursor:not-allowed;opacity:.45}.file-input{position:absolute;width:1px;height:1px;overflow:hidden;opacity:0;pointer-events:none}.workspace-grid{display:grid;grid-template-columns:minmax(0,1.65fr) minmax(280px,.58fr);gap:18px}.editor-card,.insight-card,.template-card,.source-card{padding:22px}.card-heading,.source-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:16px;margin-bottom:18px}.card-heading h3,.source-heading h3{margin:0;color: var(--c-text-primary);font-size:20px}.card-heading>button{min-height:34px}.editor-shell{height:620px;overflow:hidden;border: 1px solid var(--c-border);border-radius:var(--radius-md);background:var(--c-surface)}.editor-shell :deep(.w-e-toolbar){overflow-x:auto;border-bottom: 1px solid var(--c-border)}.editor-shell :deep(.w-e-text-container){height:570px!important}.side-column{display:flex;flex-direction:column;gap:18px}.summary-list{display:grid;gap:1px;overflow:hidden;border: 1px solid var(--c-border);border-radius:var(--radius-md);background:#e2e8f0}.summary-list div{display:flex;justify-content:space-between;padding:13px;background: var(--c-surface-subtle);color: var(--c-text-secondary);font-size:12px}.summary-list strong{color:#1e293b}.template-list{display:grid;gap:8px}.template-list button{display:flex;flex-direction:column;gap:4px;padding:12px;border: 1px solid var(--c-border);border-radius:var(--radius-sm);background: var(--c-surface-subtle);color: var(--c-text-strong);text-align:left;cursor:pointer}.template-list button:hover{border-color:#2dd4bf;background:#f0fdfa}.template-list span{color: var(--c-text-muted);font-size:11px}.source-heading p{margin:5px 0 0;color: var(--c-text-secondary);font-size:12px}.source-actions{display:flex;gap:8px}.source-actions :deep(.el-segmented){min-width:210px}.source-card pre{box-sizing:border-box;min-height:210px;max-height:420px;margin:0;padding:18px;overflow:auto;border: 1px solid var(--c-border);border-radius:var(--radius-md);background:#0f172a;color:#cbd5e1;font:12px/1.75 ui-monospace,SFMono-Regular,Menlo,monospace;white-space:pre-wrap;word-break:break-word}.delivery-actions{display:flex;justify-content:flex-end;gap:8px;margin-top:12px}.delivery-actions button.danger{border-color:#fecaca;color:#b91c1c}.dark .source-card {border-color:#334155;background:#1e293b}.dark .card-heading h3,.dark .source-heading h3,.dark .document-state strong{color:#f8fafc}.dark .bar-actions button,.dark .card-heading>button,.dark .source-actions button,.dark .delivery-actions button{border-color:#475569;background:#0f172a;color:#cbd5e1}.dark .summary-list{border-color:#334155;background:#334155}.dark .summary-list div,.dark .template-list button{border-color:#334155;background:#0f172a;color: var(--c-text-muted)}.dark .summary-list strong{color:#e2e8f0}.dark .template-list button:hover{border-color:#2dd4bf;background:#073b38}.dark .editor-shell{border-color:#334155;background:#0f172a}.dark .editor-shell :deep(.w-e-toolbar){border-color:#334155;background:#0f172a;color:#cbd5e1}.dark .editor-shell :deep(.w-e-text-container),.dark .editor-shell :deep(.w-e-scroll){background:#111827;color:#e2e8f0}.dark .editor-shell :deep(.w-e-text-placeholder){color: var(--c-text-secondary)}@media(max-width:1100px){.document-bar{grid-template-columns:1fr 1fr}.bar-actions{grid-column:1/-1}.workspace-grid{grid-template-columns:1fr}.side-column{display:grid;grid-template-columns:1fr 1fr}}@media(max-width:680px){.rich-page{gap:14px}.document-bar,.editor-card,.insight-card,.template-card,.source-card{border-radius:var(--radius-lg)}.document-bar{grid-template-columns:1fr;padding:15px}.bar-actions{grid-column:auto;display:grid;grid-template-columns:1fr 1fr}.bar-actions button.primary{grid-column:1/-1}.editor-card,.insight-card,.template-card,.source-card{padding:15px}.editor-shell{height:560px}.editor-shell :deep(.w-e-text-container){height:510px!important}.side-column{display:flex}.source-heading{flex-direction:column}.source-actions{display:grid;width:100%}.source-actions :deep(.el-segmented){min-width:0;width:100%}.delivery-actions{display:grid;grid-template-columns:1fr 1fr}.document-state{padding-bottom:0}}</style>

<!-- wangEditor 暗色主题：非 scoped 以保证 html.dark 选择器不被 data-v 属性影响 -->
<style>
html.dark {
  --w-e-textarea-bg-color: #1e293b;
  --w-e-textarea-color: #e2e8f0;
  --w-e-textarea-border-color: #475569;
  ...
  --w-e-toolbar-disabled-color: #64748b;
