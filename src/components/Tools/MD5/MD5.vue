...
<style scoped>
.md5-page { --blue: #2563eb; gap: 16px; }.hero-card, .panel, .knowledge-card { border: 1px solid #e2e8f0; border-radius: 22px; background: #fff; box-shadow: 0 12px 35px rgb(15 23 42 / 6%); }.hero-card { display: flex; align-items: center; justify-content: space-between; gap: 22px; padding: 25px 28px; background: radial-gradient(circle at 88% 10%, #dbeafe, transparent 28%), #fff; }.eyebrow { color: var(--blue); font-size: 10px; font-weight: 800; letter-spacing: .15em; }.hero-card h2 { margin: 6px 0 4px; color: #0f172a; font-size: clamp(21px, 3vw, 28px); }.hero-card p { margin: 0; color: #64748b; font-size: 13px; }.security-note { display: flex; align-items: center; gap: 10px; flex: none; max-width: 230px; padding: 11px 13px; border: 1px solid #fed7aa; border-radius: 14px; color: #c2410c; background: #fff7ed; }.security-note > .el-icon { font-size: 20px; }.security-note span { display: flex; flex-direction: column; font-size: 9px; }.security-note b { font-size: 11px; }
.mode-tabs { display: grid; grid-template-columns: repeat(2, 1fr); gap: 9px; }.mode-tabs button { display: flex; align-items: center; gap: 11px; padding: 13px 16px; border: 1px solid #e2e8f0; border-radius: 16px; color: #64748b; background: #fff; text-align: left; cursor: pointer; transition: .18s ease; }.mode-tabs button:hover, .mode-tabs button.active { border-color: #93c5fd; background: #eff6ff; transform: translateY(-2px); }.mode-tabs button > span { display: grid; width: 34px; height: 34px; flex: none; place-items: center; border-radius: 10px; color: #fff; background: #94a3b8; font: 800 10px ui-monospace, monospace; }.mode-tabs button.active > span { background: var(--blue); }.mode-tabs div { display: flex; flex-direction: column; }.mode-tabs strong { color: #334155; font-size: 12px; }.mode-tabs small { color: #94a3b8; font-size: 9px; }
.workspace { display: grid; grid-template-columns: minmax(0, 1.2fr) minmax(330px, .8fr); align-items: start; gap: 16px; }.input-column { display: flex; min-width: 0; flex-direction: column; gap: 16px; }.panel { padding: 21px; }.panel-heading { display: flex; align-items: center; justify-content: space-between; gap: 12px; margin-bottom: 15px; }.panel-heading h3 { margin: 3px 0 0; color: #0f172a; font-size: 16px; }.input-stats { display: flex; gap: 6px; }.input-stats span, .privacy-badge { padding: 4px 7px; border-radius: 99px; color: #64748b; background: #f1f5f9; font-size: 8px; }.input-panel :deep(.el-textarea__inner), .compare-panel :deep(.el-input__wrapper) { border-radius: 13px; box-shadow: 0 0 0 1px #e2e8f0 inset; font-family: ui-monospace, monospace; }.example-row { display: flex; flex-wrap: wrap; align-items: center; gap: 6px; margin-top: 11px; }.example-row > span { color: #94a3b8; font-size: 9px; }.example-row button { padding: 4px 8px; border: 0; border-radius: 99px; color: #475569; background: #f1f5f9; font-size: 9px; cursor: pointer; }.drop-zone { display: flex; min-height: 250px; align-items: center; justify-content: center; flex-direction: column; border: 1px dashed #bfdbfe; border-radius: 16px; background: #f8fafc; transition: .18s ease; }.drop-zone.dragging { border-color: #2563eb; background: #eff6ff; }.drop-zone > .el-icon { color: #3b82f6; font-size: 36px; }.drop-zone strong { margin-top: 10px; color: #334155; }.drop-zone span { margin: 3px 0 15px; color: #94a3b8; font-size: 9px; }.drop-zone label, .replace-file { padding: 7px 13px; border-radius: 9px; color: #fff; background: #2563eb; font-size: 10px; cursor: pointer; }.drop-zone input, .replace-file input { display: none; }.file-progress-card { padding: 17px; border-radius: 16px; background: #f8fafc; }.file-main { display: flex; align-items: center; gap: 11px; margin-bottom: 17px; }.file-icon { display: grid; width: 43px; height: 43px; flex: none; place-items: center; border-radius: 12px; color: #2563eb; background: #dbeafe; }.file-main > div:nth-child(2) { display: flex; min-width: 0; flex: 1; flex-direction: column; }.file-main strong { color: #334155; overflow: hidden; text-overflow: ellipsis; font-size: 11px; white-space: nowrap; }.file-main span { color: #94a3b8; font-size: 9px; }.replace-file { display: block; width: fit-content; margin-top: 14px; }.compare-status { color: #94a3b8; font-size: 9px; }.compare-status.match { display: flex; align-items: center; gap: 4px; color: #16a34a; }.compare-status.mismatch, .compare-status.invalid { color: #dc2626; }.compare-panel > p { margin: 9px 0 0; color: #94a3b8; font-size: 9px; }
.result-panel { position: sticky; top: 14px; }.digest-visual { padding: 15px; border-radius: 15px; color: #dbeafe; background: linear-gradient(145deg, #172554, #1e3a8a); }.digest-visual > span { font-size: 8px; letter-spacing: .15em; }.digest-visual code { display: block; margin: 8px 0 13px; overflow-wrap: anywhere; color: #fff; font-size: 13px; }.digest-visual > div { display: grid; grid-template-columns: repeat(16, 1fr); gap: 3px; }.digest-visual i { height: 21px; border-radius: 3px; background: #60a5fa; }.result-list { display: flex; flex-direction: column; gap: 7px; margin-top: 12px; }.result-list button { display: grid; grid-template-columns: 84px minmax(0, 1fr) auto; align-items: center; gap: 8px; padding: 10px; border: 1px solid #e2e8f0; border-radius: 11px; color: #64748b; background: #f8fafc; text-align: left; cursor: pointer; }.result-list button.primary { border-color: #bfdbfe; background: #eff6ff; }.result-list span { font-size: 9px; }.result-list code { overflow: hidden; color: #334155; text-overflow: ellipsis; font-size: 9px; white-space: nowrap; }.result-empty { display: grid; min-height: 250px; place-items: center; color: #94a3b8; font-size: 10px; }.result-meta { display: grid; grid-template-columns: repeat(3, 1fr); gap: 6px; margin-top: 13px; }.result-meta div { display: flex; flex-direction: column; padding: 8px; border-radius: 9px; background: #f1f5f9; }.result-meta span { color: #94a3b8; font-size: 8px; }.result-meta strong { color: #475569; font-size: 9px; }
.knowledge-card { padding: 21px; }.knowledge-card h3 { margin: 3px 0 0; color: #0f172a; font-size: 17px; }.knowledge-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 9px; margin-top: 15px; }.knowledge-grid article { padding: 13px; border-radius: 13px; background: #f8fafc; }.knowledge-grid strong { color: #334155; font-size: 11px; }.knowledge-grid p { margin: 5px 0 0; color: #64748b; font-size: 10px; line-height: 1.65; }
