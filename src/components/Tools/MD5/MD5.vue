...
.input-stats span, .privacy-badge {
  padding: 4px 7px;
  border-radius: 99px;
  color: var(--c-text-secondary);
  background: #f1f5f9;
...
.input-panel :deep(.el-textarea__inner), .compare-panel :deep(.el-input__wrapper) {
...
.drop-zone input, .replace-file input {
  display: none;
}
.file-progress-card {
  padding: 17px;
...
.compare-status.mismatch, .compare-status.invalid {
  color: #dc2626;
}
.compare-panel > p {
  margin: 9px 0 0;
...
:global(html.dark .md5-page .panel), :global(html.dark .md5-page .knowledge-card), :global(html.dark .md5-page .mode-tabs button) {
  border-color: var(--c-border);
  background: var(--c-surface);
  box-shadow: none;
}
:global(html.dark .md5-page h3), :global(html.dark .md5-page .mode-tabs strong), :global(html.dark .md5-page .file-main strong), :global(html.dark .md5-page .drop-zone strong), :global(html.dark .md5-page .result-list code), :global(html.dark .md5-page .knowledge-grid strong) {
  color: #f8fafc;
}
