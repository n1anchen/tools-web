...
.comparison-card,.control-card,.insight-card {
...
.comparison-heading,.card-heading {
  display: flex;
  align-items: flex-start;
  justify-content: space-between;
  gap:18px
}
.comparison-heading h3,.card-heading h3 {
  margin: 0;
...
.progress-ring,.score-ring {
  ...
  place-items: center;
  border-radius: 50%;
  background:conic-gradient(#22c55e var(--progress),#dbe5df 0)
}
.progress-ring {
  width: 92px;
  height:92px
}
.progress-ring:before,.score-ring:before {
  content: "";
  grid-area: 1/1;
  border-radius: 50%;
  background:var(--c-surface)
...
.intensity-card>div:first-child {
  display: grid;
...
.intensity-meter i {
  ...
  background:linear-gradient(90deg,#4ade80,#65a30d,#ca8a04)
}
.process-actions {
  display: flex;
  margin-top:16px
...
.score-ring {
  ...
  height: 150px;
  margin: 0 auto 18px;
  background:conic-gradient(#22c55e var(--score),#e2e8f0 0)
}
.score-ring:before {
  width: 120px;
  height:120px
...
.dark .comparison-card, .dark .control-card {
  border-color: #334155;
  background:#1e293b
}
.dark .comparison-heading h3,.dark .card-heading h3 {
  color:#f8fafc
}
...
.dark .panel-label strong,.dark .empty-state strong {
  color:#e2e8f0
}
.dark .processing-overlay {
  background:rgba(15,23,42,.92)
}
.dark .progress-ring:before,.dark .score-ring:before {
  background:#1e293b
}
.dark .comparison-meta span {
  background: #14532d;
  color:#bbf7d0
}
...
.dark .intensity-card strong,.dark .privacy-note strong,.dark .score-ring strong {
  color:#86efac
}
.dark .intensity-card p,.dark .privacy-note {
  color:#86a991
}
.dark .summary-list {
  border-color: #334155;
