...
<template>
  <div class="patina-page flex flex-col mt-3 flex-1">
    ...
    <section class="studio-hero">
      <div><span class="eyebrow">DIGITAL PATINA LAB</span><h2>模拟一张图片，被反复转发后的痕迹</h2><p>{{ toolInfo.desc }}</p></div>
