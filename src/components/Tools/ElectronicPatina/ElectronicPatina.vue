...
<template>
  <div class="patina-page flex flex-col mt-3 flex-1">
    <ToolHero summary="模拟一张图片，被反复转发后的痕迹">
      <template #metrics>
        <MetricsBar :items="[{ label: '强度评分', value: profile.score }, { label: '压缩轮次', value: (compressionCount) + '×' }, { label: '单轮质量', value: (quality) + '%' }]" />
      </template>
    </ToolHero>
...
<style scoped>
.patina-page{gap:18px}.comparison-card,.control-card,.insight-card{border: 1px solid var(--c-border);border-radius:var(--radius-card);background:var(--c-surface);box-shadow: var(--shadow-card)}.eyebrow{display:block;margin-bottom:8px;color:#86efac;font-size:11px;font-weight:900;letter-spacing:.17em}.comparison-card,.control-card,.insight-card{padding:22px}.comparison-heading,.card-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:18px}.comparison-heading h3,.card-heading h3{margin:0;color: var(--c-text-primary);font-size:20px}.comparison-heading p{margin:5px 0 0;color: var(--c-text-secondary);font-size:13px}.top-actions{display:flex;gap:9px}.top-actions button,.card-heading>button,.process-actions button{display:inline-flex;align-items:center;justify-content:center;gap:6px;min-height:38px;padding:0 13px;border:1px solid #dbe3ef;border-radius:var(--radius-sm);background:var(--c-surface);color: var(--c-text-body);font-weight:750;cursor:pointer}.top-actions button.download,.process-actions button.primary{border-color:#16a34a;background:#16a34a;color: var(--c-on-accent)}.compare-grid{display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-top:18px}.image-panel{overflow:hidden;border: 1px solid var(--c-border);border-radius:var(--radius-lg);background: var(--c-surface-subtle)}.panel-label{display:flex;justify-content:space-between;gap:12px;padding:11px 14px;border-bottom: 1px solid var(--c-border)}.panel-label strong{color: var(--c-text-strong);font-size:13px}.panel-label span{overflow:hidden;color: var(--c-text-muted);font-size:11px;text-overflow:ellipsis;white-space:nowrap}.image-stage{position:relative;display:flex;align-items:center;justify-content:center;height:360px;padding:16px;overflow:hidden}.image-stage img{display:block;width:auto;max-width:100%;height:auto;max-height:100%;border-radius:var(--radius-xs)}.empty-state{display:flex;align-items:center;flex-direction:column;color: var(--c-text-muted)}.empty-state .el-icon{font-size:42px}.empty-state strong{margin-top:10px;color: var(--c-text-secondary)}.empty-state span{margin-top:4px;font-size:12px}.processing-overlay{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:14px;background:rgba(248,250,252,.9)}.processing-overlay button{display:flex;align-items:center;gap:5px;border:0;background:transparent;color:#b91c1c;font-weight:750;cursor:pointer}.progress-ring,.score-ring{display:grid;place-items:center;border-radius:50%;background:conic-gradient(#22c55e var(--progress),#dbe5df 0)}.progress-ring{width:92px;height:92px}.progress-ring:before,.score-ring:before{content:"";grid-area:1/1;border-radius:50%;background:var(--c-surface)}.progress-ring:before{width:74px;height:74px}.progress-ring span{z-index:1;grid-area:1/1;color:#166534;font-weight:900}.comparison-meta{display:flex;flex-wrap:wrap;gap:8px;margin-top:12px}.comparison-meta span{padding:5px 9px;border-radius:var(--radius-full);background:#dcfce7;color:#166534;font-size:11px;font-weight:750}.workspace-grid{display:grid;grid-template-columns:minmax(0,1.45fr) minmax(300px,.7fr);gap:18px}.card-heading{margin-bottom:20px}.card-heading>button{min-height:34px;padding:0 10px}.preset-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:8px}.preset-grid button{display:flex;flex-direction:column;gap:3px;padding:11px;border: 1px solid var(--c-border);border-radius:var(--radius-sm);background: var(--c-surface-subtle);color: var(--c-text-strong);text-align:left;cursor:pointer}.preset-grid button:hover{border-color:#4ade80;background:#f0fdf4}.preset-grid small{color: var(--c-text-muted)}.preset-grid span{margin-top:5px;color:#16a34a;font-size:10px;font-weight:750}.slider-setting{margin-top:19px}.slider-setting label{display:flex;justify-content:space-between;color: var(--c-text-secondary);font-size:12px;font-weight:800}.slider-setting strong{color:#16a34a}.slider-setting :deep(.el-slider){padding:0 5px}.option-field{display:flex;flex-direction:column;gap:8px;margin-top:16px}.option-field>span{color: var(--c-text-secondary);font-size:12px;font-weight:800}.option-field :deep(.el-segmented){width:100%}.intensity-card{margin-top:18px;padding:15px;border-radius:var(--radius-md);background:#f0fdf4}.intensity-card>div:first-child{display:grid;grid-template-columns:1fr auto;gap:4px 12px}.intensity-card span{color: var(--c-text-secondary);font-size:11px}.intensity-card strong{color:#166534}.intensity-card p{grid-column:1/-1;margin:2px 0 0;color:#4b7b5b;font-size:12px}.intensity-meter{height:7px;margin-top:12px;overflow:hidden;border-radius:var(--radius-full);background:#dcfce7}.intensity-meter i{display:block;height:100%;border-radius:inherit;background:linear-gradient(90deg,#4ade80,#65a30d,#ca8a04)}.process-actions{display:flex;margin-top:16px}.process-actions button{width:100%}.process-actions button:disabled{cursor:not-allowed;opacity:.5}.process-actions button.cancel{border-color:#fecaca;background:#fef2f2;color:#b91c1c}.score-ring{width:150px;height:150px;margin:0 auto 18px;background:conic-gradient(#22c55e var(--score),#e2e8f0 0)}.score-ring:before{width:120px;height:120px}.score-ring>div{z-index:1;grid-area:1/1;display:flex;align-items:baseline}.score-ring strong{color:#166534;font-size:38px}.score-ring span{color: var(--c-text-muted);font-size:12px}.summary-list{display:grid;gap:1px;overflow:hidden;border: 1px solid var(--c-border);border-radius:var(--radius-md);background:#e2e8f0}.summary-list div{display:flex;justify-content:space-between;padding:12px;background: var(--c-surface-subtle);color: var(--c-text-secondary);font-size:12px}.summary-list strong{color:#1e293b}.privacy-note{display:flex;flex-direction:column;gap:4px;margin-top:14px;padding:13px;border-radius:var(--radius-md);background:#f0fdf4;color:#4b7b5b;font-size:12px}.privacy-note strong{color:#166534}.related-link{display:block;margin-top:14px;color:#16a34a;font-size:12px;font-weight:750}.dark .comparison-card, .dark .control-card {border-color:#334155;background:#1e293b}.dark .comparison-heading h3,.dark .card-heading h3{color:#f8fafc}.dark .comparison-heading p,.dark .option-field>span{color: var(--c-text-muted)}.dark .top-actions button,.dark .card-heading>button{border-color:#475569;background:#0f172a;color:#cbd5e1}.dark .image-panel{border-color:#334155;background:#0f172a}.dark .panel-label{border-color:#334155}.dark .panel-label strong,.dark .empty-state strong{color:#e2e8f0}.dark .processing-overlay{background:rgba(15,23,42,.92)}.dark .progress-ring:before,.dark .score-ring:before{background:#1e293b}.dark .comparison-meta span{background:#14532d;color:#bbf7d0}.dark .preset-grid button,.dark .summary-list div{border-color:#334155;background:#0f172a;color: var(--c-text-muted)}.dark .preset-grid button:hover{border-color:#4ade80;background:#0d2e1b}.dark .intensity-card,.dark .privacy-note{background:#0d2e1b}.dark .intensity-card strong,.dark .privacy-note strong,.dark .score-ring strong{color:#86efac}.dark .intensity-card p,.dark .privacy-note{color:#86a991}.dark .summary-list{border-color:#334155;background:#334155}.dark .summary-list strong{color:#e2e8f0}@media(max-width:980px){.workspace-grid{grid-template-columns:1fr}}@media(max-width:680px){.patina-page{gap:14px}.comparison-card,.control-card,.insight-card{border-radius:var(--radius-lg)}.comparison-card,.control-card,.insight-card{padding:15px}.comparison-heading{flex-direction:column}.top-actions{width:100%}.top-actions>*{flex:1}.top-actions button{width:100%}.compare-grid{grid-template-columns:1fr}.image-stage{height:250px}.preset-grid{grid-template-columns:1fr 1fr}.panel-label{align-items:flex-start;flex-direction:column;gap:3px}}</style>
