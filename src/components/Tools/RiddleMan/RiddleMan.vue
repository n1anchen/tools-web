    ...
    <ToolHero summary="一句话，同时看看七种“谜语”写法">
      <template #metrics>
        <div class="hero-metrics">
          <div><span>转换方案</span><strong>{{ encoders.length }}</strong></div>
          <div><span>有效结果</span><strong>{{ filledResults }}</strong></div>
          <div><span>输入字符</span><strong>{{ sourceLength }}</strong></div>
        </div>
      </template>
    </ToolHero>
