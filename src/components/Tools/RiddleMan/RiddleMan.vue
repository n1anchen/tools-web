  ...
  <div class="riddle-page flex flex-col mt-3 flex-1">
    ...
    <section class="riddle-hero">
      ...
      <div class="hero-metrics">
        ...
        <div><strong>{{ filledResults }}</strong><span>有效结果</span></div>
...
<style scoped>
.riddle-page{--accent:#7c3aed;--accent-soft:#f5f3ff;gap:18px}.riddle-hero,.workspace-card,.result-card,.guide-card{border:1px solid #e2e8f0;border-radius:22px;background:#fff;box-shadow:0 14px 38px rgba(15,23,42,.055)}.riddle-hero{display:flex;align-items:center;justify-content:space-between;gap:28px;padding:28px;background:linear-gradient(135deg,#2e1065,#6d28d9 62%,#ec4899);color:#fff}.eyebrow{display:block;color:var(--accent);font-size:12px;font-weight:900;letter-spacing:.12em}.riddle-hero .eyebrow{color:#ddd6fe}.riddle-hero h2{margin:8px 0 10px;font-size:27px;line-height:1.25}.riddle-hero p{max-width:720px;margin:0;color:#f5d0fe;font-size:14px;line-height:1.75}.hero-metrics{display:grid;min-width:330px;grid-template-columns:repeat(3,1fr)}.hero-metrics div{padding:8px 18px;border-left:1px solid rgba(255,255,255,.22);text-align:center}.hero-metrics strong,.hero-metrics span{display:block}.hero-metrics strong{font-size:24px}.hero-metrics span{margin-top:5px;color:#e9d5ff;font-size:12px}.workspace-card,.result-card{padding:22px}.section-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:18px}.section-heading h3{margin:4px 0 5px;color:#0f172a;font-size:19px}.section-heading p{margin:0;color:#64748b;font-size:13px;line-height:1.65}.ghost-button{min-height:36px;padding:0 14px;border:1px solid #d8b4fe;border-radius:10px;background:#fff;color:#7e22ce;font-size:12px;font-weight:800;cursor:pointer}.source-tabs{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:7px;margin-top:17px;padding:7px;border:1px solid #e2e8f0;border-radius:15px;background:#f8fafc}.source-tabs button{min-width:0;padding:10px 8px;border:1px solid transparent;border-radius:10px;background:transparent;color:#64748b;text-align:left;cursor:pointer}.source-tabs strong,.source-tabs span{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.source-tabs strong{font-size:13px}.source-tabs span{margin-top:3px;font-size:12px}.source-tabs button.active{border-color:#c4b5fd;background:#fff;color:#6d28d9;box-shadow:0 4px 12px rgba(124,58,237,.12)}.source-editor{margin-top:11px;overflow:hidden;border:1px solid #dbe3ef;border-radius:15px;background:#fff}.source-editor.error{border-color:#fda4af}.source-editor header,.source-editor footer{display:flex;align-items:center;justify-content:space-between;gap:14px;padding:11px 13px;background:#fafafa}.source-editor header{border-bottom:1px solid #e2e8f0}.source-editor header strong,.source-editor header span{display:block}.source-editor header strong{color:#1e293b;font-size:14px}.source-editor header div span,.source-editor header>span{margin-top:3px;color:#64748b;font-size:12px}.source-editor textarea{display:block;width:100%;min-height:190px;padding:15px;border:0;outline:0;resize:vertical;background:#171026;color:#f5f3ff;font:13px/1.7 ui-monospace,SFMono-Regular,Menlo,monospace}.source-editor textarea:focus{box-shadow:inset 0 0 0 2px #8b5cf6}.source-editor footer{min-height:48px;border-top:1px solid #e2e8f0;color:#64748b;font-size:12px}.source-editor.error footer{color:#be123c;background:#fff1f2}.source-editor footer button{min-height:34px;padding:0 15px;border:0;border-radius:9px;background:var(--accent);color:#fff;font-size:12px;font-weight:850;cursor:pointer}.source-editor footer button:disabled{cursor:not-allowed;opacity:.5}.example-row{display:flex;align-items:center;gap:7px;margin-top:11px;overflow-x:auto}.example-row>span{flex:none;color:#64748b;font-size:12px;font-weight:800}.example-row button{flex:none;padding:7px 10px;border:1px solid #e2e8f0;border-radius:999px;background:#fafafa;color:#475569;font-size:12px;cursor:pointer}.result-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:11px;margin-top:17px}.result-grid article{overflow:hidden;border:1px solid #e2e8f0;border-radius:15px;background:#f8fafc}.result-grid article:last-child{grid-column:1/-1}.result-grid article.source{border-color:#a78bfa;box-shadow:0 0 0 2px #ede9fe}.result-grid article>header,.result-grid article>footer{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:10px 12px}.result-grid article>header strong,.result-grid article>header span{display:block}.result-grid article>header strong{color:#1e293b;font-size:14px}.result-grid article>header span{margin-top:2px;color:#64748b;font-size:12px}.result-grid em{padding:3px 7px;border-radius:999px;background:#ede9fe;color:#6d28d9;font-size:11px;font-style:normal;font-weight:850}.result-grid em.irreversible{background:#fff1f2;color:#be123c}.result-grid textarea,.result-grid input{display:block;width:100%;border:0;border-block:1px solid #e2e8f0;outline:0;background:#fff;color:#334155;font:12px/1.65 ui-monospace,SFMono-Regular,Menlo,monospace}.result-grid textarea{height:112px;padding:11px;resize:none}.result-grid input{height:46px;padding:0 11px}.result-grid article>footer{color:#64748b;font-size:12px}.result-grid footer button{border:0;background:transparent;color:#7c3aed;font-size:12px;font-weight:850;cursor:pointer}.result-grid footer button:disabled{color:#94a3b8;cursor:not-allowed}.guide-card{display:grid;grid-template-columns:minmax(0,1.5fr) minmax(280px,.5fr);overflow:hidden}.guide-main{padding:22px}.scheme-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px;margin-top:16px}.scheme-grid article{position:relative;padding:13px 13px 13px 76px;border:1px solid #e2e8f0;border-radius:13px;background:#f8fafc}.scheme-grid article>span{position:absolute;top:13px;left:12px;width:52px;padding:4px 5px;border-radius:7px;background:#ede9fe;color:#6d28d9;font-size:11px;font-weight:850;text-align:center}.scheme-grid strong{color:#1e293b;font-size:13px}.scheme-grid p{margin:4px 0 0;color:#64748b;font-size:12px;line-height:1.6}.history-panel{padding:20px;border-left:1px solid #e2e8f0;background:#fafafa}.history-panel>header{display:flex;align-items:flex-start;justify-content:space-between;gap:10px}.history-panel header strong{display:block;margin-top:4px;color:#1e293b;font-size:14px}.history-panel header button{border:0;background:transparent;color:#7c3aed;font-size:12px;font-weight:800;cursor:pointer}.history-list{display:grid;gap:7px;margin-top:14px}.history-list button{padding:10px;border:1px solid #e2e8f0;border-radius:10px;background:#fff;text-align:left;cursor:pointer}.history-list span,.history-list strong{display:block}.history-list span{color:#7c3aed;font-size:11px}.history-list strong{overflow:hidden;margin-top:4px;color:#475569;font-size:12px;text-overflow:ellipsis;white-space:nowrap}.history-empty{display:flex;min-height:175px;align-items:center;justify-content:center;flex-direction:column;text-align:center}.history-empty strong{color:#334155;font-size:14px}.history-empty span{max-width:230px;margin-top:6px;color:#94a3b8;font-size:12px;line-height:1.6}.detail-notes{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}.detail-notes p{margin:0;padding:14px;border:1px solid #e2e8f0;border-radius:12px;background:#f8fafc;color:#64748b;font-size:12px;line-height:1.7}.detail-notes strong{color:#334155}
:global(html.dark .riddle-page){--accent:#a78bfa;--accent-soft:#2e1065}:global(html.dark .workspace-card),:global(html.dark .result-card),:global(html.dark .guide-card){border-color:#334155;background:#1e293b;box-shadow:none}:global(html.dark .section-heading h3),:global(html.dark .source-editor header strong),:global(html.dark .result-grid article>header strong),:global(html.dark .scheme-grid strong),:global(html.dark .history-panel header strong),:global(html.dark .history-empty strong),:global(html.dark .detail-notes strong){color:#f1f5f9}:global(html.dark .source-tabs),:global(html.dark .result-grid article),:global(html.dark .scheme-grid article),:global(html.dark .history-panel),:global(html.dark .detail-notes p){border-color:#334155;background:#172033}:global(html.dark .source-tabs button.active),:global(html.dark .history-list button),:global(html.dark .ghost-button),:global(html.dark .example-row button),:global(html.dark .source-editor header),:global(html.dark .source-editor footer){border-color:#475569;background:#0f172a;color:#c4b5fd}:global(html.dark .source-editor){border-color:#475569;background:#0f172a}:global(html.dark .result-grid article.source){border-color:#8b5cf6;box-shadow:0 0 0 2px #4c1d95}:global(html.dark .result-grid textarea),:global(html.dark .result-grid input){border-color:#334155;background:#0f172a;color:#e2e8f0}:global(html.dark .history-panel){border-left-color:#334155}
@media(max-width:1050px){.riddle-hero{align-items:flex-start;flex-direction:column}.hero-metrics{width:100%;min-width:0}.hero-metrics div:first-child{border-left:0}.source-tabs{grid-template-columns:repeat(3,1fr)}.guide-card{grid-template-columns:1fr}.history-panel{border-top:1px solid #e2e8f0;border-left:0}.detail-notes{grid-template-columns:1fr}}
@media(max-width:720px){.riddle-page{gap:12px}.riddle-hero,.workspace-card,.result-card,.guide-card{border-radius:16px}.riddle-hero{padding:20px}.riddle-hero h2{font-size:22px}.workspace-card,.result-card,.guide-main,.history-panel{padding:15px}.section-heading{flex-direction:column}.source-editor header,.source-editor footer{align-items:flex-start;flex-direction:column}.source-editor footer button{width:100%}.result-grid,.scheme-grid{grid-template-columns:1fr}.detail-notes{grid-template-columns:1fr}}
@media(max-width:430px){.source-tabs{grid-template-columns:repeat(2,1fr)}.hero-metrics div{padding-inline:8px}.hero-metrics strong{font-size:20px}.source-tabs span{font-size:11px}}
</style>
