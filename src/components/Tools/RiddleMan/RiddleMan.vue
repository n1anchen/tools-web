...
.source-tabs strong,.source-tabs span {
  display: block;
  overflow: hidden;
...
.source-editor header div span,.source-editor header>span {
  margin-top: 3px;
  color: var(--c-text-secondary);
  font-size:12px
}
...
.result-grid article>header strong,.result-grid article>header span {
  display:block
}
.result-grid article>header strong {
  color: #1e293b;
  font-size:14px
}
.result-grid article>header span {
  margin-top: 2px;
  color: var(--c-text-secondary);
  font-size:12px
}
...
.result-grid em.irreversible {
  background: #fff1f2;
  color:#be123c
}
.result-grid textarea,.result-grid input {
  display: block;
  width: 100%;
  border: 0;
...
.history-list span,.history-list strong {
  display:block
}
.history-list span {
  color: var(--c-primary);
...
:global(html.dark .section-heading h3),:global(html.dark .source-editor header strong),:global(html.dark .result-grid article>header strong),:global(html.dark .scheme-grid strong),:global(html.dark .history-panel header strong),:global(html.dark .history-empty strong),:global(html.dark .detail-notes strong) {
  color:#f1f5f9
}
:global(html.dark .source-tabs),:global(html.dark .result-grid article),:global(html.dark .scheme-grid article),:global(html.dark .history-panel),:global(html.dark .detail-notes p) {
  border-color: var(--c-border);
  background:#172033
}
...
@media(max-width:720px) {
  ...
  .workspace-card,.result-card,.guide-main,.history-panel {
    padding:15px
  }
  .section-heading {
    flex-direction:column
