...
.preset-card strong,.preset-card small {
  display:block
}
.preset-card strong {
  font-size:14px
...
.expression-card {
  display: grid;
  grid-template-columns: minmax(230px,.7fr) minmax(360px,1.3fr) auto;
  align-items: center;
  gap: 22px;
  padding:19px 22px
}
.expression-card .eyebrow,.builder-card .eyebrow,.analysis-card .eyebrow,.schedule-card .eyebrow {
  color:var(--cyan)
}
.expression-card h3,.builder-card h3,.analysis-card h3,.schedule-card h3 {
  margin: 0;
  color: var(--c-text-primary);
  font-size:19px
}
.expression-card p,.schedule-card header p {
  margin: 4px 0 0;
  color: var(--c-text-secondary);
  font-size: 13px;
  line-height:1.55
...
.expression-input button,.builder-card header button {
  display: inline-flex;
  align-items: center;
...
.builder-card,.analysis-card,.schedule-card {
  padding:22px
}
.builder-card>header,.analysis-card>header,.schedule-card>header {
  display: flex;
  align-items: flex-start;
  justify-content: space-between;
  gap:15px
}
.builder-card header button {
  min-height: 36px;
  border-radius: var(--radius-sm);
  background:var(--c-surface)
}
...
.builder-fields label.wide {
  grid-column:1/-1
}
.builder-fields :deep(.el-select),.builder-fields :deep(.el-input-number) {
  width:100%
}
.select-option {
  display: flex;
...
.builder-preview code {
  color: #164e63;
  font:800 16px ui-monospace,SFMono-Regular,Consolas,monospace
}
...
.error-state strong,.error-state p {
  color:#b91c1c
}
.field-map {
  display: grid;
...
.field-map span,.field-map code,.field-map small {
  display:block
}
.field-map span {
  color: var(--c-text-secondary);
...
:global(html.dark .cron-page .preset-card),:global(html.dark .cron-page .expression-card),:global(html.dark .cron-page .builder-card),:global(html.dark .cron-page .analysis-card),:global(html.dark .cron-page .schedule-card) {
  border-color: var(--c-border);
  background: var(--c-surface);
  box-shadow:none
}
:global(html.dark .cron-page h3),:global(html.dark .cron-page .summary-copy strong),:global(html.dark .cron-page .field-map code),:global(html.dark .cron-page .schedule-list strong) {
  color:#f8fafc
}
:global(html.dark .cron-page .preset-card button),:global(html.dark .cron-page .expression-input button),:global(html.dark .cron-page .builder-card header button),:global(html.dark .cron-page .schedule-list>div) {
  border-color: var(--c-border-strong);
  background: var(--c-surface-subtle);
  color: var(--c-text-primary)
}
:global(html.dark .cron-page .summary-copy),:global(html.dark .cron-page .builder-preview) {
  background:#0f2d3a
}
:global(html.dark .cron-page .field-map) {
  border-color: var(--c-border)
}
:global(html.dark .cron-page .field-map div) {
  border-color: var(--c-border)
}
...
@media(max-width:680px) {
  ...
  .field-map div:nth-child(2n) {
    border-right:0
  }
  .field-map div:nth-child(n+3) {
