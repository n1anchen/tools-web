...
<template>
  <div class="cron-page flex flex-col mt-3 flex-1">
    <ToolHero summary="从表达式到执行计划，一次看懂">
      <template #metrics>
...
<style scoped>
.cron-page{--cyan:#0891b2;gap:18px}.expression-card, .builder-card, .analysis-card, .schedule-card {border: 1px solid var(--c-border);border-radius:var(--radius-card);background:var(--c-surface);box-shadow: var(--shadow-card)}.eyebrow{display:block;margin-bottom:6px;color:#67e8f9;font-size:12px;font-weight:900;letter-spacing:.16em}.preset-card{display:flex;align-items:center;gap:8px;padding:12px 15px;overflow-x:auto}.preset-card>span{flex:none;color: var(--c-text-secondary);font-size:13px}.preset-card button{flex:none;padding:9px 13px;border:1px solid #dbe3ef;border-radius:var(--radius-sm);background: var(--c-surface-subtle);color: var(--c-text-strong);text-align:left;cursor:pointer}.preset-card strong,.preset-card small{display:block}.preset-card strong{font-size:14px}.preset-card small{margin-top:2px;color: var(--c-text-muted);font-size:12px}.expression-card{display:grid;grid-template-columns:minmax(230px,.7fr) minmax(360px,1.3fr) auto;align-items:center;gap:22px;padding:19px 22px}.expression-card .eyebrow,.builder-card .eyebrow,.analysis-card .eyebrow,.schedule-card .eyebrow{color:var(--cyan)}.expression-card h3,.builder-card h3,.analysis-card h3,.schedule-card h3{margin:0;color: var(--c-text-primary);font-size:19px}.expression-card p,.schedule-card header p{margin:4px 0 0;color: var(--c-text-secondary);font-size:13px;line-height:1.55}.expression-input{display:grid;grid-template-columns:1fr auto}.expression-input :deep(.el-input__wrapper){border-radius:11px 0 0 11px}.expression-input button,.builder-card header button{display:inline-flex;align-items:center;justify-content:center;gap:5px;min-height:40px;padding:0 14px;border:1px solid #dbe3ef;border-radius:0 11px 11px 0;background: var(--c-surface-subtle);color: var(--c-text-body);font-size:13px;font-weight:800;cursor:pointer}.status-pill,.count-badge{padding:6px 10px;border-radius:var(--radius-full);color:#b45309;background:#fef3c7;font-size:12px;font-weight:850;white-space:nowrap}.status-pill.valid{color:#047857;background:#d1fae5}.workspace-grid{display:grid;grid-template-columns:minmax(0,.9fr) minmax(0,1.1fr);gap:18px}.builder-card,.analysis-card,.schedule-card{padding:22px}.builder-card>header,.analysis-card>header,.schedule-card>header{display:flex;align-items:flex-start;justify-content:space-between;gap:15px}.builder-card header button{min-height:36px;border-radius:var(--radius-sm);background:var(--c-surface)}.analysis-card>header>span{color: var(--c-text-secondary);font-size:12px}.builder-fields{display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-top:19px}.builder-fields label>span{display:block;margin-bottom:7px;color: var(--c-text-secondary);font-size:13px;font-weight:750}.builder-fields label.wide{grid-column:1/-1}.builder-fields :deep(.el-select),.builder-fields :deep(.el-input-number){width:100%}.select-option{display:flex;align-items:center;justify-content:space-between;gap:12px}.select-option small{color: var(--c-text-muted)}.builder-preview{display:grid;grid-template-columns:auto 1fr;align-items:center;gap:8px 13px;margin-top:18px;padding:14px;border-radius:var(--radius-md);background:#ecfeff}.builder-preview span{color:#0e7490;font-size:12px;font-weight:850}.builder-preview code{color:#164e63;font:800 16px ui-monospace,SFMono-Regular,Consolas,monospace}.builder-preview small{grid-column:1/-1;color: var(--c-text-secondary);font-size:12px}.summary-copy,.error-state{min-height:94px;margin-top:19px;padding:16px;border-radius:var(--radius-md);background:linear-gradient(135deg,#ecfeff,#eff6ff)}.summary-copy strong,.error-state strong{color: var(--c-text-primary);font-size:18px;line-height:1.6}.summary-copy p,.error-state p{margin:7px 0 0;color: var(--c-text-secondary);font-size:13px;line-height:1.6}.error-state{background:#fef2f2}.error-state strong,.error-state p{color:#b91c1c}.field-map{display:grid;grid-template-columns:repeat(3,1fr);margin-top:15px;border: 1px solid var(--c-border);border-radius:var(--radius-md);overflow:hidden}.field-map div{min-width:0;padding:11px;border-right: 1px solid var(--c-border)}.field-map div:last-child{border:0}.field-map span,.field-map code,.field-map small{display:block}.field-map span{color: var(--c-text-secondary);font-size:12px}.field-map code{margin-top:4px;overflow:hidden;color: var(--c-text-primary);font:800 16px ui-monospace,monospace;text-overflow:ellipsis}.field-map small{margin-top:4px;color: var(--c-text-muted);font-size:12px;white-space:nowrap}.schedule-card>header{align-items:center}.schedule-list{display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin-top:18px}.schedule-list>div{display:grid;grid-template-columns:auto 1fr;gap:4px 10px;padding:13px;border: 1px solid var(--c-border);border-radius:var(--radius-md);background: var(--c-surface-subtle)}.schedule-list b{grid-row:1/3;align-self:center;color:#0891b2;font:800 13px ui-monospace,monospace}.schedule-list span{color: var(--c-text-secondary);font-size:12px}.schedule-list strong{color: var(--c-text-primary);font-size:16px}.schedule-list small{grid-column:2;color: var(--c-text-muted);font-size:12px}.empty-state{display:grid;min-height:120px;margin-top:16px;place-items:center;border:1px dashed #cbd5e1;border-radius:var(--radius-md);color: var(--c-text-muted);font-size:13px}:global(html.dark .cron-page .preset-card),:global(html.dark .cron-page .expression-card),:global(html.dark .cron-page .builder-card),:global(html.dark .cron-page .analysis-card),:global(html.dark .cron-page .schedule-card){border-color: var(--c-border);background:var(--c-surface);box-shadow:none}:global(html.dark .cron-page h3),:global(html.dark .cron-page .summary-copy strong),:global(html.dark .cron-page .field-map code),:global(html.dark .cron-page .schedule-list strong){color:#f8fafc}:global(html.dark .cron-page .preset-card button),:global(html.dark .cron-page .expression-input button),:global(html.dark .cron-page .builder-card header button),:global(html.dark .cron-page .schedule-list>div){border-color: var(--c-border-strong);background:var(--c-surface-subtle);color: var(--c-text-primary)}:global(html.dark .cron-page .summary-copy),:global(html.dark .cron-page .builder-preview){background:#0f2d3a}:global(html.dark .cron-page .field-map){border-color: var(--c-border)}:global(html.dark .cron-page .field-map div){border-color: var(--c-border)}@media(max-width:1050px){.expression-card{grid-template-columns:1fr}.workspace-grid{grid-template-columns:1fr}.schedule-list{grid-template-columns:repeat(2,1fr)}}@media(max-width:680px){.cron-page{gap:14px}.expression-card,.builder-card,.analysis-card,.schedule-card{padding:15px}.expression-input{grid-template-columns:1fr}.expression-input :deep(.el-input__wrapper){border-radius:var(--radius-sm)}.expression-input button{margin-top:8px;border-radius:var(--radius-sm)}.builder-fields{grid-template-columns:1fr}.builder-fields label.wide{grid-column:auto}.field-map{grid-template-columns:repeat(2,1fr)}.field-map div:nth-child(2n){border-right:0}.field-map div:nth-child(n+3){border-top:1px solid #334155}.schedule-list{grid-template-columns:1fr}.schedule-card>header{align-items:flex-start}}</style>
