...
.unit-page[data-accent="emerald"] {
  --accent: #059669;
  --accent-soft: #ecfdf5;
  --accent-deep:#047857
}
.category-nav,.converter-card,.insight-card,.all-results-card,.history-card {
...
.category-nav span,.category-nav strong,.category-nav small {
  display: block;
  text-align:left
}
.category-nav strong {
...
.card-heading,.results-heading,.history-card>header {
  display: flex;
  align-items: center;
...
.card-heading h3,.results-heading h3,.history-card h3 {
  margin: 0;
  color: var(--c-text-primary);
  font-size:19px
}
.card-heading p,.results-heading p {
  margin: 4px 0 0;
  color: var(--c-text-muted);
  font-size:11px
}
...
.unit-panel :deep(.el-input) {
  margin-bottom:9px
}
.source-panel :deep(.el-input__inner) {
  font-size: 20px;
  font-weight:800
}
.primary-result {
...
.equation-bar button,.history-card header button {
  display: flex;
  align-items: center;
  gap: 4px;
  padding: 5px 7px;
...
.insight-card>.card-heading>.el-icon {
  color: var(--accent);
  font-size:25px
}
.summary-result {
...
.result-grid button:hover,.result-grid button.selected {
...
.result-grid button>div {
  min-width:0
}
.result-grid strong,.result-grid small {
  display: block;
  overflow: hidden;
  text-overflow: ellipsis;
  white-space:nowrap
...
:global(html.dark .unit-page .category-nav),:global(html.dark .unit-page .converter-card),:global(html.dark .unit-page .insight-card),:global(html.dark .unit-page .all-results-card),:global(html.dark .unit-page .history-card) {
  border-color: var(--c-border);
  background-color: var(--c-surface);
  box-shadow:none
}
:global(html.dark .unit-page .category-nav button) {
  color: var(--c-text-muted)
}
:global(html.dark .unit-page .category-nav button>b),:global(html.dark .unit-page .unit-panel),:global(html.dark .unit-page .definition-notes article),:global(html.dark .unit-page .result-grid button),:global(html.dark .unit-page .history-card>div>button) {
  background:var(--c-surface-subtle)
}
:global(html.dark .unit-page .category-nav button.active),:global(html.dark .unit-page .equation-bar),:global(html.dark .unit-page .result-grid button.selected) {
  background:color-mix(in srgb,var(--accent) 18%,#0f172a)
}
:global(html.dark .unit-page .card-heading h3),:global(html.dark .unit-page .results-heading h3),:global(html.dark .unit-page .history-card h3),:global(html.dark .unit-page .summary-grid strong),:global(html.dark .unit-page .result-grid strong),:global(html.dark .unit-page .history-card>div strong) {
  color:#f8fafc
}
:global(html.dark .unit-page .unit-panel),:global(html.dark .unit-page .summary-grid),:global(html.dark .unit-page .summary-grid div),:global(html.dark .unit-page .preset-section button),:global(html.dark .unit-page .result-grid button),:global(html.dark .unit-page .history-card>div>button) {
  border-color: var(--c-border)
}
:global(html.dark .unit-page .preset-section button),:global(html.dark .unit-page .unit-symbol) {
  color: var(--c-text-secondary);
  background:var(--c-surface-subtle)
}
:global(html.dark .unit-page .warning-banner.neutral) {
  background:var(--c-surface-subtle)
}
