...
<style scoped>
.unit-page{--accent:#2563eb;--accent-soft:#eff6ff;--accent-deep:#1d4ed8;gap:16px}.unit-page[data-accent="cyan"]{--accent:#0891b2;--accent-soft:#ecfeff;--accent-deep:#0e7490}.unit-page[data-accent="amber"]{--accent:#d97706;--accent-soft:#fffbeb;--accent-deep:#b45309}.unit-page[data-accent="violet"]{--accent:#7c3aed;--accent-soft:#f5f3ff;--accent-deep:#6d28d9}.unit-page[data-accent="rose"]{--accent:#e11d48;--accent-soft:#fff1f2;--accent-deep:#be123c}.unit-page[data-accent="sky"]{--accent:#0284c7;--accent-soft:#f0f9ff;--accent-deep:#0369a1}.unit-page[data-accent="orange"]{--accent:#ea580c;--accent-soft:#fff7ed;--accent-deep:#c2410c}.unit-page[data-accent="emerald"]{--accent:#059669;--accent-soft:#ecfdf5;--accent-deep:#047857}.category-nav,.converter-card,.insight-card,.all-results-card,.history-card{border: 1px solid var(--c-border);background:var(--c-surface);box-shadow: var(--shadow-card)}.eyebrow{display:block;margin-bottom:6px;color:var(--accent);font-size:10px;font-weight:900;letter-spacing:.16em}.category-nav{display:grid;grid-template-columns:repeat(8,1fr);gap:6px;padding:9px;border-radius:19px;overflow:auto}.category-nav button{display:flex;align-items:center;justify-content:center;gap:7px;min-width:95px;padding:10px 6px;border:1px solid transparent;border-radius:var(--radius-md);color: var(--c-text-secondary);background:transparent;cursor:pointer;transition:.18s}.category-nav button>b{display:grid;place-items:center;width:29px;height:29px;border-radius:var(--radius-sm);color: var(--c-text-secondary);background:#f1f5f9;font-size:14px}.category-nav span,.category-nav strong,.category-nav small{display:block;text-align:left}.category-nav strong{font-size:12px}.category-nav small{margin-top:1px;color: var(--c-text-muted);font-size:8px}.category-nav button.active{border-color:color-mix(in srgb,var(--accent) 28%,white);color:var(--accent-deep);background:var(--accent-soft)}.category-nav button.active>b{color: var(--c-on-accent);background:var(--accent)}.workspace-grid{display:grid;grid-template-columns:minmax(0,1.55fr) minmax(330px,.75fr);gap:16px;align-items:start}.converter-card,.insight-card,.all-results-card,.history-card{padding:22px;border-radius:var(--radius-card)}.insight-card{position:sticky;top:82px}.card-heading,.results-heading,.history-card>header{display:flex;align-items:center;justify-content:space-between;gap:12px}.card-heading{margin-bottom:19px}.card-heading h3,.results-heading h3,.history-card h3{margin:0;color: var(--c-text-primary);font-size:19px}.card-heading p,.results-heading p{margin:4px 0 0;color: var(--c-text-muted);font-size:11px}.live-badge{padding:5px 9px;border-radius:var(--radius-full);color:#047857;background:#d1fae5;font-size:9px;font-weight:900;letter-spacing:.12em}.conversion-board{display:grid;grid-template-columns:minmax(0,1fr) 48px minmax(0,1fr);align-items:center;gap:10px}.unit-panel{min-width:0;padding:16px;border: 1px solid var(--c-border);border-radius:var(--radius-lg);background: var(--c-surface-subtle)}.unit-panel>label{display:block;margin-bottom:8px;color: var(--c-text-secondary);font-size:11px;font-weight:700}.unit-panel :deep(.el-input){margin-bottom:9px}.source-panel :deep(.el-input__inner){font-size:20px;font-weight:800}.primary-result{display:flex;align-items:baseline;gap:7px;min-height:40px;margin-bottom:9px;padding:5px 3px;color:var(--accent-deep);overflow:hidden}.primary-result strong{overflow:hidden;font-size:clamp(22px,3vw,31px);line-height:1.15;text-overflow:ellipsis}.primary-result span{color:var(--accent);font-size:14px;font-weight:800}.primary-result.invalid{color: var(--c-text-muted)}.inline-clear{border:0;color: var(--c-text-muted);background:none;cursor:pointer;font-size:10px}.swap-button{display:grid;place-items:center;width:42px;height:42px;border:0;border-radius:50%;color: var(--c-on-accent);background:var(--accent);box-shadow:0 8px 18px color-mix(in srgb,var(--accent) 28%,transparent);cursor:pointer;font-size:18px}.warning-banner{margin-top:12px;padding:10px 12px;border-radius:var(--radius-sm);color:#be123c;background:#fff1f2;font-size:11px}.warning-banner.neutral{color: var(--c-text-secondary);background:#f1f5f9}.equation-bar{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-top:14px;padding:11px 13px;border-radius:var(--radius-md);background:var(--accent-soft)}.equation-bar>span{color:var(--accent-deep);font-family:ui-monospace,SFMono-Regular,monospace;font-size:11px;font-weight:800}.equation-bar>div{display:flex;gap:5px}.equation-bar button,.history-card header button{display:flex;align-items:center;gap:4px;padding:5px 7px;border:0;color: var(--c-text-secondary);background:transparent;cursor:pointer;font-size:10px}.preset-section{display:grid;grid-template-columns:auto 1fr;align-items:center;gap:12px;margin-top:17px}.preset-section>span{color: var(--c-text-secondary);font-size:11px;font-weight:700}.preset-section>div{display:flex;flex-wrap:wrap;gap:6px}.preset-section button{padding:6px 9px;border: 1px solid var(--c-border);border-radius:var(--radius-full);color: var(--c-text-secondary);background:var(--c-surface);cursor:pointer;font-size:10px}.preset-section button:hover{border-color:var(--accent);color:var(--accent)}.insight-card>.card-heading>.el-icon{color:var(--accent);font-size:25px}.summary-result{display:grid;gap:5px;padding:17px;border-radius:var(--radius-lg);color: var(--c-on-accent);background:linear-gradient(135deg,var(--accent-deep),var(--accent))}.summary-result span{color:rgba(255,255,255,.76);font-size:11px}.summary-result b{opacity:.5;font-size:12px}.summary-result strong{overflow:hidden;font-size:24px;text-overflow:ellipsis}.summary-result small{font-size:12px}.summary-grid{display:grid;grid-template-columns:1fr 1fr;margin:14px 0;border: 1px solid var(--c-border);border-radius:var(--radius-md);overflow:hidden}.summary-grid div{min-width:0;padding:10px;border-right: 1px solid var(--c-border);border-bottom: 1px solid var(--c-border)}.summary-grid div:nth-child(2n){border-right:0}.summary-grid div:nth-last-child(-n+2){border-bottom:0}.summary-grid span,.summary-grid strong{display:block}.summary-grid span{color: var(--c-text-muted);font-size:9px}.summary-grid strong{margin-top:4px;overflow:hidden;color: var(--c-text-strong);font-size:11px;text-overflow:ellipsis;white-space:nowrap}.precision-setting label{display:flex;justify-content:space-between;margin-bottom:8px;color: var(--c-text-secondary);font-size:10px}.precision-setting label strong{color:var(--accent)}.precision-setting :deep(.el-segmented){width:100%}.definition-notes{display:grid;gap:8px;margin-top:14px}.definition-notes article{display:flex;gap:9px;padding:9px;border-left:2px solid var(--accent);background: var(--c-surface-subtle)}.definition-notes b{color:var(--accent);font-size:9px}.definition-notes p{margin:0;color: var(--c-text-secondary);font-size:10px;line-height:1.5}.results-heading{margin-bottom:18px}.result-tools{display:flex;gap:8px}.result-tools :deep(.el-input){width:220px}.result-groups{display:grid;gap:19px}.result-group h4{display:flex;align-items:center;gap:7px;margin:0 0 8px;color: var(--c-text-body);font-size:12px}.result-group h4 span{padding:2px 6px;border-radius:var(--radius-full);color:var(--accent);background:var(--accent-soft);font-size:8px}.result-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px}.result-grid button{display:grid;grid-template-columns:40px minmax(0,1fr) auto;align-items:center;gap:9px;min-width:0;padding:10px;border: 1px solid var(--c-border);border-radius:var(--radius-md);color: var(--c-text-secondary);background: var(--c-surface-subtle);text-align:left;cursor:pointer;transition:.16s}.result-grid button:hover,.result-grid button.selected{border-color:color-mix(in srgb,var(--accent) 55%,white);background:var(--accent-soft);transform:translateY(-1px)}.unit-symbol{display:grid;place-items:center;width:40px;height:34px;border-radius:var(--radius-sm);color:var(--accent-deep);background:var(--c-surface);font-size:11px;font-weight:900}.result-grid button>div{min-width:0}.result-grid strong,.result-grid small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.result-grid strong{color: var(--c-text-strong);font-size:12px}.result-grid small{margin-top:3px;color: var(--c-text-muted);font-size:9px}.result-grid .el-icon{color:#cbd5e1}.empty-results{padding:46px;color: var(--c-text-muted);text-align:center}.history-card>header{margin-bottom:12px}.history-card>div{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.history-card>div>button{display:flex;align-items:center;gap:9px;min-width:0;padding:10px;border: 1px solid var(--c-border);border-radius:var(--radius-sm);color: var(--c-text-secondary);background: var(--c-surface-subtle);text-align:left;cursor:pointer}.history-card>div span{padding:3px 6px;border-radius:6px;color:var(--accent);background:var(--accent-soft);font-size:9px}.history-card>div strong{overflow:hidden;color: var(--c-text-strong);font-size:10px;text-overflow:ellipsis;white-space:nowrap}:global(html.dark .unit-page .category-nav),:global(html.dark .unit-page .converter-card),:global(html.dark .unit-page .insight-card),:global(html.dark .unit-page .all-results-card),:global(html.dark .unit-page .history-card){border-color: var(--c-border);background-color:var(--c-surface);box-shadow:none}:global(html.dark .unit-page .category-nav button){color: var(--c-text-muted)}:global(html.dark .unit-page .category-nav button>b),:global(html.dark .unit-page .unit-panel),:global(html.dark .unit-page .definition-notes article),:global(html.dark .unit-page .result-grid button),:global(html.dark .unit-page .history-card>div>button){background:var(--c-surface-subtle)}:global(html.dark .unit-page .category-nav button.active),:global(html.dark .unit-page .equation-bar),:global(html.dark .unit-page .result-grid button.selected){background:color-mix(in srgb,var(--accent) 18%,#0f172a)}:global(html.dark .unit-page .card-heading h3),:global(html.dark .unit-page .results-heading h3),:global(html.dark .unit-page .history-card h3),:global(html.dark .unit-page .summary-grid strong),:global(html.dark .unit-page .result-grid strong),:global(html.dark .unit-page .history-card>div strong){color:#f8fafc}:global(html.dark .unit-page .unit-panel),:global(html.dark .unit-page .summary-grid),:global(html.dark .unit-page .summary-grid div),:global(html.dark .unit-page .preset-section button),:global(html.dark .unit-page .result-grid button),:global(html.dark .unit-page .history-card>div>button){border-color: var(--c-border)}:global(html.dark .unit-page .preset-section button),:global(html.dark .unit-page .unit-symbol){color: var(--c-text-secondary);background:var(--c-surface-subtle)}:global(html.dark .unit-page .warning-banner.neutral){background:var(--c-surface-subtle)}@media(max-width:1120px){.workspace-grid{grid-template-columns:1fr}.insight-card{position:static}.result-grid{grid-template-columns:repeat(3,minmax(0,1fr))}.category-nav{justify-content:start;grid-template-columns:repeat(8,minmax(100px,1fr))}}@media(max-width:720px){.unit-page{gap:12px}.category-nav{display:flex;padding:7px}.category-nav button{flex:0 0 98px}.converter-card,.insight-card,.all-results-card,.history-card{padding:15px;border-radius:19px}.conversion-board{grid-template-columns:1fr}.swap-button{margin:-2px auto;transform:rotate(90deg)}.equation-bar{align-items:flex-start;flex-direction:column}.equation-bar>div{width:100%;justify-content:flex-end}.preset-section{grid-template-columns:1fr}.results-heading{align-items:flex-start;flex-direction:column}.result-tools{width:100%}.result-tools :deep(.el-input){width:100%}.result-grid{grid-template-columns:1fr 1fr}.history-card>div{grid-template-columns:1fr}.card-heading{align-items:flex-start}.summary-result strong{font-size:21px}}@media(max-width:430px){.result-grid{grid-template-columns:1fr}.result-tools{flex-direction:column}.result-tools :deep(.el-button){width:100%;margin-left:0}}</style>
