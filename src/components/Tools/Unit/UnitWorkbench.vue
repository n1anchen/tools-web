    ...
    <ToolHero summary="一次输入，读懂整组单位关系">
      <template #metrics>
        <div class="hero-metrics">
          <div><span>换算分类</span><strong>8</strong></div>
          <div><span>单位定义</span><strong>100+</strong></div>
          <div><span>网络请求</span><strong>0</strong></div>
        </div>
      </template>
    </ToolHero>
