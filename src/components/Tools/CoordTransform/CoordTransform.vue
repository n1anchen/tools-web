...
<template>
  <div class="coord-tool flex flex-col mt-3 flex-1">
    ...
    <section class="hero-card">
      <div>
        <div class="eyebrow">COORDINATE TRANSFORM LAB</div>
        <h2>单点定位与批量互转，一个入口完成</h2>
        <p>在五种常用坐标系之间同步换算；单点模式可以地图选点，批量模式适合表格数据和接口清单。</p>
      </div>
