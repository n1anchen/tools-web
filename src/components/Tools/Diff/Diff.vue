    ...
    <ToolHero summary="不只标红，还要看清改了多少">
      <template #metrics>
        <div class="hero-metrics">
          <div><span>行相似度</span><strong>{{ summary.similarity }}%</strong></div>
          <div><span>增删行数</span><strong>{{ changedLines }}</strong></div>
          <div><span>变更区块</span><strong>{{ summary.changedBlocks }}</strong></div>
        </div>
      </template>
    </ToolHero>
