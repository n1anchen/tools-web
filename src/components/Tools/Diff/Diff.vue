...
<style scoped>
.diff-page{--blue:#2563eb;gap:18px}.hero-card,.command-card,.rule-card,.text-card,.result-card{border:1px solid #e2e8f0;border-radius:22px;background:#fff;box-shadow:0 14px 38px rgba(15,23,42,.06)}.hero-card{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:28px;padding:30px;color:#fff;border:0;background:radial-gradient(circle at 86% 12%,rgba(96,165,250,.34),transparent 28%),linear-gradient(135deg,#172554,#1d4ed8 58%,#0f766e)}.eyebrow{display:block;margin-bottom:7px;color:#93c5fd;font-size:12px;font-weight:900;letter-spacing:.16em}.hero-card h2{margin:0;font-size:clamp(25px,3vw,36px);line-height:1.2}.hero-card p{max-width:720px;margin:11px 0 0;color:#dbeafe;font-size:14px;line-height:1.75}.hero-stats{display:grid;grid-template-columns:repeat(3,96px)}.hero-stats div{padding:8px;text-align:center;border-left:1px solid rgba(255,255,255,.2)}.hero-stats strong,.hero-stats span{display:block}.hero-stats strong{font-size:23px}.hero-stats span{margin-top:5px;color:#bfdbfe;font-size:12px}.command-card{display:flex;align-items:center;justify-content:space-between;gap:15px;padding:13px 16px}.sample-list,.command-actions{display:flex;align-items:center;gap:8px}.sample-list>span{flex:none;color:#64748b;font-size:13px}.sample-list button{display:flex;flex-direction:column;gap:2px;padding:9px 13px;border:1px solid #dbe3ef;border-radius:11px;background:#f8fafc;color:#334155;text-align:left;cursor:pointer}.sample-list strong{font-size:14px}.sample-list small{color:#94a3b8;font-size:12px}.command-actions button,.text-card header button,.result-actions button{display:inline-flex;align-items:center;justify-content:center;gap:5px;min-height:36px;padding:0 11px;border:1px solid #dbe3ef;border-radius:9px;background:#fff;color:#475569;font-size:13px;font-weight:750;cursor:pointer}.command-actions button.danger{color:#dc2626}.command-actions button:disabled,.text-card header button:disabled,.result-actions button:disabled{cursor:not-allowed;opacity:.45}.rule-card{display:grid;grid-template-columns:auto 1fr auto;align-items:center;gap:24px;padding:17px 20px}.rule-card h3{margin:0;color:#0f172a;font-size:18px}.rule-card .eyebrow{margin-bottom:3px;color:var(--blue)}.rule-options{display:flex;align-items:center;justify-content:center;gap:6px 20px}.rule-card>label{display:flex;align-items:center;gap:9px;color:#64748b;font-size:13px}.input-grid{display:grid;grid-template-columns:1fr 1fr;gap:18px}.text-card{min-width:0;padding:20px}.text-card.original{border-top:3px solid #f97316}.text-card.revised{border-top:3px solid #10b981}.text-card header{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:14px}.text-card header>div:first-child>span{color:#64748b;font-size:12px;font-weight:900;letter-spacing:.14em}.text-card h3{display:inline;margin:0 8px 0 0;color:#0f172a;font-size:19px}.text-card header small{color:#94a3b8;font-size:12px}.text-card header>div:last-child{display:flex;gap:7px}.text-card :deep(.el-textarea__inner){min-height:320px!important;padding:14px;border-radius:13px;font:14px/1.7 ui-monospace,SFMono-Regular,Consolas,monospace}.result-card{padding:22px}.result-heading{display:flex;align-items:center;justify-content:space-between;gap:18px}.result-heading .eyebrow{color:var(--blue)}.result-heading h3{display:inline;margin:0 8px 0 0;color:#0f172a;font-size:21px}.result-heading p{display:inline;margin:0;color:#94a3b8;font-size:13px}.result-actions{display:flex;align-items:center;gap:8px}.summary-strip{display:grid;grid-template-columns:repeat(4,1fr);margin:18px 0;border:1px solid #e2e8f0;border-radius:14px;overflow:hidden}.summary-strip div{padding:13px 15px;border-right:1px solid #e2e8f0}.summary-strip div:last-child{border:0}.summary-strip span,.summary-strip strong{display:block}.summary-strip span{color:#94a3b8;font-size:12px}.summary-strip strong{margin-top:3px;color:#334155;font-size:18px}.summary-strip .added strong{color:#059669}.summary-strip .removed strong{color:#dc2626}.empty-state{display:grid;min-height:210px;place-items:center;border:1px dashed #cbd5e1;border-radius:14px;color:#94a3b8}.unified-view,.side-view,.line-view{max-height:620px;overflow:auto;border:1px solid #dbe3ef;border-radius:14px;background:#f8fafc}.unified-view{padding:18px;color:#334155;font:14px/1.75 ui-monospace,SFMono-Regular,Consolas,monospace;white-space:pre-wrap;overflow-wrap:anywhere}.unified-view .removed,.line-row.removed{color:#b91c1c;background:#fee2e2;text-decoration:line-through}.unified-view .added,.line-row.added{color:#047857;background:#d1fae5;font-weight:700}.side-header{position:sticky;top:0;z-index:2;display:grid;grid-template-columns:1fr 1fr;background:#e2e8f0}.side-header span{padding:10px 45px;color:#475569;font-size:12px;font-weight:800}.diff-row{display:grid;grid-template-columns:1fr 1fr}.diff-row>div{display:grid;grid-template-columns:40px minmax(0,1fr);min-width:0;border-top:1px solid #e2e8f0}.diff-row>div:first-child{border-right:1px solid #cbd5e1}.diff-row b,.line-row b{padding:8px;color:#94a3b8;background:#f1f5f9;font:12px ui-monospace,monospace;text-align:right}.diff-row code,.line-row code{padding:8px 10px;color:#334155;font:13px/1.55 ui-monospace,SFMono-Regular,Consolas,monospace;white-space:pre-wrap;overflow-wrap:anywhere}.diff-row.changed>div:first-child,.diff-row.removed>div:first-child{background:#fff1f2}.diff-row.changed>div:last-child,.diff-row.added>div:last-child{background:#ecfdf5}.diff-row .empty{background:#f1f5f9!important}.line-row{display:grid;grid-template-columns:42px 28px minmax(0,1fr);border-top:1px solid #e2e8f0}.line-row>span{display:grid;place-items:center;font-weight:900}.line-row.same>span{background:#f8fafc}.detail-copy{color:#64748b;font-size:14px;line-height:1.9}
:global(html.dark .diff-page .command-card),:global(html.dark .diff-page .rule-card),:global(html.dark .diff-page .text-card),:global(html.dark .diff-page .result-card){border-color:#334155;background:#1e293b;box-shadow:none}:global(html.dark .diff-page h3){color:#f8fafc}:global(html.dark .diff-page .sample-list button),:global(html.dark .diff-page .command-actions button),:global(html.dark .diff-page .text-card header button),:global(html.dark .diff-page .result-actions button){border-color:#475569;background:#0f172a;color:#e2e8f0}:global(html.dark .diff-page .unified-view),:global(html.dark .diff-page .side-view),:global(html.dark .diff-page .line-view){border-color:#475569;background:#0f172a}:global(html.dark .diff-page .summary-strip){border-color:#334155}:global(html.dark .diff-page .summary-strip div),:global(html.dark .diff-page .diff-row>div),:global(html.dark .diff-page .line-row){border-color:#334155}:global(html.dark .diff-page .summary-strip strong),:global(html.dark .diff-page .unified-view),:global(html.dark .diff-page .diff-row code),:global(html.dark .diff-page .line-row code){color:#e2e8f0}:global(html.dark .diff-page .side-header){background:#334155}:global(html.dark .diff-page .side-header span){color:#e2e8f0}:global(html.dark .diff-page .diff-row b),:global(html.dark .diff-page .line-row b),:global(html.dark .diff-page .diff-row .empty){background:#1e293b}:global(html.dark .diff-page .diff-row.changed>div:first-child),:global(html.dark .diff-page .diff-row.removed>div:first-child){background:#3f1d2e}:global(html.dark .diff-page .diff-row.changed>div:last-child),:global(html.dark .diff-page .diff-row.added>div:last-child){background:#12372a}:global(html.dark .diff-page .line-row.removed){background:#3f1d2e;color:#fecdd3}:global(html.dark .diff-page .line-row.added){background:#12372a;color:#a7f3d0}
@media(max-width:980px){.rule-card{grid-template-columns:1fr}.rule-options{justify-content:flex-start}.input-grid{grid-template-columns:1fr}.result-heading{align-items:flex-start;flex-direction:column}.result-actions{width:100%;flex-wrap:wrap}}@media(max-width:680px){.diff-page{gap:14px}.hero-card{grid-template-columns:1fr;padding:22px 18px}.hero-stats{grid-template-columns:repeat(3,1fr)}.hero-stats div:first-child{border-left:0}.command-card{align-items:stretch;flex-direction:column}.sample-list{overflow-x:auto}.command-actions{display:grid;grid-template-columns:1fr 1fr}.rule-card,.text-card,.result-card{padding:15px}.rule-options{align-items:flex-start;flex-direction:column}.rule-card>label{align-items:flex-start;flex-direction:column}.text-card header{align-items:flex-start;flex-direction:column}.text-card header>div:last-child{width:100%}.text-card header button{flex:1}.text-card :deep(.el-textarea__inner){min-height:260px!important}.result-actions{display:grid;grid-template-columns:1fr 1fr}.result-actions :deep(.el-segmented){grid-column:1/-1;width:100%}.summary-strip{grid-template-columns:1fr 1fr}.summary-strip div:nth-child(2){border-right:0}.summary-strip div:nth-child(-n+2){border-bottom:1px solid #e2e8f0}.side-view{overflow-x:auto}.side-header,.diff-row{min-width:720px}.result-heading p{display:block;margin-top:4px}.hero-card h2{font-size:25px}}
</style>
