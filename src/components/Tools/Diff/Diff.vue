...
function downloadDiff() {
  ...
  downloadText(unifiedText.value, `${sanitizeDocumentName('文本差异', 'comparison')}.diff`)
...
.text-card header>div:first-child>span {
  color: var(--c-text-secondary);
  font-size: 12px;
  font-weight: 900;
  letter-spacing:.14em
...
.summary-strip span,.summary-strip strong {
  display:block
}
.summary-strip span {
  color: var(--c-text-muted);
...
.summary-strip .added strong {
  color:#059669
}
.summary-strip .removed strong {
  color:#dc2626
}
.empty-state {
  display: grid;
...
.unified-view,.side-view,.line-view {
  max-height: 620px;
  overflow: auto;
  border: 1px solid #dbe3ef;
  border-radius: var(--radius-md);
...
.unified-view .removed,.line-row.removed {
  color: #b91c1c;
  background: #fee2e2;
  text-decoration:line-through
}
.unified-view .added,.line-row.added {
  color: #047857;
  background: #d1fae5;
  font-weight:700
}
...
.diff-row.changed>div:first-child,.diff-row.removed>div:first-child {
  background:#fff1f2
}
.diff-row.changed>div:last-child,.diff-row.added>div:last-child {
  background:#ecfdf5
}
.diff-row .empty {
...
:global(html.dark .diff-page .command-card),:global(html.dark .diff-page .rule-card),:global(html.dark .diff-page .text-card),:global(html.dark .diff-page .result-card) {
...
:global(html.dark .diff-page .unified-view),:global(html.dark .diff-page .side-view),:global(html.dark .diff-page .line-view) {
  border-color: var(--c-border-strong);
  background:var(--c-surface-subtle)
}
:global(html.dark .diff-page .summary-strip) {
  border-color: var(--c-border)
}
:global(html.dark .diff-page .summary-strip div),:global(html.dark .diff-page .diff-row>div),:global(html.dark .diff-page .line-row) {
  border-color: var(--c-border)
}
:global(html.dark .diff-page .summary-strip strong),:global(html.dark .diff-page .unified-view),:global(html.dark .diff-page .diff-row code),:global(html.dark .diff-page .line-row code) {
  color: var(--c-text-primary)
}
:global(html.dark .diff-page .side-header) {
  background:#334155
}
:global(html.dark .diff-page .side-header span) {
  color: var(--c-text-primary)
}
:global(html.dark .diff-page .diff-row b),:global(html.dark .diff-page .line-row b),:global(html.dark .diff-page .diff-row .empty) {
  background:var(--c-surface)
}
:global(html.dark .diff-page .diff-row.changed>div:first-child),:global(html.dark .diff-page .diff-row.removed>div:first-child) {
  background:#3f1d2e
}
:global(html.dark .diff-page .diff-row.changed>div:last-child),:global(html.dark .diff-page .diff-row.added>div:last-child) {
  background:#12372a
}
:global(html.dark .diff-page .line-row.removed) {
  background: #3f1d2e;
  color:#fecdd3
}
:global(html.dark .diff-page .line-row.added) {
  background: #12372a;
  color:#a7f3d0
}
