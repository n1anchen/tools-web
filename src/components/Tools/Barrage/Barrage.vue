...
<style scoped>
.barrage-page{--accent:#f43f5e;--accent-deep:#e11d48;--soft:#fff1f2;gap:16px}.preview-card,.control-card,.appearance-card{border: 1px solid var(--c-border);border-radius:var(--radius-card);background:var(--c-surface);box-shadow: var(--shadow-card)}.eyebrow{display:block;margin-bottom:6px;color:var(--accent);font-size:10px;font-weight:900;letter-spacing:.16em}.hero-fullscreen-btn{display:flex;align-items:center;gap:10px;min-width:176px;padding:13px 15px;border: 1px solid var(--c-border);border-radius:var(--radius-md);color:#be123c;background:var(--c-surface);cursor:pointer;box-shadow:0 10px 25px rgba(15,23,42,.16)}.hero-fullscreen-btn:disabled{opacity:.5;cursor:not-allowed}.hero-fullscreen-btn>.el-icon{font-size:22px}.hero-fullscreen-btn span,.hero-fullscreen-btn strong,.hero-fullscreen-btn small{display:block;text-align:left}.hero-fullscreen-btn strong{font-size:12px}.hero-fullscreen-btn small{margin-top:2px;color: var(--c-text-muted);font-size:9px}.preview-card{padding:21px}.preview-heading,.card-heading{display:flex;align-items:center;justify-content:space-between;gap:12px}.preview-heading{margin-bottom:13px}.preview-heading h3,.card-heading h3{margin:0;color: var(--c-text-primary);font-size:19px}.preview-meta{display:flex;flex-wrap:wrap;justify-content:flex-end;gap:5px}.preview-meta span,.message-count{padding:5px 8px;border-radius:var(--radius-full);color: var(--c-text-secondary);background:#f1f5f9;font-size:9px}.preview-stage{position:relative;display:flex;align-items:center;height:230px;border-radius:17px;overflow:hidden;isolation:isolate}.preview-stage::after,.fullscreen-canvas::after{position:absolute;inset:0;z-index:-1;background:repeating-linear-gradient(0deg,rgba(255,255,255,.025) 0 1px,transparent 1px 4px);content:"";pointer-events:none}.safe-area{position:absolute;inset:16px;border:1px dashed rgba(255,255,255,.2);border-radius:var(--radius-sm);pointer-events:none}.safe-area span{position:absolute;right:7px;bottom:5px;color:rgba(255,255,255,.36);font-size:8px}.display-track{position:relative;z-index:1;width:max-content;max-width:none;font-weight:900;line-height:1;letter-spacing:.04em;white-space:nowrap;text-shadow:0 .04em .16em rgba(0,0,0,.28);will-change:transform}.display-track.scroll{animation:ticker var(--duration) linear infinite}.display-track.scroll.right{animation-direction:reverse}.display-track.static,.display-track.pulse{width:100%;padding:0 6%;text-align:center;white-space:normal}.display-track.pulse{animation:pulse-display 1.25s ease-in-out infinite}.empty-stage{width:100%;color:rgba(255,255,255,.55);text-align:center}.workspace-grid{display:grid;grid-template-columns:minmax(0,1.12fr) minmax(330px,.78fr);gap:16px;align-items:start}.control-card,.appearance-card{padding:21px}.card-heading{margin-bottom:18px}.field-label,.slider-setting label{display:flex;align-items:center;justify-content:space-between;margin-bottom:7px;color: var(--c-text-secondary);font-size:11px}.field-label b,.slider-setting strong{color:var(--accent-deep)}.preset-section{margin-top:15px}.preset-section>span{display:block;margin-bottom:7px;color: var(--c-text-secondary);font-size:10px}.preset-section>div{display:grid;grid-template-columns:repeat(4,1fr);gap:6px}.preset-section button{padding:9px;border: 1px solid var(--c-border);border-radius:var(--radius-sm);color: var(--c-text-secondary);background: var(--c-surface-subtle);text-align:left;cursor:pointer}.preset-section button strong,.preset-section button small{display:block}.preset-section button strong{color: var(--c-text-strong);font-size:10px}.preset-section button small{margin-top:3px;color: var(--c-text-muted);font-size:8px}.mode-grid{display:grid;grid-template-columns:1.2fr 1fr;gap:12px;margin-top:17px}.mode-grid label>span{display:block;margin-bottom:7px;color: var(--c-text-secondary);font-size:10px}.mode-grid :deep(.el-segmented){width:100%}.slider-setting{margin-top:14px}.slider-setting.disabled{opacity:.45}.slider-setting :deep(.el-slider){padding:0 8px}.contrast-badge{padding:5px 8px;border-radius:var(--radius-full);font-size:9px;font-weight:900}.contrast-badge.excellent,.contrast-badge.good{color:#047857;background:#d1fae5}.contrast-badge.low{color:#be123c;background:#ffe4e6}.color-fields{display:grid;grid-template-columns:1fr 1fr;gap:9px}.color-fields label{padding:10px;border: 1px solid var(--c-border);border-radius:var(--radius-md)}.color-fields label>span{display:block;margin-bottom:7px;color: var(--c-text-muted);font-size:9px}.color-fields label>div{display:flex;align-items:center;gap:8px}.color-fields code{color: var(--c-text-body);font-size:10px}.color-presets{display:grid;grid-template-columns:repeat(4,1fr);gap:6px;margin-top:9px}.color-presets button{display:flex;align-items:center;gap:5px;padding:6px;border: 1px solid var(--c-border);border-radius:var(--radius-sm);color: var(--c-text-secondary);background:var(--c-surface);cursor:pointer;font-size:8px}.color-presets i{width:17px;height:17px;border:1px solid #cbd5e1;border-radius:50%}.contrast-card{margin-top:12px;padding:11px 12px;border-left:3px solid #10b981;border-radius:var(--radius-sm);background:#ecfdf5}.contrast-card.low{border-color:#f43f5e;background:#fff1f2}.contrast-card strong{color:#047857;font-size:11px}.contrast-card.low strong{color:#be123c}.contrast-card p{margin:3px 0 0;color: var(--c-text-secondary);font-size:9px;line-height:1.5}.option-field{display:grid;grid-template-columns:86px 1fr;align-items:center;gap:8px;margin-top:13px}.option-field>span{color: var(--c-text-secondary);font-size:10px}.option-field :deep(.el-radio-group),.option-field :deep(.el-input){width:100%}.summary-grid{display:grid;grid-template-columns:1fr 1fr;margin-top:14px;border: 1px solid var(--c-border);border-radius:var(--radius-md);overflow:hidden}.summary-grid div{padding:10px;border-right: 1px solid var(--c-border);border-bottom: 1px solid var(--c-border)}.summary-grid div:nth-child(2n){border-right:0}.summary-grid div:nth-last-child(-n+2){border-bottom:0}.summary-grid span,.summary-grid strong{display:block}.summary-grid span{color: var(--c-text-muted);font-size:8px}.summary-grid strong{margin-top:3px;color: var(--c-text-strong);font-size:10px}.fullscreen-overlay{position:fixed;inset:0;z-index:99999;overflow:hidden}.fullscreen-canvas{position:absolute;top:0;left:0;display:flex;align-items:center;width:100vw;height:100vh;overflow:hidden}.fullscreen-canvas.portrait{width:100vh;height:100vw;transform:rotate(90deg) translateY(-100%);transform-origin:top left}.fullscreen-track{font-weight:950}.exit-button{position:absolute;top:18px;right:18px;z-index:5;display:flex;align-items:center;gap:5px;padding:9px 12px;border:1px solid rgba(255,255,255,.28);border-radius:var(--radius-full);color: var(--c-on-accent);background:rgba(15,23,42,.58);cursor:pointer;backdrop-filter:blur(8px)}.exit-hint{position:absolute;right:20px;bottom:17px;color:rgba(255,255,255,.35);font-size:10px}@keyframes ticker{from{transform:translateX(100vw)}to{transform:translateX(-100%)}}@keyframes pulse-display{0%,100%{opacity:.72;transform:scale(.96)}50%{opacity:1;transform:scale(1.04)}}
:global(html.dark .barrage-page .hero-fullscreen-btn){border-color:#40516a;background:rgba(15,23,42,.55);color:#fecdd3}:global(html.dark .barrage-page .preview-card),:global(html.dark .barrage-page .control-card),:global(html.dark .barrage-page .appearance-card){border-color: var(--c-border);background:var(--c-surface);box-shadow:none}:global(html.dark .barrage-page .preview-heading h3),:global(html.dark .barrage-page .card-heading h3),:global(html.dark .barrage-page .preset-section button strong),:global(html.dark .barrage-page .summary-grid strong){color:#f8fafc}:global(html.dark .barrage-page .preview-meta span),:global(html.dark .barrage-page .message-count),:global(html.dark .barrage-page .preset-section button),:global(html.dark .barrage-page .color-presets button){border-color: var(--c-border);color: var(--c-text-secondary);background:var(--c-surface-subtle)}:global(html.dark .barrage-page .color-fields label),:global(html.dark .barrage-page .summary-grid),:global(html.dark .barrage-page .summary-grid div){border-color: var(--c-border)}:global(html.dark .barrage-page .color-fields code){color: var(--c-text-secondary)}:global(html.dark .barrage-page .contrast-card){background:#064e3b}:global(html.dark .barrage-page .contrast-card.low){background:#4c0519}:global(html.dark .barrage-page .contrast-card p){color: var(--c-text-secondary)}
@media(max-width:1000px){.workspace-grid{grid-template-columns:1fr}.preview-stage{height:210px}}@media(max-width:700px){.barrage-page{gap:12px}.hero-fullscreen-btn{width:100%;justify-content:center}:deep(.hero-actions){flex-wrap:wrap}.preview-card,.control-card,.appearance-card{padding:15px}.preview-heading{align-items:flex-start;flex-direction:column}.preview-meta{justify-content:flex-start}.preview-stage{height:180px}.preset-section>div{grid-template-columns:1fr 1fr}.mode-grid,.color-fields{grid-template-columns:1fr}.color-presets{grid-template-columns:1fr 1fr}.option-field{grid-template-columns:1fr}.card-heading{align-items:flex-start}}
</style>
