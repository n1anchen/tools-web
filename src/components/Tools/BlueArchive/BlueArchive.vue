    ...
    <ToolHero summary="拆分文字，组合一枚清透标题">
      <template #metrics>
        <div class="hero-metrics">
          <div><span>导出宽度</span><strong>{{ dimensions.width }}</strong></div>
          <div><span>导出高度</span><strong>{{ dimensions.height }}</strong></div>
...
:global(html.dark .blue-logo-page .hero-metrics){border-color:#40516a;background:rgba(15,23,42,.5)}:global(html.dark .blue-logo-page .hero-metrics div){border-color:#40516a}:global(html.dark .blue-logo-page .hero-metrics strong){color:#e7edf6}:global(html.dark .blue-logo-page .hero-metrics span){color:#a8b4c5}:global(html.dark .blue-logo-page .preview-card),:global(html.dark .blue-logo-page .control-card),:global(html.dark .blue-logo-page .export-card){border-color:#334155;background:#1e293b;box-shadow:none}:global(html.dark .blue-logo-page .preview-heading h3),:global(html.dark .blue-logo-page .card-heading h3),:global(html.dark .blue-logo-page .preset-section strong),:global(html.dark .blue-logo-page .background-row strong){color:#f8fafc}:global(html.dark .blue-logo-page .canvas-stage){background-color:#0f172a;background-image:linear-gradient(45deg,#1e293b 25%,transparent 25%,transparent 75%,#1e293b 75%),linear-gradient(45deg,#1e293b 25%,transparent 25%,transparent 75%,#1e293b 75%)}:global(html.dark .blue-logo-page .loading-overlay){background:rgba(15,23,42,.8)}:global(html.dark .blue-logo-page .export-actions button),:global(html.dark .blue-logo-page .card-heading>button),:global(html.dark .blue-logo-page .preset-section button),:global(html.dark .blue-logo-page .background-row){border-color:#334155;color:#cbd5e1;background:#0f172a}:global(html.dark .blue-logo-page .preview-meta span){color:#cbd5e1;background:#0f172a}
.canvas-stage canvas{max-height:520px}
@media(max-width:980px){.workspace-grid{grid-template-columns:1fr}.canvas-stage{min-height:240px}}@media(max-width:650px){.blue-logo-page{gap:12px}.hero-metrics{grid-template-columns:1fr}.hero-metrics div{border-left:0;border-bottom:1px solid #e5edf6}.hero-metrics div:last-child{border-bottom:0}.preview-card,.control-card,.export-card{padding:15px}.preview-heading{align-items:flex-start;flex-direction:column}.export-actions{width:100%}.export-actions button{flex:1;justify-content:center}.canvas-stage{min-height:190px;padding:14px}.text-grid{grid-template-columns:1fr}.preset-section>div{grid-template-columns:1fr 1fr}.card-heading{align-items:flex-start}}
</style>
