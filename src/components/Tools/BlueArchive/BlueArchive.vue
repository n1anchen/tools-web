...
<style scoped>
.blue-logo-page{--accent:#0ea5e9;--deep:#0369a1;--soft:#f0f9ff;gap:16px}.preview-card,.control-card,.export-card{border:1px solid #dbeafe;border-radius:22px;background:#fff;box-shadow:0 16px 40px rgba(14,116,144,.07)}.eyebrow{display:block;margin-bottom:6px;color:var(--accent);font-size:10px;font-weight:900;letter-spacing:.16em}.preview-card{padding:21px}.preview-heading,.card-heading{display:flex;align-items:center;justify-content:space-between;gap:12px}.preview-heading{margin-bottom:14px}.preview-heading h3,.card-heading h3{margin:0;color: var(--c-text-primary);font-size:19px}.preview-heading p{margin:3px 0 0;color: var(--c-text-muted);font-size:10px}.export-actions{display:flex;gap:7px}.export-actions button,.card-heading>button{display:flex;align-items:center;gap:5px;padding:8px 10px;border:1px solid #cbd5e1;border-radius:9px;color: var(--c-text-body);background:#fff;cursor:pointer;font-size:10px}.export-actions button.primary{border-color:var(--accent);color:#fff;background:var(--accent)}.export-actions button:disabled{opacity:.4;cursor:not-allowed}.canvas-stage{position:relative;display:grid;place-items:center;min-height:280px;padding:28px;border-radius:17px;overflow:auto;background-color: var(--c-surface-subtle);background-image:linear-gradient(45deg,#e2e8f0 25%,transparent 25%,transparent 75%,#e2e8f0 75%),linear-gradient(45deg,#e2e8f0 25%,transparent 25%,transparent 75%,#e2e8f0 75%);background-position:0 0,12px 12px;background-size:24px 24px}.canvas-stage canvas{display:block;max-width:100%;height:auto;filter:drop-shadow(0 10px 24px rgba(14,116,144,.12))}.loading-overlay{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;gap:9px;color:var(--deep);background:rgba(248,250,252,.75);backdrop-filter:blur(4px);font-size:11px}.loading-overlay>.el-icon{font-size:25px}.loading-overlay.error{flex-direction:column;color:#be123c}.loading-overlay button{padding:6px 9px;border:0;border-radius:7px;color:#fff;background:#e11d48;cursor:pointer}.preview-meta{display:flex;flex-wrap:wrap;gap:6px;margin-top:11px}.preview-meta span{padding:5px 8px;border-radius:999px;color: var(--c-text-secondary);background:#f1f5f9;font-size:9px}.workspace-grid{display:grid;grid-template-columns:minmax(0,1.12fr) minmax(340px,.78fr);gap:16px;align-items:start}.control-card,.export-card{padding:21px}.card-heading{margin-bottom:17px}.card-heading>span{padding:5px 8px;border-radius:999px;color:var(--deep);background:var(--soft);font-size:9px}.card-heading>button{padding:6px 8px}.text-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}.text-grid label>span,.option-field>span,.resolution-field>span{display:block;margin-bottom:7px;color: var(--c-text-secondary);font-size:10px}.preset-section{margin-top:15px}.preset-section>span{display:block;margin-bottom:7px;color: var(--c-text-secondary);font-size:10px}.preset-section>div{display:grid;grid-template-columns:repeat(4,1fr);gap:6px}.preset-section button{padding:9px;border: 1px solid var(--c-border);border-radius:11px;color: var(--c-text-secondary);background: var(--c-surface-subtle);text-align:left;cursor:pointer}.preset-section strong,.preset-section small{display:block}.preset-section strong{color: var(--c-text-strong);font-size:10px}.preset-section small{margin-top:3px;color: var(--c-text-muted);font-size:8px}.option-field,.resolution-field{display:block;margin-top:16px}.option-field :deep(.el-segmented),.resolution-field :deep(.el-segmented){width:100%}.background-row{display:flex;align-items:center;justify-content:space-between;margin-top:13px;padding:11px 12px;border-radius:12px;background: var(--c-surface-subtle)}.background-row strong,.background-row span{display:block}.background-row strong{color: var(--c-text-strong);font-size:11px}.background-row span{margin-top:2px;color: var(--c-text-muted);font-size:9px}.slider-setting{margin-top:13px}.slider-setting label{display:flex;justify-content:space-between;margin-bottom:7px;color: var(--c-text-secondary);font-size:10px}.slider-setting strong{color:var(--deep)}.slider-setting :deep(.el-slider){padding:0 8px}.halo-reset{width:100%;padding:7px;border:1px dashed #bae6fd;border-radius:9px;color:var(--deep);background:var(--soft);cursor:pointer;font-size:9px}.dimension-summary{margin-top:14px;padding:15px;border-radius:14px;color:#fff;background:linear-gradient(135deg,#075985,#0284c7)}.dimension-summary span,.dimension-summary strong,.dimension-summary small{display:block}.dimension-summary span{color:#bae6fd;font-size:9px}.dimension-summary strong{margin-top:5px;font-size:22px}.dimension-summary small{margin-top:4px;color:#e0f2fe;font-size:9px}:global(html.dark .blue-logo-page .preview-card),:global(html.dark .blue-logo-page .control-card),:global(html.dark .blue-logo-page .export-card){border-color: var(--c-border);background:var(--c-surface);box-shadow:none}:global(html.dark .blue-logo-page .preview-heading h3),:global(html.dark .blue-logo-page .card-heading h3),:global(html.dark .blue-logo-page .preset-section strong),:global(html.dark .blue-logo-page .background-row strong){color:#f8fafc}:global(html.dark .blue-logo-page .canvas-stage){background-color:var(--c-surface-subtle);background-image:linear-gradient(45deg,#1e293b 25%,transparent 25%,transparent 75%,#1e293b 75%),linear-gradient(45deg,#1e293b 25%,transparent 25%,transparent 75%,#1e293b 75%)}:global(html.dark .blue-logo-page .loading-overlay){background:rgba(15,23,42,.8)}:global(html.dark .blue-logo-page .export-actions button),:global(html.dark .blue-logo-page .card-heading>button),:global(html.dark .blue-logo-page .preset-section button),:global(html.dark .blue-logo-page .background-row){border-color: var(--c-border);color: var(--c-text-secondary);background:var(--c-surface-subtle)}:global(html.dark .blue-logo-page .preview-meta span){color: var(--c-text-secondary);background:var(--c-surface-subtle)}
