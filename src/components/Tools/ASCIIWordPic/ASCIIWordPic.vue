  ...
  <div class="ascii-page flex flex-col mt-3 flex-1">
    ...
    <section class="ascii-hero">
      ...
      <div class="hero-stats">
        ...
        <div><strong>{{ metrics.rows || '—' }}</strong><span>输出行数</span></div>
