...
.sample-row>span,.recent-row>span {
  margin-right: 4px;
  color: var(--c-text-muted);
  font-size:10px
}
.sample-row button,.recent-row button {
  padding: 5px 8px;
  border: 1px solid var(--c-border);
  border-radius: var(--radius-full);
  color: var(--c-text-secondary);
...
.metric-strip div {
  padding: 12px;
  border-right:1px solid #252d41
}
.metric-strip div:last-child {
  border-right:0
}
.metric-strip span,.metric-strip strong {
  display:block
}
.metric-strip span {
  color: var(--c-text-secondary);
...
:global(html.dark .ascii-page .control-card) {
  border-color: var(--c-border);
  background: var(--c-surface);
  box-shadow:none
}
:global(html.dark .ascii-page .card-heading h3),:global(html.dark .ascii-page .auto-row strong) {
  color:#f8fafc
}
:global(html.dark .ascii-page .auto-row),:global(html.dark .ascii-page .sample-row button),:global(html.dark .ascii-page .recent-row button) {
  border-color: var(--c-border);
  color: var(--c-text-secondary);
  background:var(--c-surface-subtle)
}
...
@media(max-width:650px) {
  ...
  .primary-actions :deep(.el-button:first-child) {
    flex:1
  }
}
</style>
