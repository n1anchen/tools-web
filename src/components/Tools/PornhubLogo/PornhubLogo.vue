...
<style scoped>
.split-logo-page{--accent:#f59e0b;--deep:#b45309;--soft:#fffbeb;gap:16px}.preview-card,.control-card,.appearance-card{border:1px solid #fde68a;border-radius:var(--radius-card);background:var(--c-surface);box-shadow:0 16px 40px rgba(120,53,15,.07)}.eyebrow{display:block;margin-bottom:6px;color:var(--accent);font-size:10px;font-weight:900;letter-spacing:.16em}.preview-card{padding:21px}.preview-heading,.card-heading{display:flex;align-items:center;justify-content:space-between;gap:12px}.preview-heading{margin-bottom:14px}.preview-heading h3,.card-heading h3{margin:0;color:#18181b;font-size:19px}.preview-heading p{margin:3px 0 0;color:#a1a1aa;font-size:10px}.export-actions{display:flex;gap:7px}.export-actions button,.card-heading>button{display:flex;align-items:center;gap:5px;padding:8px 10px;border:1px solid #d4d4d8;border-radius:var(--radius-sm);color:#52525b;background:var(--c-surface);cursor:pointer;font-size:10px}.export-actions button.primary{border-color:var(--accent);color:#18181b;background:var(--accent);font-weight:800}.export-actions button:disabled{opacity:.4;cursor:not-allowed}.canvas-stage{position:relative;display:grid;place-items:center;min-height:290px;padding:30px;border-radius:17px;overflow:auto;background-color:#fafafa;background-image:linear-gradient(45deg,#e4e4e7 25%,transparent 25%,transparent 75%,#e4e4e7 75%),linear-gradient(45deg,#e4e4e7 25%,transparent 25%,transparent 75%,#e4e4e7 75%);background-position:0 0,12px 12px;background-size:24px 24px}.canvas-stage canvas{display:block;max-width:100%;height:auto;filter:drop-shadow(0 13px 25px rgba(24,24,27,.16))}.loading-overlay{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;gap:9px;color:var(--deep);background:rgba(250,250,250,.78);backdrop-filter:blur(4px);font-size:11px}.loading-overlay>.el-icon{font-size:25px}.loading-overlay.error{flex-direction:column;color:#be123c}.loading-overlay button{padding:6px 9px;border:0;border-radius:var(--radius-xs);color: var(--c-on-accent);background:#e11d48;cursor:pointer}.preview-meta{display:flex;flex-wrap:wrap;gap:6px;margin-top:11px}.preview-meta span{padding:5px 8px;border-radius:var(--radius-full);color:#71717a;background:#f4f4f5;font-size:9px}.workspace-grid{display:grid;grid-template-columns:minmax(0,1.12fr) minmax(360px,.78fr);gap:16px;align-items:start}.control-card,.appearance-card{padding:21px}.card-heading{margin-bottom:17px}.card-heading>button{padding:6px 8px}.text-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}.text-grid label>span,.option-field>span,.resolution-field>span{display:block;margin-bottom:7px;color:#71717a;font-size:10px}.text-presets{margin-top:13px}.text-presets>span{display:block;margin-bottom:7px;color:#71717a;font-size:10px}.text-presets>div{display:flex;flex-wrap:wrap;gap:6px}.text-presets button{padding:6px 8px;border:1px solid #e4e4e7;border-radius:var(--radius-full);color:#71717a;background:#fafafa;cursor:pointer;font-size:9px}.option-field,.resolution-field{display:block;margin-top:15px}.option-field :deep(.el-segmented),.resolution-field :deep(.el-segmented){width:100%}.slider-setting{margin-top:14px}.slider-setting label{display:flex;justify-content:space-between;margin-bottom:7px;color:#71717a;font-size:10px}.slider-setting strong{color:var(--deep)}.slider-setting :deep(.el-slider){padding:0 8px}.compact-sliders{display:grid;grid-template-columns:1fr 1fr;gap:14px}.theme-presets{display:grid;grid-template-columns:1fr 1fr;gap:7px}.theme-presets button{display:flex;align-items:center;gap:8px;padding:8px;border:1px solid #e4e4e7;border-radius:var(--radius-sm);background:#fafafa;text-align:left;cursor:pointer}.theme-presets i{flex:0 0 29px;width:29px;height:29px;border:1px solid #d4d4d8;border-radius:var(--radius-sm)}.theme-presets span,.theme-presets strong,.theme-presets small{display:block}.theme-presets strong{color:#3f3f46;font-size:10px}.theme-presets small{margin-top:2px;color:#a1a1aa;font-size:8px}.color-grid{display:grid;grid-template-columns:1fr 1fr;gap:7px;margin-top:12px}.color-grid label{padding:9px;border:1px solid #e4e4e7;border-radius:var(--radius-sm)}.color-grid label>span{display:block;margin-bottom:6px;color:#a1a1aa;font-size:8px}.color-grid label>div{display:flex;align-items:center;gap:7px}.color-grid code{color:#52525b;font-size:9px}.dimension-summary{margin-top:14px;padding:15px;border-radius:var(--radius-md);color: var(--c-on-accent);background:linear-gradient(135deg,#18181b,#78350f)}.dimension-summary span,.dimension-summary strong,.dimension-summary small{display:block}.dimension-summary span{color:#fcd34d;font-size:9px}.dimension-summary strong{margin-top:5px;font-size:22px}.dimension-summary small{margin-top:4px;color:#fef3c7;font-size:9px}:global(html.dark .split-logo-page .preview-card),:global(html.dark .split-logo-page .control-card),:global(html.dark .split-logo-page .appearance-card){border-color:#3f3f46;background:#27272a;box-shadow:none}:global(html.dark .split-logo-page .preview-heading h3),:global(html.dark .split-logo-page .card-heading h3),:global(html.dark .split-logo-page .theme-presets strong){color:#fafafa}:global(html.dark .split-logo-page .canvas-stage){background-color:#18181b;background-image:linear-gradient(45deg,#27272a 25%,transparent 25%,transparent 75%,#27272a 75%),linear-gradient(45deg,#27272a 25%,transparent 25%,transparent 75%,#27272a 75%)}:global(html.dark .split-logo-page .loading-overlay){background:rgba(24,24,27,.82)}:global(html.dark .split-logo-page .export-actions button),:global(html.dark .split-logo-page .card-heading>button),:global(html.dark .split-logo-page .text-presets button),:global(html.dark .split-logo-page .theme-presets button){border-color:#3f3f46;color:#d4d4d8;background:#18181b}:global(html.dark .split-logo-page .preview-meta span){color:#d4d4d8;background:#18181b}:global(html.dark .split-logo-page .color-grid label){border-color:#3f3f46}:global(html.dark .split-logo-page .color-grid code){color:#e4e4e7}
.canvas-stage canvas{max-height:520px}@media(max-width:1000px){.workspace-grid{grid-template-columns:1fr}.canvas-stage{min-height:240px}}@media(max-width:650px){.split-logo-page{gap:12px}.preview-card,.control-card,.appearance-card{padding:15px}.preview-heading{align-items:flex-start;flex-direction:column}.export-actions{width:100%}.export-actions button{flex:1;justify-content:center}.canvas-stage{min-height:190px;padding:14px}.text-grid,.compact-sliders,.color-grid{grid-template-columns:1fr}.theme-presets{grid-template-columns:1fr 1fr}.card-heading{align-items:flex-start}}</style>
