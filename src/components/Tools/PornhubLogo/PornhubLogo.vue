...
async function downloadImage() {
  ...
  try {
    ...
    anchor.href = url
    anchor.download = buildLogoFilename([state.leftText, state.rightText], 'split-badge')
    anchor.click()
