...
<style scoped>
.mirage-tool { --accent:#2d6eb5; --ink:#262d38; --muted:#707b89; }.hero-card { display:flex; align-items:flex-end; justify-content:space-between; gap:24px; padding:26px; border:1px solid #dce6ef; border-radius:24px; background:linear-gradient(135deg,#f7fbff,#edf5fb 55%,#f4f0ff); box-shadow:0 14px 34px rgba(45,82,113,.07); }.eyebrow,.step-heading>div>span,.settings-title>div>span { color:#557b9f; font-size:13px; font-weight:800; letter-spacing:.12em; }.hero-card h2 { margin:6px 0 8px; color:var(--ink); font-size:25px; line-height:1.3; font-weight:800; }.hero-card p { margin:0; color:var(--muted); font-size:14px; line-height:1.7; }.hero-metrics { display:grid; grid-template-columns:repeat(3,minmax(115px,1fr)); min-width:460px; padding:13px 0; border:1px solid rgba(112,144,172,.24); border-radius:17px; background:rgba(255,255,255,.74); }.hero-metrics div { min-width:0; padding:0 16px; border-right:1px solid #dfe7ee; }.hero-metrics div:last-child { border-right:0; }.hero-metrics span { display:block; color:#85909c; font-size:13px; }.hero-metrics strong { display:block; margin-top:5px; overflow:hidden; color:#364659; font-size:14px; white-space:nowrap; text-overflow:ellipsis; }
