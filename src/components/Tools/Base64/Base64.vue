...
<style scoped>
.base64-page{--violet:#7c3aed;gap:18px}.mode-nav, .text-toolbar, .io-card, .upload-card, .file-result-card, .decode-input-card, .decode-result-card {border: 1px solid var(--c-border);border-radius:var(--radius-card);background:var(--c-surface);box-shadow: var(--shadow-card)}.eyebrow{display:block;margin-bottom:7px;color:#c4b5fd;font-size:12px;font-weight:900;letter-spacing:.16em}.mode-nav{display:grid;grid-template-columns:repeat(3,1fr);gap:9px;padding:10px}.mode-nav button{display:flex;align-items:center;gap:12px;padding:13px;border:1px solid transparent;border-radius:var(--radius-md);background:transparent;color: var(--c-text-secondary);text-align:left;cursor:pointer}.mode-nav button>b{display:grid;width:38px;height:38px;place-items:center;border-radius:var(--radius-sm);background:#f1f5f9;color: var(--c-text-secondary);font:800 13px ui-monospace,monospace}.mode-nav span,.mode-nav strong,.mode-nav small{display:block}.mode-nav strong{color: var(--c-text-strong);font-size:15px}.mode-nav small{margin-top:2px;color: var(--c-text-muted);font-size:12px}.mode-nav button.active{border-color:#c4b5fd;background:#f5f3ff;color:#6d28d9}.mode-nav button.active>b{color: var(--c-on-accent);background:var(--violet)}.mode-nav button.active strong{color:#5b21b6}.text-toolbar{display:grid;grid-template-columns:auto minmax(270px,1fr) auto auto;align-items:center;gap:18px;padding:17px 20px}.text-toolbar .eyebrow{margin-bottom:3px;color:var(--violet)}.text-toolbar h3,.io-card h3,.upload-card h3,.file-result-card h3,.decode-grid h3{margin:0;color: var(--c-text-primary);font-size:19px}.toolbar-actions{display:flex;gap:8px}.toolbar-actions button,.io-card footer button,.file-result-card footer button,.decode-input-card header button{display:inline-flex;align-items:center;justify-content:center;gap:5px;min-height:36px;padding:0 11px;border:1px solid #dbe3ef;border-radius:var(--radius-sm);background:var(--c-surface);color: var(--c-text-body);font-size:13px;font-weight:750;cursor:pointer}.toolbar-actions button:disabled,.io-card footer button:disabled,.file-result-card footer button:disabled{opacity:.45;cursor:not-allowed}.sample-card{display:flex;align-items:center;gap:8px;padding:12px 15px;overflow-x:auto}.sample-card>span{flex:none;color: var(--c-text-secondary);font-size:13px}.sample-card button{flex:none;padding:9px 13px;border:1px solid #dbe3ef;border-radius:var(--radius-sm);background: var(--c-surface-subtle);color: var(--c-text-strong);text-align:left;cursor:pointer}.sample-card strong,.sample-card small{display:block}.sample-card strong{font-size:14px}.sample-card small{margin-top:2px;color: var(--c-text-muted);font-size:12px}.text-workspace{display:grid;grid-template-columns:minmax(0,1fr) 70px minmax(0,1fr);align-items:stretch}.io-card{min-width:0;padding:20px}.io-card header{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:13px}.io-card header span{color: var(--c-text-secondary);font-size:12px;font-weight:900;letter-spacing:.14em}.io-card header small{color: var(--c-text-muted);font-size:12px}.io-card :deep(.el-textarea__inner),.file-result-card :deep(.el-textarea__inner),.decode-input-card :deep(.el-textarea__inner){min-height:330px!important;padding:14px;border-radius:var(--radius-md);font:14px/1.7 ui-monospace,SFMono-Regular,Consolas,monospace}.io-card footer,.file-result-card footer{display:flex;justify-content:flex-end;gap:8px;margin-top:12px}.flow-action{display:grid;place-items:center}.flow-action button{display:grid;width:54px;height:54px;place-items:center;border:0;border-radius:50%;color: var(--c-on-accent);background:linear-gradient(135deg,#7c3aed,#2563eb);box-shadow:0 12px 25px rgba(124,58,237,.28);cursor:pointer}.flow-action span{font-size:12px;font-weight:800}.flow-action b{line-height:.7}.file-workspace,.decode-grid{display:grid;grid-template-columns:minmax(0,.9fr) minmax(0,1.1fr);gap:18px}.upload-card,.file-result-card,.decode-input-card,.decode-result-card{padding:22px}.upload-card p,.decode-input-card header p{margin:5px 0 0;color: var(--c-text-secondary);font-size:13px;line-height:1.6}.upload-card .eyebrow,.file-result-card .eyebrow,.decode-grid .eyebrow{color:var(--violet)}.upload-card :deep(.el-upload){display:block;margin-top:18px}.upload-card :deep(.el-upload-dragger){display:flex;min-height:230px;align-items:center;justify-content:center;flex-direction:column;border-radius:var(--radius-lg)}.upload-icon{color:var(--violet);font-size:34px}.upload-card :deep(.el-upload-dragger strong){margin-top:10px;color: var(--c-text-strong);font-size:15px}.upload-card :deep(.el-upload-dragger small){margin-top:5px;color: var(--c-text-muted);font-size:12px}.loading-state{margin-top:14px;padding:12px;border-radius:var(--radius-sm);color:#6d28d9;background:#f5f3ff;text-align:center}.file-meta,.restore-summary{display:grid;grid-template-columns:1fr 1fr;margin-top:16px;border: 1px solid var(--c-border);border-radius:var(--radius-md);overflow:hidden}.file-meta>div,.restore-summary>div{min-width:0;padding:12px;border-right: 1px solid var(--c-border);border-bottom: 1px solid var(--c-border)}.file-meta>div:nth-child(2n),.restore-summary>div:nth-child(2n){border-right:0}.file-meta>div:nth-last-child(-n+2),.restore-summary>div:nth-last-child(-n+2){border-bottom:0}.file-meta span,.file-meta strong,.restore-summary span,.restore-summary strong{display:block}.file-meta span,.restore-summary span{color: var(--c-text-muted);font-size:12px}.file-meta strong,.restore-summary strong{margin-top:3px;overflow:hidden;color: var(--c-text-strong);font-size:13px;text-overflow:ellipsis;white-space:nowrap}.file-result-card>header,.decode-input-card>header,.decode-result-card>header{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-bottom:15px}.file-result-card footer button.primary{border-color:var(--violet);background:var(--violet);color: var(--c-on-accent)}.textarea-wrap{position:relative}.textarea-wrap>span{position:absolute;right:12px;bottom:10px;padding:3px 7px;border-radius:var(--radius-xs);background:rgba(255,255,255,.88);color: var(--c-text-muted);font-size:12px}.textarea-wrap>span.danger{color:#dc2626}.error-banner{margin-top:10px;padding:10px 12px;border-radius:var(--radius-sm);color:#b91c1c;background:#fef2f2;font-size:13px}.filename-row{display:grid;grid-template-columns:1fr 150px;gap:10px;margin-top:14px}.filename-row label>span{display:block;margin-bottom:6px;color: var(--c-text-secondary);font-size:12px}.restore-button,.download-button{display:flex;width:100%;min-height:43px;align-items:center;justify-content:center;gap:7px;margin-top:15px;border:0;border-radius:var(--radius-sm);background:linear-gradient(135deg,#7c3aed,#2563eb);color: var(--c-on-accent);font-size:14px;font-weight:800;cursor:pointer}.restore-button:disabled,.download-button:disabled{cursor:not-allowed;filter:grayscale(1);opacity:.5}.status-pill{padding:5px 9px;border-radius:var(--radius-full);color: var(--c-text-secondary);background:#f1f5f9;font-size:12px;font-weight:800}.status-pill.ready{color:#047857;background:#d1fae5}.file-placeholder{display:flex;min-height:265px;align-items:center;justify-content:center;flex-direction:column;margin-top:15px;border:1px dashed #cbd5e1;border-radius:var(--radius-md);color: var(--c-text-muted);text-align:center}.file-placeholder>.el-icon{font-size:36px}.file-placeholder strong{margin-top:10px;color: var(--c-text-body);font-size:15px}.file-placeholder span{max-width:320px;margin-top:5px;font-size:12px}.preview-box{display:grid;min-height:265px;margin-top:15px;padding:14px;place-items:center;border-radius:var(--radius-md);background: var(--c-surface-subtle)}.preview-box span{justify-self:start;color: var(--c-text-secondary);font-size:12px}.preview-box img{max-width:100%;max-height:280px;border-radius:var(--radius-sm)}:global(html.dark .base64-page .mode-nav),:global(html.dark .base64-page .text-toolbar),:global(html.dark .base64-page .sample-card),:global(html.dark .base64-page .io-card),:global(html.dark .base64-page .upload-card),:global(html.dark .base64-page .file-result-card),:global(html.dark .base64-page .decode-input-card),:global(html.dark .base64-page .decode-result-card){border-color: var(--c-border);background:var(--c-surface);box-shadow:none}:global(html.dark .base64-page h3),:global(html.dark .base64-page .mode-nav strong),:global(html.dark .base64-page .file-meta strong),:global(html.dark .base64-page .restore-summary strong),:global(html.dark .base64-page .file-placeholder strong){color:#f8fafc}:global(html.dark .base64-page .mode-nav button>b),:global(html.dark .base64-page .sample-card button),:global(html.dark .base64-page .toolbar-actions button),:global(html.dark .base64-page .io-card footer button),:global(html.dark .base64-page .file-result-card footer button),:global(html.dark .base64-page .decode-input-card header button){border-color: var(--c-border-strong);background:var(--c-surface-subtle);color: var(--c-text-primary)}:global(html.dark .base64-page .mode-nav button.active){border-color:#7c3aed;background:#2e1065}:global(html.dark .base64-page .mode-nav button.active strong){color:#ddd6fe}:global(html.dark .base64-page .file-meta),:global(html.dark .base64-page .restore-summary){border-color: var(--c-border)}:global(html.dark .base64-page .file-meta>div),:global(html.dark .base64-page .restore-summary>div){border-color: var(--c-border)}:global(html.dark .base64-page .textarea-wrap>span){background:rgba(15,23,42,.9)}:global(html.dark .base64-page .preview-box){background:var(--c-surface-subtle)}:global(html.dark .base64-page .file-placeholder){border-color: var(--c-border-strong)}
@media(max-width:1050px){.text-toolbar{grid-template-columns:1fr 1fr}.text-workspace{grid-template-columns:1fr}.flow-action{padding:8px}.flow-action button{width:100%;height:42px;border-radius:var(--radius-sm)}.flow-action b{display:none}.file-workspace,.decode-grid{grid-template-columns:1fr}}@media(max-width:680px){.base64-page{gap:14px}.mode-nav{grid-template-columns:1fr}.text-toolbar{grid-template-columns:1fr;padding:15px}.toolbar-actions{display:grid;grid-template-columns:1fr 1fr}.sample-card{padding:11px}.io-card,.upload-card,.file-result-card,.decode-input-card,.decode-result-card{padding:15px}.io-card header{align-items:flex-start;flex-direction:column}.io-card :deep(.el-textarea__inner),.file-result-card :deep(.el-textarea__inner),.decode-input-card :deep(.el-textarea__inner){min-height:260px!important}.filename-row{grid-template-columns:1fr}.file-meta,.restore-summary{grid-template-columns:1fr}.file-meta>div,.restore-summary>div{border-right:0}.file-meta>div:nth-last-child(2),.restore-summary>div:nth-last-child(2){border-bottom: 1px solid var(--c-border)}}
</style>
