...
.mode-nav span,.mode-nav strong,.mode-nav small {
  display:block
}
.mode-nav strong {
...
.text-toolbar .eyebrow {
  margin-bottom: 3px;
  color:var(--violet)
}
.text-toolbar h3,.io-card h3,.upload-card h3,.file-result-card h3,.decode-grid h3 {
  margin: 0;
...
.sample-card strong,.sample-card small {
  display:block
}
.sample-card strong {
  font-size:14px
...
.io-card header small {
  color: var(--c-text-muted);
  font-size:12px
}
.io-card :deep(.el-textarea__inner),.file-result-card :deep(.el-textarea__inner),.decode-input-card :deep(.el-textarea__inner) {
  min-height: 330px!important;
  padding: 14px;
  border-radius: var(--radius-md);
  font:14px/1.7 ui-monospace,SFMono-Regular,Consolas,monospace
}
.io-card footer,.file-result-card footer {
  display: flex;
...
.upload-card,.file-result-card,.decode-input-card,.decode-result-card {
  padding:22px
}
.upload-card p,.decode-input-card header p {
  margin: 5px 0 0;
  color: var(--c-text-secondary);
  font-size: 13px;
  line-height:1.6
}
.upload-card .eyebrow,.file-result-card .eyebrow,.decode-grid .eyebrow {
  color:var(--violet)
}
...
.upload-card :deep(.el-upload-dragger small) {
  margin-top: 5px;
  color: var(--c-text-muted);
  font-size:12px
}
...
.file-meta>div,.restore-summary>div {
  min-width: 0;
  padding: 12px;
  border-right: 1px solid var(--c-border);
  border-bottom: 1px solid var(--c-border)
}
.file-meta>div:nth-child(2n),.restore-summary>div:nth-child(2n) {
  border-right:0
}
.file-meta>div:nth-last-child(-n+2),.restore-summary>div:nth-last-child(-n+2) {
  border-bottom:0
}
.file-meta span,.file-meta strong,.restore-summary span,.restore-summary strong {
  display:block
}
.file-meta span,.restore-summary span {
  color: var(--c-text-muted);
  font-size:12px
}
.file-meta strong,.restore-summary strong {
  margin-top: 3px;
  overflow: hidden;
  color: var(--c-text-strong);
  font-size: 13px;
...
.file-result-card>header,.decode-input-card>header,.decode-result-card>header {
  display: flex;
...
.file-result-card footer button.primary {
...
:global(html.dark .base64-page .file-meta>div),:global(html.dark .base64-page .restore-summary>div) {
  border-color: var(--c-border)
}
:global(html.dark .base64-page .textarea-wrap>span) {
  background:rgba(15,23,42,.9)
}
:global(html.dark .base64-page .preview-box) {
  background:var(--c-surface-subtle)
}
:global(html.dark .base64-page .file-placeholder) {
  border-color: var(--c-border-strong)
}
...
@media(max-width:680px) {
  ...
  .io-card,.upload-card,.file-result-card,.decode-input-card,.decode-result-card {
    padding:15px
  }
  .io-card header {
    align-items: flex-start;
  ...
  .file-meta>div:nth-last-child(2),.restore-summary>div:nth-last-child(2) {
    border-bottom: 1px solid var(--c-border)
  }
}
</style>
