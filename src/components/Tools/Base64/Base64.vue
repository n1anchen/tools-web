...
<template>
  <div class="base64-page flex flex-col mt-3 flex-1">
    ...
    <section class="hero-card">
      <div><span class="eyebrow">BASE64 DATA STUDIO</span><h2>文字与文件，都走清晰的转换流程</h2><p>{{ toolInfo.desc }}</p></div>
