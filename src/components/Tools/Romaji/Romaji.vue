...
.hero-card { display:flex; align-items:flex-end; justify-content:space-between; gap:24px; padding:26px; border:1px solid #eadfd8; border-radius:24px; background:linear-gradient(135deg,#fffaf5,#fff1ea 58%,#f7f2ff); box-shadow:0 14px 34px rgba(106,69,52,.07); }
.eyebrow,.pane-heading span,.section-heading>div>span { color:#a66b59; font-size:13px; font-weight:800; letter-spacing:.12em; }
.hero-card h2 { margin:6px 0 8px; color:var(--ink); font-size:25px; line-height:1.3; font-weight:800; }.hero-card p { margin:0; max-width:720px; color:var(--muted); font-size:14px; line-height:1.7; }
.hero-stats { display:grid; grid-template-columns:repeat(4,68px); flex:none; padding:13px 5px; border:1px solid rgba(188,141,121,.25); border-radius:17px; background:rgba(255,255,255,.7); }.hero-stats div { text-align:center; border-right:1px solid #eadfd8; }.hero-stats div:last-child { border-right:0; }.hero-stats span { display:block; color:#96858c; font-size:13px; }.hero-stats strong { display:block; margin-top:3px; color:#58464a; font-size:18px; }
