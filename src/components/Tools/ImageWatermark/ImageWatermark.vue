...
.upload-card, .preview-card, .settings-card, .feature-strip article { border: 1px solid var(--c-border); background: #fff; box-shadow: 0 16px 40px rgba(15, 23, 42, .06); }
...
.source-image { display: none; }.image-meta { display: grid; grid-template-columns: 1.5fr repeat(3, 1fr); margin-top: 14px; border: 1px solid var(--c-border); border-radius: 14px; overflow: hidden; }.image-meta div { min-width: 0; padding: 11px 13px; border-right: 1px solid var(--c-border); }.image-meta div:last-child { border: 0; }.image-meta span, .image-meta strong { display: block; }.image-meta span { color: var(--c-text-muted); font-size: 10px; }.image-meta strong { margin-top: 3px; overflow: hidden; color: var(--c-text-strong); font-size: 12px; text-overflow: ellipsis; white-space: nowrap; }
...
.position-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 7px; }.position-grid button { display: flex; align-items: center; justify-content: center; gap: 5px; padding: 8px 5px; border: 1px solid var(--c-border); border-radius: 9px; color: var(--c-text-secondary); background: var(--c-surface-subtle); cursor: pointer; }.position-grid button.active { border-color: #60a5fa; color: #1d4ed8; background: #eff6ff; box-shadow: inset 0 0 0 1px #93c5fd; }
.toggle-row { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin: 14px 0; }.toggle-row label { display: flex; align-items: center; justify-content: space-between; gap: 8px; padding: 10px; border: 1px solid var(--c-border); border-radius: 12px; color: var(--c-text-strong); font-size: 12px; }.toggle-row span, .toggle-row small { display: block; }
.export-box { margin-top: 16px; padding: 14px; border-radius: 16px; background: var(--c-surface-subtle); }.download-button { width: 100%; }
