...
.upload-card, .preview-card, .settings-card, .feature-strip article {
...
.image-meta div:last-child {
  border: 0;
}
.image-meta span, .image-meta strong {
  display: block;
}
.image-meta span {
...
.field-group > label, .slider-field > label {
  display: flex;
  justify-content: space-between;
  margin-bottom: 7px;
...
.field-group label small, .toggle-row small {
  color: var(--c-text-muted);
  font-weight: 400;
}
.two-columns {
...
.two-columns :deep(.el-input-number), .two-columns :deep(.el-select) {
  width: 100%;
}
.color-row {
  display: flex;
...
.toggle-row span, .toggle-row small {
  display: block;
}
.export-box {
  margin-top: 16px;
...
:global(html.dark .watermark-page .upload-card), :global(html.dark .watermark-page .preview-card), :global(html.dark .watermark-page .settings-card), :global(html.dark .watermark-page .feature-strip article) {
  border-color: var(--c-border);
  background-color: var(--c-surface);
  box-shadow: none;
}
:global(html.dark .watermark-page .upload-card.dragging), :global(html.dark .watermark-page .export-box) {
  background: var(--c-surface-subtle);
}
:global(html.dark .watermark-page .upload-card h3), :global(html.dark .watermark-page .card-heading h3), :global(html.dark .watermark-page .feature-strip strong) {
  color: #f8fafc;
}
:global(html.dark .watermark-page .upload-card p), :global(html.dark .watermark-page .feature-strip p), :global(html.dark .watermark-page .field-group > label), :global(html.dark .watermark-page .slider-field > label) {
  color: var(--c-text-muted);
}
:global(html.dark .watermark-page .canvas-stage) {
...
:global(html.dark .watermark-page .image-meta), :global(html.dark .watermark-page .image-meta div), :global(html.dark .watermark-page .position-grid button), :global(html.dark .watermark-page .toggle-row label) {
  border-color: var(--c-border);
}
:global(html.dark .watermark-page .image-meta strong), :global(html.dark .watermark-page .toggle-row label) {
  color: var(--c-text-primary);
}
:global(html.dark .watermark-page .position-grid button) {
  color: var(--c-text-muted);
  background: var(--c-surface-subtle);
}
...
@media (max-width: 720px) {
  ...
  .image-meta div:nth-child(2) {
    border-right: 0;
  }
  .image-meta div:nth-child(-n+2) {
    border-bottom: 1px solid var(--c-border);
  }
  .feature-strip {
    grid-template-columns: 1fr;
  }
  .two-columns, .toggle-row {
    grid-template-columns: 1fr;
  }
  .upload-actions {
