...
.source-image { display: none; }.image-meta { display: grid; grid-template-columns: 1.5fr repeat(3, 1fr); margin-top: 14px; border: 1px solid var(--c-border); border-radius: 14px; overflow: hidden; }.image-meta div { min-width: 0; padding: 11px 13px; border-right: 1px solid #e2e8f0; }.image-meta div:last-child { border: 0; }.image-meta span, .image-meta strong { display: block; }.image-meta span { color: var(--c-text-muted); font-size: 10px; }.image-meta strong { margin-top: 3px; overflow: hidden; color: #334155; font-size: 12px; text-overflow: ellipsis; white-space: nowrap; }
...
.toggle-row { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin: 14px 0; }.toggle-row label { display: flex; align-items: center; justify-content: space-between; gap: 8px; padding: 10px; border: 1px solid var(--c-border); border-radius: 12px; color: #334155; font-size: 12px; }.toggle-row span, .toggle-row small { display: block; }
...
:global(html.dark .watermark-page .canvas-stage) { background-color: #0f172a; background-image: linear-gradient(45deg,#1e293b 25%,transparent 25%),linear-gradient(-45deg,#1e293b 25%,transparent 25%),linear-gradient(45deg,transparent 75%,#1e293b 75%),linear-gradient(-45deg,transparent 75%,#1e293b 75%); }:global(html.dark .watermark-page .image-meta), :global(html.dark .watermark-page .image-meta div), :global(html.dark .watermark-page .position-grid button), :global(html.dark .watermark-page .toggle-row label) { border-color: #334155; }:global(html.dark .watermark-page .image-meta strong), :global(html.dark .watermark-page .toggle-row label) { color: #e2e8f0; }:global(html.dark .watermark-page .position-grid button) { color: var(--c-text-muted); background: #0f172a; }:global(html.dark .watermark-page .position-grid button.active) { color: #93c5fd; background: #172554; }:global(html.dark .watermark-page .feature-strip b) { background: #431407; }@media (max-width: 1080px) { .studio-grid { grid-template-columns: 1fr; }.settings-card { position: static; }.canvas-stage { min-height: 360px; }}@media (max-width: 720px) { .watermark-page { gap: 12px; }.upload-card { min-height: 360px; padding: 36px 18px; }.preview-card, .settings-card { padding: 15px; border-radius: 20px; }.card-heading { align-items: flex-start; }.header-actions { flex-wrap: wrap; justify-content: flex-end; }.canvas-stage { min-height: 280px; padding: 10px; }.image-meta { grid-template-columns: 1fr 1fr; }.image-meta div:nth-child(2) { border-right: 0; }.image-meta div:nth-child(-n+2) { border-bottom: 1px solid #e2e8f0; }.feature-strip { grid-template-columns: 1fr; }.two-columns, .toggle-row { grid-template-columns: 1fr; }.upload-actions { flex-direction: column; width: 100%; }.upload-actions :deep(.el-button) { width: 100%; margin-left: 0; }}</style>
