...
.input-card, .results-card, .alphabet-card { padding: 24px; border: 1px solid var(--c-border); border-radius: 23px; background: var(--c-surface); box-shadow: var(--shadow-card); }
...
.input-heading h2, .section-heading h3 { margin: 6px 0 3px; color: var(--c-text-primary); }
.input-heading h2 { font-size: clamp(20px, 3vw, 27px); }
.section-heading h3 { font-size: 19px; }
.input-heading p { margin: 0; color: var(--c-text-secondary); font-size: 13px; }
.precision-badge { display: flex; align-items: center; gap: 6px; flex: none; padding: 8px 12px; border: 1px solid #ddd6fe; border-radius: var(--radius-full); color: #6d28d9; background: #f5f3ff; font-size: 12px; font-weight: 700; }
.input-layout { display: grid; grid-template-columns: 190px minmax(0, 1fr); gap: 12px; margin-top: 24px; }
.base-picker, .number-input { display: flex; min-width: 0; flex-direction: column; padding: 15px; border: 1px solid var(--c-border); border-radius: var(--radius-lg); background: var(--c-surface-subtle); }
.base-picker label, .number-input label { margin-bottom: 8px; color: var(--c-text-body); font-size: 12px; font-weight: 700; }
.base-picker small, .number-input small { margin-top: 7px; color: var(--c-text-muted); font-size: 10px; }
...
.preset-row { display: flex; align-items: center; flex-wrap: wrap; gap: 7px; margin-top: 13px; color: var(--c-text-muted); font-size: 11px; }
.preset-row button { padding: 5px 10px; border: 0; border-radius: 99px; color: #5b21b6; background: #f5f3ff; cursor: pointer; }
.option-row { flex-wrap: wrap; margin-top: 18px; padding: 14px 16px; border-radius: var(--radius-md); background: var(--c-surface-subtle); }
...
.error-box { margin-top: 14px; padding: 12px 14px; border: 1px solid #fecaca; border-radius: var(--radius-md); color: #b91c1c; background: #fef2f2; font-size: 13px; }
...
.result-item { min-width: 0; padding: 15px; border: 1px solid var(--c-border); border-radius: var(--radius-lg); background: var(--c-surface-subtle); cursor: pointer; transition: .18s ease; }
...
.result-meta strong { display: grid; width: 31px; height: 31px; place-items: center; border-radius: var(--radius-sm); color: var(--c-on-accent); background: var(--accent); font-size: 12px; }
.result-meta span { color: var(--c-text-secondary); font-size: 11px; }
...
.result-footer small { color: var(--c-text-muted); font-size: 10px; }
.alphabet-list { display: grid; gap: 9px; margin-top: 17px; }
.alphabet-list > div { display: grid; grid-template-columns: 80px minmax(0, 1fr) 210px; align-items: center; gap: 12px; padding: 11px 13px; border: 1px solid var(--c-border); border-radius: var(--radius-md); background: var(--c-surface-subtle); }
.alphabet-list strong { color: var(--c-text-body); font-size: 12px; }
...
@media (max-width: 760px) {
  .input-card, .results-card, .alphabet-card { padding: 18px; border-radius: var(--radius-card); }
