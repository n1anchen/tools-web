...
.input-heading h2, .section-heading h3 {
  margin: 6px 0 3px;
...
.base-picker label, .number-input label {
  margin-bottom: 8px;
  color: var(--c-text-body);
  font-size: 12px;
  font-weight: 700;
}
.base-picker small, .number-input small {
  margin-top: 7px;
  color: var(--c-text-muted);
  font-size: 10px;
}
.number-input :deep(.el-textarea__inner) {
  padding: 4px 0;
  border: 0;
  box-shadow: none;
  color: #1e293b;
...
.option-row > div:first-child > span {
  color: var(--c-text-secondary);
  font-size: 12px;
  font-weight: 700;
}
...
.decimal-summary span {
  color: var(--c-text-muted);
  font-size: 11px;
}
.decimal-summary strong {
  max-width: 300px;
...
:global(html.dark .radix-page .input-card), :global(html.dark .radix-page .results-card), :global(html.dark .radix-page .alphabet-card) {
  border-color: var(--c-border);
  background: var(--c-surface);
  box-shadow: none;
}
:global(html.dark .radix-page .input-card) {
  background: radial-gradient(circle at 92% 8%, #3b1f5e 0, transparent 28%), #1e293b;
}
:global(html.dark .radix-page h2), :global(html.dark .radix-page h3), :global(html.dark .radix-page .result-item code) {
  color: #f8fafc;
}
:global(html.dark .radix-page .base-picker label), :global(html.dark .radix-page .number-input label), :global(html.dark .radix-page .option-row > div:first-child > span) {
  color: var(--c-text-secondary);
}
:global(html.dark .radix-page .input-heading p), :global(html.dark .radix-page .result-meta span), :global(html.dark .radix-page .result-footer small) {
  color: var(--c-text-muted);
}
...
:global(html.dark .radix-page .number-input .el-textarea__inner) {
  color: var(--c-text-primary);
}
:global(html.dark .radix-page .decimal-summary strong) {
  color: var(--c-text-secondary);
}
:global(html.dark .radix-page .error-box) {
  border-color: #7f1d1d;
  color: #fca5a5;
  background: #450a0a;
}
