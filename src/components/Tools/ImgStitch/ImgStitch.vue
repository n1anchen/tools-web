    ...
    <ToolHero summary="排序、裁切、拼接，一块画布完成">
      <template #metrics>
        <div class="hero-metrics">
          ...
          <div><span>输出宽</span><strong>{{ plan.width || '—' }}</strong></div>
          <div><span>输出高</span><strong>{{ plan.height || '—' }}</strong></div>
        </div>
      </template>
    </ToolHero>
