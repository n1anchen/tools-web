    ...
    <ToolHero summary="从一张图片，读懂整套色彩">
      <template #metrics>
        <div class="hero-metrics">
          <div><span>色彩格式</span><strong>5</strong></div>
          <div><span>智能主色</span><strong>8</strong></div>
          <div><span>历史记录</span><strong>20</strong></div>
        </div>
      </template>
    </ToolHero>
