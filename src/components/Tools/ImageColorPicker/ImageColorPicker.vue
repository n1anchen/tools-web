...
<style scoped>
.color-page { --blue: #2563eb; gap: 16px; }.hero-card, .upload-card, .file-bar, .image-panel, .inspector-panel, .palette-card, .history-card { border: 1px solid #e2e8f0; border-radius: 22px; background: #fff; box-shadow: 0 12px 35px rgb(15 23 42 / 6%); }.hero-card { display: flex; align-items: center; justify-content: space-between; gap: 20px; padding: 25px 28px; background: radial-gradient(circle at 88% 10%, #e0e7ff, transparent 28%), #fff; }.eyebrow { color: var(--blue); font-size:12px; font-weight: 800; letter-spacing: .15em; }.hero-card h2 { margin: 6px 0 4px; color: #0f172a; font-size: clamp(21px, 3vw, 28px); }.hero-card p { margin: 0; color: #64748b; font-size: 13px; }.hero-stats { display: flex; gap: 9px; }.hero-stats div { display: flex; min-width: 70px; flex-direction: column; padding: 9px 11px; border: 1px solid #c7d2fe; border-radius: 13px; background: #eef2ff; text-align: center; }.hero-stats strong { color: #4338ca; font-size: 17px; }.hero-stats span { color: #6366f1; font-size:12px; }
