...
<style scoped>
.color-page { --blue: #2563eb; gap: 16px; }.upload-card, .file-bar, .image-panel, .inspector-panel, .palette-card, .history-card { border: 1px solid var(--c-border); border-radius: 22px; background: #fff; box-shadow: 0 12px 35px rgb(15 23 42 / 6%); }.eyebrow { color: var(--blue); font-size:12px; font-weight: 800; letter-spacing: .15em; }
